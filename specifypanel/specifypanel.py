...
def upload_db():
    ...
    yield "dropping db.\n"
    call(["/usr/bin/mysqladmin", "-f", "-uMasterUser", "-pMasterPassword", "drop", db_name])
    yield "creating db.\n"
    check_call(["/usr/bin/mysqladmin", "-uMasterUser", "-pMasterPassword", "create", db_name])
    yield "loading db.\n"
    mysql = Popen(["/usr/bin/mysql", "-uMasterUser", "-pMasterPassword", db_name], stdin=PIPE)
...
def export():
    ...
    mysqldump = Popen(["/usr/bin/mysqldump", "-uMasterUser", "-pMasterPassword", db_name], stdout=PIPE)
