from specifyweb.stored_queries.execution import run_ephemeral_query
from specifyweb.stored_queries.tests.test_execution.simple_query import simple_query
