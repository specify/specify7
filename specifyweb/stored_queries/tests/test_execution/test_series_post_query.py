...
class TestSeriesPostQuery(SQLAlchemySetup):
    ...
    def test_string_integer_just_cn_field(self):
    ...
    def test_string_integer_with_same_fields(self):
        collectionobjects = self._make_string_numeric_cos()
        table, query_fields = make_query_fields_test(
            "Collectionobject",
            [["catalognumber"], ["text1"], ["collection", "collectionname"]],
    ...
    def test_string_integer_unique_distinct_fields(self):
        collectionobjects = self._make_string_numeric_cos()
        table, query_fields = make_query_fields_test(
            "Collectionobject",
            [["catalognumber"], ["guid"], ["text1"], ["collection", "collectionname"]],
    ...
    def test_catalog_number_sort(self):
        collectionobjects = self._make_numeric_cos()
        table, query_fields = make_query_fields_test(
            "Collectionobject", [["catalognumber"]]
        )
    ...
    @expectedFailure
    def test_string_integer_postfix_preserved(self):
    ...
    @expectedFailure
    def test_column_ordering_invalid(self):
    ...
    @expectedFailure
    def test_row_ordering_invalid(self):
