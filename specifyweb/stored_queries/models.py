...
class Accession(Base):
    ...
    accessionCondition = Column('AccessionCondition', type=types.String, index=False, unique=False, nullable=True)
    accessionNumber = Column('AccessionNumber', type=types.String, index=True, unique=False, nullable=False)
    dateAccessioned = Column('DateAccessioned', type=types.Date, index=True, unique=False, nullable=True)
    dateAcknowledged = Column('DateAcknowledged', type=types.Date, index=False, unique=False, nullable=True)
    dateReceived = Column('DateReceived', type=types.Date, index=False, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    integer3 = Column('Integer3', type=types.Integer, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    status = Column('Status', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.Text, index=False, unique=False, nullable=True)
    text5 = Column('Text5', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    totalValue = Column('TotalValue', type=types.Numeric, index=False, unique=False, nullable=True)
    type = Column('Type', type=types.String, index=False, unique=False, nullable=True)
    verbatimDate = Column('VerbatimDate', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)

    addressOfRecord = Column('AddressOfRecordID', type=types.Integer, ForeignKey='AddressOfRecord.AddressOfRecordID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    division = Column('DivisionID', type=types.Integer, ForeignKey='Division.UserGroupScopeId', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    repositoryAgreement = Column('RepositoryAgreementID', type=types.Integer, ForeignKey='RepositoryAgreement.RepositoryAgreementID', nullable=True, unique=False)
...
class AccessionAgent(Base):
    ...
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    role = Column('Role', type=types.String, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    accession = Column('AccessionID', type=types.Integer, ForeignKey='Accession.AccessionID', nullable=True, unique=False)
    agent = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    repositoryAgreement = Column('RepositoryAgreementID', type=types.Integer, ForeignKey='RepositoryAgreement.RepositoryAgreementID', nullable=True, unique=False)
...
class AccessionAttachment(Base):
    ...
    ordinal = Column('Ordinal', type=types.Integer, index=False, unique=False, nullable=False)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    accession = Column('AccessionID', type=types.Integer, ForeignKey='Accession.AccessionID', nullable=False, unique=False)
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class AccessionAuthorization(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    permit = Column('PermitID', type=types.Integer, ForeignKey='Permit.PermitID', nullable=False, unique=False)
    repositoryAgreement = Column('RepositoryAgreementID', type=types.Integer, ForeignKey='RepositoryAgreement.RepositoryAgreementID', nullable=True, unique=False)
...
class AccessionCitation(Base):
    ...
    figureNumber = Column('FigureNumber', type=types.String, index=False, unique=False, nullable=True)
    isFigured = Column('IsFigured', type=mysql_bit_type, index=False, unique=False, nullable=True)
    pageNumber = Column('PageNumber', type=types.String, index=False, unique=False, nullable=True)
    plateNumber = Column('PlateNumber', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    referenceWork = Column('ReferenceWorkID', type=types.Integer, ForeignKey='ReferenceWork.ReferenceWorkID', nullable=False, unique=False)
...
class Address(Base):
    ...
    address = Column('Address', type=types.String, index=False, unique=False, nullable=True)
    address2 = Column('Address2', type=types.String, index=False, unique=False, nullable=True)
    address3 = Column('Address3', type=types.String, index=False, unique=False, nullable=True)
    address4 = Column('Address4', type=types.String, index=False, unique=False, nullable=True)
    address5 = Column('Address5', type=types.String, index=False, unique=False, nullable=True)
    city = Column('City', type=types.String, index=False, unique=False, nullable=True)
    country = Column('Country', type=types.String, index=False, unique=False, nullable=True)
    endDate = Column('EndDate', type=types.Date, index=False, unique=False, nullable=True)
    fax = Column('Fax', type=types.String, index=False, unique=False, nullable=True)
    isCurrent = Column('IsCurrent', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isPrimary = Column('IsPrimary', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isShipping = Column('IsShipping', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ordinal = Column('Ordinal', type=types.Integer, index=False, unique=False, nullable=True)
    phone1 = Column('Phone1', type=types.String, index=False, unique=False, nullable=True)
    phone2 = Column('Phone2', type=types.String, index=False, unique=False, nullable=True)
    positionHeld = Column('PositionHeld', type=types.String, index=False, unique=False, nullable=True)
    postalCode = Column('PostalCode', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    roomOrBuilding = Column('RoomOrBuilding', type=types.String, index=False, unique=False, nullable=True)
    startDate = Column('StartDate', type=types.Date, index=False, unique=False, nullable=True)
    state = Column('State', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    typeOfAddr = Column('TypeOfAddr', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    agent = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class Agent(Base):
    ...
    abbreviation = Column('Abbreviation', type=types.String, index=True, unique=False, nullable=True)
    agentType = Column('AgentType', type=types.Integer, index=True, unique=False, nullable=False)
    date1 = Column('Date1', type=types.Date, index=False, unique=False, nullable=True)
    date1Precision = Column('Date1Precision', type=types.Integer, index=False, unique=False, nullable=True)
    date2 = Column('Date2', type=types.Date, index=False, unique=False, nullable=True)
    date2Precision = Column('Date2Precision', type=types.Integer, index=False, unique=False, nullable=True)
    dateOfBirth = Column('DateOfBirth', type=types.Date, index=False, unique=False, nullable=True)
    dateOfBirthPrecision = Column('DateOfBirthPrecision', type=types.Integer, index=False, unique=False, nullable=True)
    dateOfDeath = Column('DateOfDeath', type=types.Date, index=False, unique=False, nullable=True)
    dateOfDeathPrecision = Column('DateOfDeathPrecision', type=types.Integer, index=False, unique=False, nullable=True)
    dateType = Column('DateType', type=types.Integer, index=False, unique=False, nullable=True)
    email = Column('Email', type=types.String, index=False, unique=False, nullable=True)
    firstName = Column('FirstName', type=types.String, index=True, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    initials = Column('Initials', type=types.String, index=False, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    interests = Column('Interests', type=types.String, index=False, unique=False, nullable=True)
    jobTitle = Column('JobTitle', type=types.String, index=False, unique=False, nullable=True)
    lastName = Column('LastName', type=types.String, index=True, unique=False, nullable=True)
    middleInitial = Column('MiddleInitial', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    suffix = Column('Suffix', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.Text, index=False, unique=False, nullable=True)
    ...
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    title = Column('Title', type=types.String, index=False, unique=False, nullable=True)
    url = Column('URL', type=types.String, index=False, unique=False, nullable=True)
    verbatimDate1 = Column('VerbatimDate1', type=types.String, index=False, unique=False, nullable=True)
    verbatimDate2 = Column('VerbatimDate2', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    collContentContact = Column('CollectionCCID', type=types.Integer, ForeignKey='Collection.UserGroupScopeId', nullable=True, unique=False)
    collTechContact = Column('CollectionTCID', type=types.Integer, ForeignKey='Collection.UserGroupScopeId', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    division = Column('DivisionID', type=types.Integer, ForeignKey='Division.UserGroupScopeId', nullable=True, unique=False)
    instContentContact = Column('InstitutionCCID', type=types.Integer, ForeignKey='Institution.UserGroupScopeId', nullable=True, unique=False)
    instTechContact = Column('InstitutionTCID', type=types.Integer, ForeignKey='Institution.UserGroupScopeId', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    organization = Column('ParentOrganizationID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    specifyUser = Column('SpecifyUserID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=True, unique=False)
...
class AgentGeography(Base):
    ...
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    role = Column('Role', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    agent = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    geography = Column('GeographyID', type=types.Integer, ForeignKey='Geography.GeographyID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class AgentIdentifier(Base):
    ...
    date2 = Column('Date2', type=types.Date, index=False, unique=False, nullable=True)
    date2Precision = Column('Date2Precision', type=types.Integer, index=False, unique=False, nullable=True)
    identifier = Column('Identifier', type=types.String, index=False, unique=False, nullable=False)
    identifierType = Column('IdentifierType', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    ...
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo3 = Column('YesNo3', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo4 = Column('YesNo4', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo5 = Column('YesNo5', type=mysql_bit_type, index=False, unique=False, nullable=True)
...
class AgentSpecialty(Base):
    ...
    orderNumber = Column('OrderNumber', type=types.Integer, index=False, unique=False, nullable=False)
    specialtyName = Column('SpecialtyName', type=types.String, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class AgentVariant(Base):
    ...
    country = Column('Country', type=types.String, index=False, unique=False, nullable=True)
    language = Column('Language', type=types.String, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    varType = Column('VarType', type=types.Integer, index=False, unique=False, nullable=False)
    variant = Column('Variant', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class Appraisal(Base):
    ...
    appraisalDate = Column('AppraisalDate', type=types.Date, index=True, unique=False, nullable=False)
    appraisalNumber = Column('AppraisalNumber', type=types.String, index=True, unique=True, nullable=False)
    appraisalValue = Column('AppraisalValue', type=types.Numeric, index=False, unique=False, nullable=True)
    monetaryUnitType = Column('MonetaryUnitType', type=types.String, index=False, unique=False, nullable=True)
    notes = Column('Notes', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class Attachment(Base):
    ...
    attachmentLocation = Column('AttachmentLocation', type=types.String, index=False, unique=False, nullable=True)
    attachmentStorageConfig = Column('AttachmentStorageConfig', type=types.Text, index=False, unique=False, nullable=True)
    captureDevice = Column('CaptureDevice', type=types.String, index=False, unique=False, nullable=True)
    copyrightDate = Column('CopyrightDate', type=types.String, index=False, unique=False, nullable=True)
    copyrightHolder = Column('CopyrightHolder', type=types.String, index=False, unique=False, nullable=True)
    credit = Column('Credit', type=types.String, index=False, unique=False, nullable=True)
    dateImaged = Column('DateImaged', type=types.String, index=True, unique=False, nullable=True)
    fileCreatedDate = Column('FileCreatedDate', type=types.Date, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    isPublic = Column('IsPublic', type=mysql_bit_type, index=False, unique=False, nullable=False)
    license = Column('License', type=types.String, index=False, unique=False, nullable=True)
    licenseLogoUrl = Column('LicenseLogoUrl', type=types.String, index=False, unique=False, nullable=True)
    metadataText = Column('MetadataText', type=types.String, index=False, unique=False, nullable=True)
    mimeType = Column('MimeType', type=types.String, index=False, unique=False, nullable=True)
    origFilename = Column('OrigFilename', type=types.Text, index=False, unique=False, nullable=False)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    scopeID = Column('ScopeID', type=types.Integer, index=True, unique=False, nullable=True)
    scopeType = Column('ScopeType', type=types.Integer, index=True, unique=False, nullable=True)
    subjectOrientation = Column('SubjectOrientation', type=types.String, index=False, unique=False, nullable=True)
    subtype = Column('Subtype', type=types.String, index=False, unique=False, nullable=True)
    tableID = Column('TableID', type=types.Integer, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    title = Column('Title', type=types.String, index=True, unique=False, nullable=True)
    type = Column('Type', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    visibility = Column('Visibility', type=types.Integer, index=False, unique=False, nullable=True)

    attachmentImageAttribute = Column('AttachmentImageAttributeID', type=types.Integer, ForeignKey='AttachmentImageAttribute.AttachmentImageAttributeID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    creator = Column('CreatorID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    visibilitySetBy = Column('VisibilitySetByID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=True, unique=False)
...
class AttachmentImageAttribute(Base):
    ...
    creativeCommons = Column('CreativeCommons', type=types.String, index=False, unique=False, nullable=True)
    height = Column('Height', type=types.Integer, index=False, unique=False, nullable=True)
    imageType = Column('ImageType', type=types.String, index=False, unique=False, nullable=True)
    magnification = Column('Magnification', type=types.Float, index=False, unique=False, nullable=True)
    mbImageId = Column('MBImageID', type=types.Integer, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    resolution = Column('Resolution', type=types.Float, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampLastSend = Column('TimestampLastSend', type=types.DateTime, index=False, unique=False, nullable=True)
    timestampLastUpdateCheck = Column('TimestampLastUpdateCheck', type=types.DateTime, index=False, unique=False, nullable=True)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    viewDescription = Column('ViewDescription', type=types.String, index=False, unique=False, nullable=True)
    width = Column('Width', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)

    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    morphBankView = Column('MorphBankViewID', type=types.Integer, ForeignKey='MorphBankView.MorphBankViewID', nullable=True, unique=False)
...
class AttachmentMetadata(Base):
    ...
    name = Column('Name', type=types.String, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    value = Column('Value', type=types.String, index=False, unique=False, nullable=False)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class AttachmentTag(Base):
    ...
    tag = Column('Tag', type=types.String, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class AttributeDef(Base):
    ...
    dataType = Column('DataType', type=types.Integer, index=False, unique=False, nullable=True)
    fieldName = Column('FieldName', type=types.String, index=False, unique=False, nullable=True)
    tableType = Column('TableType', type=types.Integer, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    prepType = Column('PrepTypeID', type=types.Integer, ForeignKey='PrepType.PrepTypeID', nullable=True, unique=False)
...
class AutoNumberingScheme(Base):
    ...
    formatName = Column('FormatName', type=types.String, index=False, unique=False, nullable=True)
    isNumericOnly = Column('IsNumericOnly', type=mysql_bit_type, index=False, unique=False, nullable=False)
    schemeClassName = Column('SchemeClassName', type=types.String, index=False, unique=False, nullable=True)
    schemeName = Column('SchemeName', type=types.String, index=True, unique=False, nullable=True)
    tableNumber = Column('TableNumber', type=types.Integer, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class Borrow(Base):
    ...
    borrowDate = Column('BorrowDate', type=types.Date, index=False, unique=False, nullable=True)
    borrowDatePrecision = Column('BorrowDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    currentDueDate = Column('CurrentDueDate', type=types.Date, index=False, unique=False, nullable=True)
    dateClosed = Column('DateClosed', type=types.Date, index=False, unique=False, nullable=True)
    invoiceNumber = Column('InvoiceNumber', type=types.String, index=True, unique=False, nullable=False)
    isClosed = Column('IsClosed', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isFinancialResponsibility = Column('IsFinancialResponsibility', type=mysql_bit_type, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    numberOfItemsBorrowed = Column('NumberOfItemsBorrowed', type=types.Integer, index=False, unique=False, nullable=True)
    originalDueDate = Column('OriginalDueDate', type=types.Date, index=False, unique=False, nullable=True)
    receivedDate = Column('ReceivedDate', type=types.Date, index=True, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    status = Column('Status', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
...
class BorrowAgent(Base):
    ...
    agent = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    borrow = Column('BorrowID', type=types.Integer, ForeignKey='Borrow.BorrowID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class BorrowMaterial(Base):
    ...
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    description = Column('Description', type=types.String, index=True, unique=False, nullable=True)
    inComments = Column('InComments', type=types.Text, index=False, unique=False, nullable=True)
    materialNumber = Column('MaterialNumber', type=types.String, index=True, unique=False, nullable=False)
    outComments = Column('OutComments', type=types.Text, index=False, unique=False, nullable=True)
    quantity = Column('Quantity', type=types.Integer, index=False, unique=False, nullable=True)
    quantityResolved = Column('QuantityResolved', type=types.Integer, index=False, unique=False, nullable=True)
    quantityReturned = Column('QuantityReturned', type=types.Integer, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
...
class BorrowReturnMaterial(Base):
    ...
    quantity = Column('Quantity', type=types.Integer, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    returnedDate = Column('ReturnedDate', type=types.Date, index=True, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    agent = Column('ReturnedByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    borrowMaterial = Column('BorrowMaterialID', type=types.Integer, ForeignKey='BorrowMaterial.BorrowMaterialID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class CollectingEvent(Base):
    ...
    endDate = Column('EndDate', type=types.Date, index=True, unique=False, nullable=True)
    endDatePrecision = Column('EndDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    endDateVerbatim = Column('EndDateVerbatim', type=types.String, index=False, unique=False, nullable=True)
    endTime = Column('EndTime', type=types.Integer, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    method = Column('Method', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    reservedInteger3 = Column('ReservedInteger3', type=types.Integer, index=False, unique=False, nullable=True)
    reservedInteger4 = Column('ReservedInteger4', type=types.Integer, index=False, unique=False, nullable=True)
    reservedText1 = Column('ReservedText1', type=types.String, index=False, unique=False, nullable=True)
    reservedText2 = Column('ReservedText2', type=types.String, index=False, unique=False, nullable=True)
    sgrStatus = Column('SGRStatus', type=types.Integer, index=False, unique=False, nullable=True)
    startDate = Column('StartDate', type=types.Date, index=True, unique=False, nullable=True)
    startDatePrecision = Column('StartDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    startDateVerbatim = Column('StartDateVerbatim', type=types.String, index=False, unique=False, nullable=True)
    startTime = Column('StartTime', type=types.Integer, index=False, unique=False, nullable=True)
    stationFieldNumber = Column('StationFieldNumber', type=types.String, index=True, unique=False, nullable=True)
    stationFieldNumberModifier1 = Column('StationFieldNumberModifier1', type=types.String, index=False, unique=False, nullable=True)
    stationFieldNumberModifier2 = Column('StationFieldNumberModifier2', type=types.String, index=False, unique=False, nullable=True)
    stationFieldNumberModifier3 = Column('StationFieldNumberModifier3', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.Text, index=False, unique=False, nullable=True)
    text5 = Column('Text5', type=types.Text, index=False, unique=False, nullable=True)
    text6 = Column('Text6', type=types.Text, index=False, unique=False, nullable=True)
    text7 = Column('Text7', type=types.Text, index=False, unique=False, nullable=True)
    text8 = Column('Text8', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    uniqueIdentifier = Column('UniqueIdentifier', type=types.String, index=True, unique=False, nullable=True)
    verbatimDate = Column('VerbatimDate', type=types.String, index=False, unique=False, nullable=True)
    verbatimLocality = Column('VerbatimLocality', type=types.Text, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    visibility = Column('Visibility', type=types.Integer, index=False, unique=False, nullable=True)

    collectingEventAttribute = Column('CollectingEventAttributeID', type=types.Integer, ForeignKey='CollectingEventAttribute.CollectingEventAttributeID', nullable=True, unique=False)
    collectingTrip = Column('CollectingTripID', type=types.Integer, ForeignKey='CollectingTrip.CollectingTripID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    locality = Column('LocalityID', type=types.Integer, ForeignKey='Locality.LocalityID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    paleoContext = Column('PaleoContextID', type=types.Integer, ForeignKey='PaleoContext.PaleoContextID', nullable=True, unique=False)
    visibilitySetBy = Column('VisibilitySetByID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=True, unique=False)
...
class CollectingEventAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    collectingEvent = Column('CollectingEventID', type=types.Integer, ForeignKey='CollectingEvent.CollectingEventID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class CollectingEventAttr(Base):
    ...
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    dblValue = Column('DoubleValue', type=types.Float, index=False, unique=False, nullable=True)
    strValue = Column('StrValue', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    collectingEvent = Column('CollectingEventID', type=types.Integer, ForeignKey='CollectingEvent.CollectingEventID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    definition = Column('AttributeDefID', type=types.Integer, ForeignKey='AttributeDef.AttributeDefID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class CollectingEventAttribute(Base):
    ...
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer10 = Column('Integer10', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    integer3 = Column('Integer3', type=types.Integer, index=False, unique=False, nullable=True)
    integer4 = Column('Integer4', type=types.Integer, index=False, unique=False, nullable=True)
    integer5 = Column('Integer5', type=types.Integer, index=False, unique=False, nullable=True)
    integer6 = Column('Integer6', type=types.Integer, index=False, unique=False, nullable=True)
    integer7 = Column('Integer7', type=types.Integer, index=False, unique=False, nullable=True)
    integer8 = Column('Integer8', type=types.Integer, index=False, unique=False, nullable=True)
    integer9 = Column('Integer9', type=types.Integer, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number10 = Column('Number10', type=types.Numeric, index=False, unique=False, nullable=True)
    number11 = Column('Number11', type=types.Numeric, index=False, unique=False, nullable=True)
    number12 = Column('Number12', type=types.Numeric, index=False, unique=False, nullable=True)
    number13 = Column('Number13', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    number4 = Column('Number4', type=types.Numeric, index=False, unique=False, nullable=True)
    number5 = Column('Number5', type=types.Numeric, index=False, unique=False, nullable=True)
    number6 = Column('Number6', type=types.Numeric, index=False, unique=False, nullable=True)
    number7 = Column('Number7', type=types.Numeric, index=False, unique=False, nullable=True)
    number8 = Column('Number8', type=types.Numeric, index=False, unique=False, nullable=True)
    number9 = Column('Number9', type=types.Numeric, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text10 = Column('Text10', type=types.Text, index=False, unique=False, nullable=True)
    text11 = Column('Text11', type=types.Text, index=False, unique=False, nullable=True)
    text12 = Column('Text12', type=types.Text, index=False, unique=False, nullable=True)
    text13 = Column('Text13', type=types.Text, index=False, unique=False, nullable=True)
    text14 = Column('Text14', type=types.Text, index=False, unique=False, nullable=True)
    text15 = Column('Text15', type=types.Text, index=False, unique=False, nullable=True)
    text16 = Column('Text16', type=types.Text, index=False, unique=False, nullable=True)
    text17 = Column('Text17', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.String, index=False, unique=False, nullable=True)
    text5 = Column('Text5', type=types.String, index=False, unique=False, nullable=True)
    text6 = Column('Text6', type=types.Text, index=False, unique=False, nullable=True)
    text7 = Column('Text7', type=types.Text, index=False, unique=False, nullable=True)
    text8 = Column('Text8', type=types.Text, index=False, unique=False, nullable=True)
    text9 = Column('Text9', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    hostTaxon = Column('HostTaxonID', type=types.Integer, ForeignKey='Taxon.TaxonID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class CollectingEventAuthorization(Base):
    ...
    collectingEvent = Column('CollectingEventID', type=types.Integer, ForeignKey='CollectingEvent.CollectingEventID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    permit = Column('PermitID', type=types.Integer, ForeignKey='Permit.PermitID', nullable=False, unique=False)
...
class CollectingTrip(Base):
    ...
    collectingTripName = Column('CollectingTripName', type=types.String, index=True, unique=False, nullable=True)
    cruise = Column('Cruise', type=types.String, index=False, unique=False, nullable=True)
    date1 = Column('Date1', type=types.Date, index=False, unique=False, nullable=True)
    date1Precision = Column('Date1Precision', type=types.Integer, index=False, unique=False, nullable=True)
    date2 = Column('Date2', type=types.Date, index=False, unique=False, nullable=True)
    date2Precision = Column('Date2Precision', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    endDateVerbatim = Column('EndDateVerbatim', type=types.String, index=False, unique=False, nullable=True)
    endTime = Column('EndTime', type=types.Integer, index=False, unique=False, nullable=True)
    expedition = Column('Expedition', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Integer, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Integer, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    sponsor = Column('Sponsor', type=types.String, index=False, unique=False, nullable=True)
    startDate = Column('StartDate', type=types.Date, index=True, unique=False, nullable=True)
    startDatePrecision = Column('StartDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    startDateVerbatim = Column('StartDateVerbatim', type=types.String, index=False, unique=False, nullable=True)
    startTime = Column('StartTime', type=types.Integer, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.String, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.String, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.String, index=False, unique=False, nullable=True)
    text5 = Column('Text5', type=types.Text, index=False, unique=False, nullable=True)
    text6 = Column('Text6', type=types.Text, index=False, unique=False, nullable=True)
    text7 = Column('Text7', type=types.Text, index=False, unique=False, nullable=True)
    ...
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    vessel = Column('Vessel', type=types.String, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)

    agent1 = Column('Agent1ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent2 = Column('Agent2ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    collectingTripAttribute = Column('CollectingTripAttributeID', type=types.Integer, ForeignKey='CollectingTripAttribute.CollectingTripAttributeID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class CollectingTripAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    collectingTrip = Column('CollectingTripID', type=types.Integer, ForeignKey='CollectingTrip.CollectingTripID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class CollectingTripAttribute(Base):
    ...
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text10 = Column('Text10', type=types.String, index=False, unique=False, nullable=True)
    text11 = Column('Text11', type=types.String, index=False, unique=False, nullable=True)
    text12 = Column('Text12', type=types.String, index=False, unique=False, nullable=True)
    text13 = Column('Text13', type=types.String, index=False, unique=False, nullable=True)
    text14 = Column('Text14', type=types.String, index=False, unique=False, nullable=True)
    text15 = Column('Text15', type=types.String, index=False, unique=False, nullable=True)
    text16 = Column('Text16', type=types.String, index=False, unique=False, nullable=True)
    text17 = Column('Text17', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.String, index=False, unique=False, nullable=True)
    text5 = Column('Text5', type=types.String, index=False, unique=False, nullable=True)
    text6 = Column('Text6', type=types.String, index=False, unique=False, nullable=True)
    text7 = Column('Text7', type=types.String, index=False, unique=False, nullable=True)
    text8 = Column('Text8', type=types.String, index=False, unique=False, nullable=True)
    text9 = Column('Text9', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
...
class Collection(Base):
    ...
    catalogNumFormatName = Column('CatalogFormatNumName', type=types.String, index=False, unique=False, nullable=False)
    code = Column('Code', type=types.String, index=False, unique=False, nullable=True)
    collectionName = Column('CollectionName', type=types.String, index=True, unique=False, nullable=True)
    collectionType = Column('CollectionType', type=types.String, index=False, unique=False, nullable=True)
    dbContentVersion = Column('DbContentVersion', type=types.String, index=False, unique=False, nullable=True)
    description = Column('Description', type=types.Text, index=False, unique=False, nullable=True)
    developmentStatus = Column('DevelopmentStatus', type=types.String, index=False, unique=False, nullable=True)
    estimatedSize = Column('EstimatedSize', type=types.Integer, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    institutionType = Column('InstitutionType', type=types.String, index=False, unique=False, nullable=True)
    isEmbeddedCollectingEvent = Column('IsEmbeddedCollectingEvent', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isaNumber = Column('IsaNumber', type=types.String, index=False, unique=False, nullable=True)
    kingdomCoverage = Column('KingdomCoverage', type=types.String, index=False, unique=False, nullable=True)
    preservationMethodType = Column('PreservationMethodType', type=types.String, index=False, unique=False, nullable=True)
    primaryFocus = Column('PrimaryFocus', type=types.String, index=False, unique=False, nullable=True)
    primaryPurpose = Column('PrimaryPurpose', type=types.String, index=False, unique=False, nullable=True)
    regNumber = Column('RegNumber', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    scope = Column('Scope', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    webPortalURI = Column('WebPortalURI', type=types.String, index=False, unique=False, nullable=True)
    webSiteURI = Column('WebSiteURI', type=types.String, index=False, unique=False, nullable=True)

    adminContact = Column('AdminContactID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    institutionNetwork = Column('InstitutionNetworkID', type=types.Integer, ForeignKey='Institution.UserGroupScopeId', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class CollectionObject(Base):
    ...
    altCatalogNumber = Column('AltCatalogNumber', type=types.String, index=True, unique=False, nullable=True)
    availability = Column('Availability', type=types.String, index=False, unique=False, nullable=True)
    catalogNumber = Column('CatalogNumber', type=types.String, index=True, unique=False, nullable=True)
    catalogedDate = Column('CatalogedDate', type=types.Date, index=True, unique=False, nullable=True)
    catalogedDatePrecision = Column('CatalogedDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    catalogedDateVerbatim = Column('CatalogedDateVerbatim', type=types.String, index=False, unique=False, nullable=True)
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=False, unique=False, nullable=False)
    countAmt = Column('CountAmt', type=types.Integer, index=False, unique=False, nullable=True)
    date1 = Column('Date1', type=types.Date, index=False, unique=False, nullable=True)
    date1Precision = Column('Date1Precision', type=types.Integer, index=False, unique=False, nullable=True)
    deaccessioned = Column('Deaccessioned', type=mysql_bit_type, index=False, unique=False, nullable=True)
    description = Column('Description', type=types.Text, index=False, unique=False, nullable=True)
    embargoReason = Column('EmbargoReason', type=types.Text, index=False, unique=False, nullable=True)
    embargoReleaseDate = Column('EmbargoReleaseDate', type=types.Date, index=False, unique=False, nullable=True)
    embargoReleaseDatePrecision = Column('EmbargoReleaseDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    embargoStartDate = Column('EmbargoStartDate', type=types.Date, index=False, unique=False, nullable=True)
    embargoStartDatePrecision = Column('EmbargoStartDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    fieldNumber = Column('FieldNumber', type=types.String, index=True, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    inventoryDate = Column('InventoryDate', type=types.Date, index=False, unique=False, nullable=True)
    inventoryDatePrecision = Column('InventoryDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    modifier = Column('Modifier', type=types.String, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=True)
    notifications = Column('Notifications', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    numberOfDuplicates = Column('NumberOfDuplicates', type=types.Integer, index=False, unique=False, nullable=True)
    objectCondition = Column('ObjectCondition', type=types.String, index=False, unique=False, nullable=True)
    ocr = Column('OCR', type=types.Text, index=False, unique=False, nullable=True)
    projectNumber = Column('ProjectNumber', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    reservedInteger3 = Column('ReservedInteger3', type=types.Integer, index=False, unique=False, nullable=True)
    reservedInteger4 = Column('ReservedInteger4', type=types.Integer, index=False, unique=False, nullable=True)
    reservedText = Column('ReservedText', type=types.String, index=False, unique=False, nullable=True)
    reservedText2 = Column('ReservedText2', type=types.String, index=False, unique=False, nullable=True)
    reservedText3 = Column('ReservedText3', type=types.String, index=False, unique=False, nullable=True)
    restrictions = Column('Restrictions', type=types.String, index=False, unique=False, nullable=True)
    sgrStatus = Column('SGRStatus', type=types.Integer, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    ...
    yesNo4 = Column('YesNo4', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo5 = Column('YesNo5', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo6 = Column('YesNo6', type=mysql_bit_type, index=False, unique=False, nullable=True)

    accession = Column('AccessionID', type=types.Integer, ForeignKey='Accession.AccessionID', nullable=True, unique=False)
    agent1 = Column('Agent1ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    appraisal = Column('AppraisalID', type=types.Integer, ForeignKey='Appraisal.AppraisalID', nullable=True, unique=False)
    cataloger = Column('CatalogerID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    collectingEvent = Column('CollectingEventID', type=types.Integer, ForeignKey='CollectingEvent.CollectingEventID', nullable=True, unique=False)
    collection = Column('CollectionID', type=types.Integer, ForeignKey='Collection.UserGroupScopeId', nullable=False, unique=False)
    collectionObjectAttribute = Column('CollectionObjectAttributeID', type=types.Integer, ForeignKey='CollectionObjectAttribute.CollectionObjectAttributeID', nullable=True, unique=False)
    container = Column('ContainerID', type=types.Integer, ForeignKey='Container.ContainerID', nullable=True, unique=False)
    containerOwner = Column('ContainerOwnerID', type=types.Integer, ForeignKey='Container.ContainerID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    embargoAuthority = Column('EmbargoAuthorityID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    fieldNotebookPage = Column('FieldNotebookPageID', type=types.Integer, ForeignKey='FieldNotebookPage.FieldNotebookPageID', nullable=True, unique=False)
    inventorizedBy = Column('InventorizedByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    paleoContext = Column('PaleoContextID', type=types.Integer, ForeignKey='PaleoContext.PaleoContextID', nullable=True, unique=False)
    visibilitySetBy = Column('VisibilitySetByID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=True, unique=False)
...
class CollectionObjectAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    collectionObject = Column('CollectionObjectID', type=types.Integer, ForeignKey='CollectionObject.CollectionObjectID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class CollectionObjectAttribute(Base):
    ...
    bottomDistance = Column('BottomDistance', type=types.Numeric, index=False, unique=False, nullable=True)
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    date1 = Column('Date1', type=types.Date, index=False, unique=False, nullable=True)
    date1Precision = Column('Date1Precision', type=types.Integer, index=False, unique=False, nullable=True)
    direction = Column('Direction', type=types.String, index=False, unique=False, nullable=True)
    distanceUnits = Column('DistanceUnits', type=types.String, index=False, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer10 = Column('Integer10', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    integer3 = Column('Integer3', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    number12 = Column('Number12', type=types.Numeric, index=False, unique=False, nullable=True)
    number13 = Column('Number13', type=types.Numeric, index=False, unique=False, nullable=True)
    number14 = Column('Number14', type=types.Numeric, index=False, unique=False, nullable=True)
    number15 = Column('Number15', type=types.Numeric, index=False, unique=False, nullable=True)
    number16 = Column('Number16', type=types.Numeric, index=False, unique=False, nullable=True)
    number17 = Column('Number17', type=types.Numeric, index=False, unique=False, nullable=True)
    number18 = Column('Number18', type=types.Numeric, index=False, unique=False, nullable=True)
    number19 = Column('Number19', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    number20 = Column('Number20', type=types.Numeric, index=False, unique=False, nullable=True)
    number21 = Column('Number21', type=types.Numeric, index=False, unique=False, nullable=True)
    number22 = Column('Number22', type=types.Numeric, index=False, unique=False, nullable=True)
    number23 = Column('Number23', type=types.Numeric, index=False, unique=False, nullable=True)
    number24 = Column('Number24', type=types.Numeric, index=False, unique=False, nullable=True)
    number25 = Column('Number25', type=types.Numeric, index=False, unique=False, nullable=True)
    number26 = Column('Number26', type=types.Numeric, index=False, unique=False, nullable=True)
    number27 = Column('Number27', type=types.Numeric, index=False, unique=False, nullable=True)
    number28 = Column('Number28', type=types.Numeric, index=False, unique=False, nullable=True)
    number29 = Column('Number29', type=types.Numeric, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    number30 = Column('Number30', type=types.Integer, index=False, unique=False, nullable=True)
    number31 = Column('Number31', type=types.Numeric, index=False, unique=False, nullable=True)
    number32 = Column('Number32', type=types.Numeric, index=False, unique=False, nullable=True)
    number33 = Column('Number33', type=types.Numeric, index=False, unique=False, nullable=True)
    number34 = Column('Number34', type=types.Numeric, index=False, unique=False, nullable=True)
    number35 = Column('Number35', type=types.Numeric, index=False, unique=False, nullable=True)
    number36 = Column('Number36', type=types.Numeric, index=False, unique=False, nullable=True)
    number37 = Column('Number37', type=types.Numeric, index=False, unique=False, nullable=True)
    number38 = Column('Number38', type=types.Numeric, index=False, unique=False, nullable=True)
    number39 = Column('Number39', type=types.Numeric, index=False, unique=False, nullable=True)
    number4 = Column('Number4', type=types.Numeric, index=False, unique=False, nullable=True)
    number40 = Column('Number40', type=types.Numeric, index=False, unique=False, nullable=True)
    number41 = Column('Number41', type=types.Numeric, index=False, unique=False, nullable=True)
    number42 = Column('Number42', type=types.Numeric, index=False, unique=False, nullable=True)
    number5 = Column('Number5', type=types.Numeric, index=False, unique=False, nullable=True)
    number6 = Column('Number6', type=types.Numeric, index=False, unique=False, nullable=True)
    number7 = Column('Number7', type=types.Numeric, index=False, unique=False, nullable=True)
    number8 = Column('Number8', type=types.Integer, index=False, unique=False, nullable=True)
    number9 = Column('Number9', type=types.Numeric, index=False, unique=False, nullable=True)
    positionState = Column('PositionState', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text10 = Column('Text10', type=types.String, index=False, unique=False, nullable=True)
    text11 = Column('Text11', type=types.String, index=False, unique=False, nullable=True)
    ...
    text16 = Column('Text16', type=types.Text, index=False, unique=False, nullable=True)
    text17 = Column('Text17', type=types.Text, index=False, unique=False, nullable=True)
    text18 = Column('Text18', type=types.Text, index=False, unique=False, nullable=True)
    text19 = Column('Text19', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text20 = Column('Text20', type=types.Text, index=False, unique=False, nullable=True)
    text21 = Column('Text21', type=types.Text, index=False, unique=False, nullable=True)
    text22 = Column('Text22', type=types.Text, index=False, unique=False, nullable=True)
    text23 = Column('Text23', type=types.Text, index=False, unique=False, nullable=True)
    text24 = Column('Text24', type=types.Text, index=False, unique=False, nullable=True)
    text25 = Column('Text25', type=types.Text, index=False, unique=False, nullable=True)
    text26 = Column('Text26', type=types.Text, index=False, unique=False, nullable=True)
    text27 = Column('Text27', type=types.Text, index=False, unique=False, nullable=True)
    text28 = Column('Text28', type=types.Text, index=False, unique=False, nullable=True)
    text29 = Column('Text29', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text30 = Column('Text30', type=types.Text, index=False, unique=False, nullable=True)
    text31 = Column('Text31', type=types.Text, index=False, unique=False, nullable=True)
    text32 = Column('Text32', type=types.Text, index=False, unique=False, nullable=True)
    text33 = Column('Text33', type=types.Text, index=False, unique=False, nullable=True)
    text34 = Column('Text34', type=types.Text, index=False, unique=False, nullable=True)
    text35 = Column('Text35', type=types.Text, index=False, unique=False, nullable=True)
    text36 = Column('Text36', type=types.Text, index=False, unique=False, nullable=True)
    text37 = Column('Text37', type=types.Text, index=False, unique=False, nullable=True)
    text38 = Column('Text38', type=types.Text, index=False, unique=False, nullable=True)
    text39 = Column('Text39', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.String, index=False, unique=False, nullable=True)
    text40 = Column('Text40', type=types.Text, index=False, unique=False, nullable=True)
    text5 = Column('Text5', type=types.String, index=False, unique=False, nullable=True)
    text6 = Column('Text6', type=types.String, index=False, unique=False, nullable=True)
    text7 = Column('Text7', type=types.String, index=False, unique=False, nullable=True)
    text8 = Column('Text8', type=types.String, index=False, unique=False, nullable=True)
    ...
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    topDistance = Column('TopDistance', type=types.Numeric, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo10 = Column('YesNo10', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo11 = Column('YesNo11', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo12 = Column('YesNo12', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo13 = Column('YesNo13', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo14 = Column('YesNo14', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo15 = Column('YesNo15', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo16 = Column('YesNo16', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo17 = Column('YesNo17', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo18 = Column('YesNo18', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo19 = Column('YesNo19', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo20 = Column('YesNo20', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo3 = Column('YesNo3', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo4 = Column('YesNo4', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo5 = Column('YesNo5', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo6 = Column('YesNo6', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo7 = Column('YesNo7', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo8 = Column('YesNo8', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo9 = Column('YesNo9', type=mysql_bit_type, index=False, unique=False, nullable=True)
...
class CollectionObjectProperty(Base):
    ...
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    date1 = Column('Date1', type=types.Date, index=False, unique=False, nullable=True)
    date10 = Column('Date10', type=types.Date, index=False, unique=False, nullable=True)
    date11 = Column('Date11', type=types.Date, index=False, unique=False, nullable=True)
    date12 = Column('Date12', type=types.Date, index=False, unique=False, nullable=True)
    date13 = Column('Date13', type=types.Date, index=False, unique=False, nullable=True)
    date14 = Column('Date14', type=types.Date, index=False, unique=False, nullable=True)
    date15 = Column('Date15', type=types.Date, index=False, unique=False, nullable=True)
    date16 = Column('Date16', type=types.Date, index=False, unique=False, nullable=True)
    date17 = Column('Date17', type=types.Date, index=False, unique=False, nullable=True)
    date18 = Column('Date18', type=types.Date, index=False, unique=False, nullable=True)
    date19 = Column('Date19', type=types.Date, index=False, unique=False, nullable=True)
    date2 = Column('Date2', type=types.Date, index=False, unique=False, nullable=True)
    date20 = Column('Date20', type=types.Date, index=False, unique=False, nullable=True)
    date3 = Column('Date3', type=types.Date, index=False, unique=False, nullable=True)
    date4 = Column('Date4', type=types.Date, index=False, unique=False, nullable=True)
    date5 = Column('Date5', type=types.Date, index=False, unique=False, nullable=True)
    date6 = Column('Date6', type=types.Date, index=False, unique=False, nullable=True)
    date7 = Column('Date7', type=types.Date, index=False, unique=False, nullable=True)
    date8 = Column('Date8', type=types.Date, index=False, unique=False, nullable=True)
    date9 = Column('Date9', type=types.Date, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=False, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer10 = Column('Integer10', type=types.Integer, index=False, unique=False, nullable=True)
    integer11 = Column('Integer11', type=types.Integer, index=False, unique=False, nullable=True)
    integer12 = Column('Integer12', type=types.Integer, index=False, unique=False, nullable=True)
    integer13 = Column('Integer13', type=types.Integer, index=False, unique=False, nullable=True)
    integer14 = Column('Integer14', type=types.Integer, index=False, unique=False, nullable=True)
    integer15 = Column('Integer15', type=types.Integer, index=False, unique=False, nullable=True)
    integer16 = Column('Integer16', type=types.Integer, index=False, unique=False, nullable=True)
    integer17 = Column('Integer17', type=types.Integer, index=False, unique=False, nullable=True)
    integer18 = Column('Integer18', type=types.Integer, index=False, unique=False, nullable=True)
    integer19 = Column('Integer19', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    integer20 = Column('Integer20', type=types.Integer, index=False, unique=False, nullable=True)
    integer21 = Column('Integer21', type=types.Integer, index=False, unique=False, nullable=True)
    integer22 = Column('Integer22', type=types.Integer, index=False, unique=False, nullable=True)
    integer23 = Column('Integer23', type=types.Integer, index=False, unique=False, nullable=True)
    integer24 = Column('Integer24', type=types.Integer, index=False, unique=False, nullable=True)
    integer25 = Column('Integer25', type=types.Integer, index=False, unique=False, nullable=True)
    integer26 = Column('Integer26', type=types.Integer, index=False, unique=False, nullable=True)
    integer27 = Column('Integer27', type=types.Integer, index=False, unique=False, nullable=True)
    integer28 = Column('Integer28', type=types.Integer, index=False, unique=False, nullable=True)
    integer29 = Column('Integer29', type=types.Integer, index=False, unique=False, nullable=True)
    integer3 = Column('Integer3', type=types.Integer, index=False, unique=False, nullable=True)
    integer30 = Column('Integer30', type=types.Integer, index=False, unique=False, nullable=True)
    integer4 = Column('Integer4', type=types.Integer, index=False, unique=False, nullable=True)
    integer5 = Column('Integer5', type=types.Integer, index=False, unique=False, nullable=True)
    integer6 = Column('Integer6', type=types.Integer, index=False, unique=False, nullable=True)
    integer7 = Column('Integer7', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    number29 = Column('Number29', type=types.Numeric, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    number30 = Column('Number30', type=types.Numeric, index=False, unique=False, nullable=True)
    number4 = Column('Number4', type=types.Numeric, index=False, unique=False, nullable=True)
    number5 = Column('Number5', type=types.Numeric, index=False, unique=False, nullable=True)
    number6 = Column('Number6', type=types.Numeric, index=False, unique=False, nullable=True)
    number7 = Column('Number7', type=types.Numeric, index=False, unique=False, nullable=True)
    ...
    text16 = Column('Text16', type=types.String, index=False, unique=False, nullable=True)
    text17 = Column('Text17', type=types.String, index=False, unique=False, nullable=True)
    text18 = Column('Text18', type=types.String, index=False, unique=False, nullable=True)
    text19 = Column('Text19', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.String, index=False, unique=False, nullable=True)
    text20 = Column('Text20', type=types.String, index=False, unique=False, nullable=True)
    text21 = Column('Text21', type=types.String, index=False, unique=False, nullable=True)
    text22 = Column('Text22', type=types.String, index=False, unique=False, nullable=True)
    text23 = Column('Text23', type=types.String, index=False, unique=False, nullable=True)
    text24 = Column('Text24', type=types.String, index=False, unique=False, nullable=True)
    text25 = Column('Text25', type=types.String, index=False, unique=False, nullable=True)
    text26 = Column('Text26', type=types.String, index=False, unique=False, nullable=True)
    text27 = Column('Text27', type=types.String, index=False, unique=False, nullable=True)
    text28 = Column('Text28', type=types.String, index=False, unique=False, nullable=True)
    text29 = Column('Text29', type=types.String, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.String, index=False, unique=False, nullable=True)
    text30 = Column('Text30', type=types.String, index=False, unique=False, nullable=True)
    text31 = Column('Text31', type=types.Text, index=False, unique=False, nullable=True)
    text32 = Column('Text32', type=types.Text, index=False, unique=False, nullable=True)
    text33 = Column('Text33', type=types.Text, index=False, unique=False, nullable=True)
    text34 = Column('Text34', type=types.Text, index=False, unique=False, nullable=True)
    ...
    agent1 = Column('Agent1ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent10 = Column('Agent10ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent11 = Column('Agent11ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent12 = Column('Agent12ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent13 = Column('Agent13ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent14 = Column('Agent14ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent15 = Column('Agent15ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent16 = Column('Agent16ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent17 = Column('Agent17ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent18 = Column('Agent18ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent19 = Column('Agent19ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent2 = Column('Agent2ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent20 = Column('Agent20ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent3 = Column('Agent3ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent4 = Column('Agent4ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent5 = Column('Agent5ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent6 = Column('Agent6ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent7 = Column('Agent7ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent8 = Column('Agent8D', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    agent9 = Column('Agent9ID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    collectionObject = Column('CollectionObjectID', type=types.Integer, ForeignKey='CollectionObject.CollectionObjectID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class CollectionRelType(Base):
    ...
    name = Column('Name', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    leftSideCollection = Column('LeftSideCollectionID', type=types.Integer, ForeignKey='Collection.UserGroupScopeId', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    rightSideCollection = Column('RightSideCollectionID', type=types.Integer, ForeignKey='Collection.UserGroupScopeId', nullable=True, unique=False)
...
class CollectionRelationship(Base):
    ...
    collectionRelType = Column('CollectionRelTypeID', type=types.Integer, ForeignKey='CollectionRelType.CollectionRelTypeID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    leftSide = Column('LeftSideCollectionID', type=types.Integer, ForeignKey='CollectionObject.CollectionObjectID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    rightSide = Column('RightSideCollectionID', type=types.Integer, ForeignKey='CollectionObject.CollectionObjectID', nullable=False, unique=False)
...
class Collector(Base):
    ...
    isPrimary = Column('IsPrimary', type=mysql_bit_type, index=False, unique=False, nullable=False)
    orderNumber = Column('OrderNumber', type=types.Integer, index=False, unique=False, nullable=False)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
...
class CommonNameTx(Base):
    ...
    author = Column('Author', type=types.String, index=False, unique=False, nullable=True)
    country = Column('Country', type=types.String, index=True, unique=False, nullable=True)
    language = Column('Language', type=types.String, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    variant = Column('Variant', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    taxon = Column('TaxonID', type=types.Integer, ForeignKey='Taxon.TaxonID', nullable=False, unique=False)
...
class CommonNameTxCitation(Base):
    ...
    commonNameTx = Column('CommonNameTxID', type=types.Integer, ForeignKey='CommonNameTx.CommonNameTxID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    referenceWork = Column('ReferenceWorkID', type=types.Integer, ForeignKey='ReferenceWork.ReferenceWorkID', nullable=False, unique=False)
...
class ConservDescription(Base):
    ...
    backgroundInfo = Column('BackgroundInfo', type=types.Text, index=False, unique=False, nullable=True)
    composition = Column('Composition', type=types.Text, index=False, unique=False, nullable=True)
    date1 = Column('Date1', type=types.Date, index=False, unique=False, nullable=True)
    date1Precision = Column('Date1Precision', type=types.Integer, index=False, unique=False, nullable=True)
    date2 = Column('Date2', type=types.Date, index=False, unique=False, nullable=True)
    date2Precision = Column('Date2Precision', type=types.Integer, index=False, unique=False, nullable=True)
    date3 = Column('Date3', type=types.Date, index=False, unique=False, nullable=True)
    date3Precision = Column('Date3Precision', type=types.Integer, index=False, unique=False, nullable=True)
    date4 = Column('Date4', type=types.Date, index=False, unique=False, nullable=True)
    date4Precision = Column('Date4Precision', type=types.Integer, index=False, unique=False, nullable=True)
    date5 = Column('Date5', type=types.Date, index=False, unique=False, nullable=True)
    date5Precision = Column('Date5Precision', type=types.Integer, index=False, unique=False, nullable=True)
    description = Column('Description', type=types.Text, index=False, unique=False, nullable=True)
    determinedDate = Column('CatalogedDate', type=types.Date, index=False, unique=False, nullable=True)
    displayRecommendations = Column('DisplayRecommendations', type=types.Text, index=False, unique=False, nullable=True)
    height = Column('Height', type=types.Numeric, index=False, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    integer3 = Column('Integer3', type=types.Integer, index=False, unique=False, nullable=True)
    integer4 = Column('Integer4', type=types.Integer, index=False, unique=False, nullable=True)
    integer5 = Column('Integer5', type=types.Integer, index=False, unique=False, nullable=True)
    lightRecommendations = Column('LightRecommendations', type=types.Text, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    number4 = Column('Number4', type=types.Numeric, index=False, unique=False, nullable=True)
    number5 = Column('Number5', type=types.Numeric, index=False, unique=False, nullable=True)
    objLength = Column('ObjLength', type=types.Numeric, index=False, unique=False, nullable=True)
    otherRecommendations = Column('OtherRecommendations', type=types.Text, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    shortDesc = Column('ShortDesc', type=types.String, index=True, unique=False, nullable=True)
    source = Column('Source', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.Text, index=False, unique=False, nullable=True)
    ...
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    units = Column('Units', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    width = Column('Width', type=types.Numeric, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo3 = Column('YesNo3', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo4 = Column('YesNo4', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ...
    collectionObject = Column('CollectionObjectID', type=types.Integer, ForeignKey='CollectionObject.CollectionObjectID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    division = Column('DivisionID', type=types.Integer, ForeignKey='Division.UserGroupScopeId', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    preparation = Column('PreparationID', type=types.Integer, ForeignKey='Preparation.PreparationID', nullable=True, unique=False)
...
class ConservDescriptionAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    conservDescription = Column('ConservDescriptionID', type=types.Integer, ForeignKey='ConservDescription.ConservDescriptionID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class ConservEvent(Base):
    ...
    advTestingExam = Column('AdvTestingExam', type=types.Text, index=False, unique=False, nullable=True)
    advTestingExamResults = Column('AdvTestingExamResults', type=types.Text, index=False, unique=False, nullable=True)
    completedComments = Column('CompletedComments', type=types.Text, index=False, unique=False, nullable=True)
    completedDate = Column('CompletedDate', type=types.Date, index=False, unique=False, nullable=True)
    completedDatePrecision = Column('CompletedDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    conditionReport = Column('ConditionReport', type=types.Text, index=False, unique=False, nullable=True)
    curatorApprovalDate = Column('CuratorApprovalDate', type=types.Date, index=False, unique=False, nullable=True)
    curatorApprovalDatePrecision = Column('CuratorApprovalDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    examDate = Column('ExamDate', type=types.Date, index=True, unique=False, nullable=True)
    examDatePrecision = Column('ExamDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Integer, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Integer, index=False, unique=False, nullable=True)
    photoDocs = Column('PhotoDocs', type=types.Text, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    treatmentCompDate = Column('TreatmentCompDate', type=types.Date, index=False, unique=False, nullable=True)
    treatmentCompDatePrecision = Column('TreatmentCompDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    treatmentReport = Column('TreatmentReport', type=types.Text, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ...
    conservDescription = Column('ConservDescriptionID', type=types.Integer, ForeignKey='ConservDescription.ConservDescriptionID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    curator = Column('CuratorID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    examinedByAgent = Column('ExaminedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    treatedByAgent = Column('TreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class ConservEventAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    conservEvent = Column('ConservEventID', type=types.Integer, ForeignKey='ConservEvent.ConservEventID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class Container(Base):
    ...
    description = Column('Description', type=types.Text, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=True)
    number = Column('Number', type=types.Integer, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    type = Column('Type', type=types.Integer, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentID', type=types.Integer, ForeignKey='Container.ContainerID', nullable=True, unique=False)
    storage = Column('StorageID', type=types.Integer, ForeignKey='Storage.StorageID', nullable=True, unique=False)
...
class DNAPrimer(Base):
    ...
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    primerDesignator = Column('PrimerDesignator', type=types.String, index=True, unique=False, nullable=True)
    primerNameForward = Column('PrimerNameForward', type=types.String, index=False, unique=False, nullable=True)
    primerNameReverse = Column('PrimerNameReverse', type=types.String, index=False, unique=False, nullable=True)
    primerReferenceCitationForward = Column('PrimerReferenceCitationForward', type=types.String, index=False, unique=False, nullable=True)
    primerReferenceCitationReverse = Column('PrimerReferenceCitationReverse', type=types.String, index=False, unique=False, nullable=True)
    primerReferenceLinkForward = Column('PrimerReferenceLinkForward', type=types.String, index=False, unique=False, nullable=True)
    primerReferenceLinkReverse = Column('PrimerReferenceLinkReverse', type=types.String, index=False, unique=False, nullable=True)
    primerSequenceForward = Column('PrimerSequenceForward', type=types.String, index=False, unique=False, nullable=True)
    primerSequenceReverse = Column('PrimerSequenceReverse', type=types.String, index=False, unique=False, nullable=True)
    purificationMethod = Column('purificationMethod', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    reservedInteger3 = Column('ReservedInteger3', type=types.Integer, index=False, unique=False, nullable=True)
    reservedInteger4 = Column('ReservedInteger4', type=types.Integer, index=False, unique=False, nullable=True)
    reservedNumber3 = Column('ReservedNumber3', type=types.Numeric, index=False, unique=False, nullable=True)
    reservedNumber4 = Column('ReservedNumber4', type=types.Numeric, index=False, unique=False, nullable=True)
    reservedText3 = Column('ReservedText3', type=types.Text, index=False, unique=False, nullable=True)
    reservedText4 = Column('ReservedText4', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
...
class DNASequence(Base):
    ...
    ambiguousResidues = Column('AmbiguousResidues', type=types.Integer, index=False, unique=False, nullable=True)
    boldBarcodeId = Column('BOLDBarcodeID', type=types.String, index=True, unique=False, nullable=True)
    boldLastUpdateDate = Column('BOLDLastUpdateDate', type=types.Date, index=False, unique=False, nullable=True)
    boldSampleId = Column('BOLDSampleID', type=types.String, index=True, unique=False, nullable=True)
    boldTranslationMatrix = Column('BOLDTranslationMatrix', type=types.String, index=False, unique=False, nullable=True)
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=False, unique=False, nullable=False)
    compA = Column('CompA', type=types.Integer, index=False, unique=False, nullable=True)
    compC = Column('CompC', type=types.Integer, index=False, unique=False, nullable=True)
    compG = Column('CompG', type=types.Integer, index=False, unique=False, nullable=True)
    compT = Column('compT', type=types.Integer, index=False, unique=False, nullable=True)
    extractionDate = Column('ExtractionDate', type=types.Date, index=False, unique=False, nullable=True)
    extractionDatePrecision = Column('ExtractionDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    genbankAccessionNumber = Column('GenBankAccessionNumber', type=types.String, index=True, unique=False, nullable=True)
    geneSequence = Column('GeneSequence', type=types.Text, index=False, unique=False, nullable=True)
    moleculeType = Column('MoleculeType', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    sequenceDate = Column('SequenceDate', type=types.Date, index=False, unique=False, nullable=True)
    sequenceDatePrecision = Column('SequenceDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    targetMarker = Column('TargetMarker', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.String, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    totalResidues = Column('TotalResidues', type=types.Integer, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo3 = Column('YesNo3', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ...
    collectionObject = Column('CollectionObjectID', type=types.Integer, ForeignKey='CollectionObject.CollectionObjectID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    extractor = Column('ExtractorID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    materialSample = Column('MaterialSampleID', type=types.Integer, ForeignKey='MaterialSample.MaterialSampleID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    sequencer = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class DNASequenceAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    dnaSequence = Column('DnaSequenceID', type=types.Integer, ForeignKey='DNASequence.DnaSequenceID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class DNASequencingRun(Base):
    ...
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=False, unique=False, nullable=False)
    dryadDOI = Column('DryadDOI', type=types.String, index=False, unique=False, nullable=True)
    geneSequence = Column('GeneSequence', type=types.Text, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    ordinal = Column('Ordinal', type=types.Integer, index=False, unique=False, nullable=True)
    pcrCocktailPrimer = Column('PCRCocktailPrimer', type=mysql_bit_type, index=False, unique=False, nullable=True)
    pcrForwardPrimerCode = Column('PCRForwardPrimerCode', type=types.String, index=False, unique=False, nullable=True)
    pcrPrimerName = Column('PCRPrimerName', type=types.String, index=False, unique=False, nullable=True)
    pcrPrimerSequence5_3 = Column('PCRPrimerSequence5_3', type=types.String, index=False, unique=False, nullable=True)
    pcrReversePrimerCode = Column('PCRReversePrimerCode', type=types.String, index=False, unique=False, nullable=True)
    readDirection = Column('ReadDirection', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    runDate = Column('RunDate', type=types.Date, index=False, unique=False, nullable=True)
    scoreFileName = Column('ScoreFileName', type=types.String, index=False, unique=False, nullable=True)
    sequenceCocktailPrimer = Column('SequenceCocktailPrimer', type=mysql_bit_type, index=False, unique=False, nullable=True)
    sequencePrimerCode = Column('SequencePrimerCode', type=types.String, index=False, unique=False, nullable=True)
    sequencePrimerName = Column('SequencePrimerName', type=types.String, index=False, unique=False, nullable=True)
    sequencePrimerSequence5_3 = Column('SequencePrimerSequence5_3', type=types.String, index=False, unique=False, nullable=True)
    sraExperimentID = Column('SRAExperimentID', type=types.String, index=False, unique=False, nullable=True)
    sraRunID = Column('SRARunID', type=types.String, index=False, unique=False, nullable=True)
    sraSubmissionID = Column('SRASubmissionID', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.String, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    traceFileName = Column('TraceFileName', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo3 = Column('YesNo3', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    dnaPrimer = Column('DNAPrimerID', type=types.Integer, ForeignKey='DNAPrimer.DNAPrimerID', nullable=True, unique=False)
    dnaSequence = Column('DNASequenceID', type=types.Integer, ForeignKey='DNASequence.DnaSequenceID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    preparedByAgent = Column('PreparedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    runByAgent = Column('RunByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class DNASequencingRunAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    dnaSequencingRun = Column('DnaSequencingRunID', type=types.Integer, ForeignKey='DNASequencingRun.DNASequencingRunID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class DNASequencingRunCitation(Base):
    ...
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    referenceWork = Column('ReferenceWorkID', type=types.Integer, ForeignKey='ReferenceWork.ReferenceWorkID', nullable=False, unique=False)
    sequencingRun = Column('DNASequencingRunID', type=types.Integer, ForeignKey='DNASequencingRun.DNASequencingRunID', nullable=False, unique=False)
...
class Deaccession(Base):
    ...
    date1 = Column('Date1', type=types.Date, index=False, unique=False, nullable=True)
    date2 = Column('Date2', type=types.Date, index=False, unique=False, nullable=True)
    deaccessionDate = Column('DeaccessionDate', type=types.Date, index=True, unique=False, nullable=True)
    deaccessionNumber = Column('DeaccessionNumber', type=types.String, index=True, unique=False, nullable=False)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    integer3 = Column('Integer3', type=types.Integer, index=False, unique=False, nullable=True)
    integer4 = Column('Integer4', type=types.Integer, index=False, unique=False, nullable=True)
...
class DeaccessionAgent(Base):
    ...
    agent = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    deaccession = Column('DeaccessionID', type=types.Integer, ForeignKey='Deaccession.DeaccessionID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class Determination(Base):
    ...
    addendum = Column('Addendum', type=types.String, index=False, unique=False, nullable=True)
    alternateName = Column('AlternateName', type=types.String, index=True, unique=False, nullable=True)
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    confidence = Column('Confidence', type=types.String, index=False, unique=False, nullable=True)
    determinedDate = Column('DeterminedDate', type=types.Date, index=True, unique=False, nullable=True)
    determinedDatePrecision = Column('DeterminedDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    featureOrBasis = Column('FeatureOrBasis', type=types.String, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    integer3 = Column('Integer3', type=types.Integer, index=False, unique=False, nullable=True)
    integer4 = Column('Integer4', type=types.Integer, index=False, unique=False, nullable=True)
    integer5 = Column('Integer5', type=types.Integer, index=False, unique=False, nullable=True)
    isCurrent = Column('IsCurrent', type=mysql_bit_type, index=False, unique=False, nullable=False)
    method = Column('Method', type=types.String, index=False, unique=False, nullable=True)
    nameUsage = Column('NameUsage', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    number4 = Column('Number4', type=types.Numeric, index=False, unique=False, nullable=True)
    number5 = Column('Number5', type=types.Numeric, index=False, unique=False, nullable=True)
    qualifier = Column('Qualifier', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    subSpQualifier = Column('SubSpQualifier', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.String, index=False, unique=False, nullable=True)
    ...
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    typeStatusName = Column('TypeStatusName', type=types.String, index=True, unique=False, nullable=True)
    varQualifier = Column('VarQualifier', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo3 = Column('YesNo3', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ...
    collectionObject = Column('CollectionObjectID', type=types.Integer, ForeignKey='CollectionObject.CollectionObjectID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    determiner = Column('DeterminerID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    preferredTaxon = Column('PreferredTaxonID', type=types.Integer, ForeignKey='Taxon.TaxonID', nullable=True, unique=False)
    taxon = Column('TaxonID', type=types.Integer, ForeignKey='Taxon.TaxonID', nullable=True, unique=False)
...
class DeterminationCitation(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    determination = Column('DeterminationID', type=types.Integer, ForeignKey='Determination.DeterminationID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    referenceWork = Column('ReferenceWorkID', type=types.Integer, ForeignKey='ReferenceWork.ReferenceWorkID', nullable=False, unique=False)
...
class Discipline(Base):
    ...
    isPaleoContextEmbedded = Column('IsPaleoContextEmbedded', type=mysql_bit_type, index=False, unique=False, nullable=False)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=True)
    paleoContextChildTable = Column('PaleoContextChildTable', type=types.String, index=False, unique=False, nullable=True)
    regNumber = Column('RegNumber', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    type = Column('Type', type=types.String, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    dataType = Column('DataTypeID', type=types.Integer, ForeignKey='DataType.DataTypeID', nullable=False, unique=False)
    division = Column('DivisionID', type=types.Integer, ForeignKey='Division.UserGroupScopeId', nullable=False, unique=False)
    geographyTreeDef = Column('GeographyTreeDefID', type=types.Integer, ForeignKey='GeographyTreeDef.GeographyTreeDefID', nullable=False, unique=False)
    geologicTimePeriodTreeDef = Column('GeologicTimePeriodTreeDefID', type=types.Integer, ForeignKey='GeologicTimePeriodTreeDef.GeologicTimePeriodTreeDefID', nullable=False, unique=False)
    lithoStratTreeDef = Column('LithoStratTreeDefID', type=types.Integer, ForeignKey='LithoStratTreeDef.LithoStratTreeDefID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    taxonTreeDef = Column('TaxonTreeDefID', type=types.Integer, ForeignKey='TaxonTreeDef.TaxonTreeDefID', nullable=True, unique=False)
...
class Disposal(Base):
    ...
    disposalDate = Column('DisposalDate', type=types.Date, index=True, unique=False, nullable=True)
    disposalNumber = Column('DisposalNumber', type=types.String, index=True, unique=False, nullable=False)
    doNotExport = Column('doNotExport', type=mysql_bit_type, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    deaccession = Column('DeaccessionID', type=types.Integer, ForeignKey='Deaccession.DeaccessionID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class DisposalAgent(Base):
    ...
    agent = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    disposal = Column('DisposalID', type=types.Integer, ForeignKey='Disposal.DisposalID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class DisposalPreparation(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    disposal = Column('DisposalID', type=types.Integer, ForeignKey='Disposal.DisposalID', nullable=False, unique=False)
    loanReturnPreparation = Column('LoanReturnPreparationID', type=types.Integer, ForeignKey='LoanReturnPreparation.LoanReturnPreparationID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    preparation = Column('PreparationID', type=types.Integer, ForeignKey='Preparation.PreparationID', nullable=True, unique=False)
...
class Division(Base):
    ...
    abbrev = Column('Abbrev', type=types.String, index=False, unique=False, nullable=True)
    altName = Column('AltName', type=types.String, index=False, unique=False, nullable=True)
    description = Column('Description', type=types.Text, index=False, unique=False, nullable=True)
    discipline = Column('DisciplineType', type=types.String, index=False, unique=False, nullable=True)
    iconURI = Column('IconURI', type=types.String, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=True)
    regNumber = Column('RegNumber', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    uri = Column('Uri', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    address = Column('AddressID', type=types.Integer, ForeignKey='Address.AddressID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    institution = Column('InstitutionID', type=types.Integer, ForeignKey='Institution.UserGroupScopeId', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class ExchangeIn(Base):
    ...
    contents = Column('Contents', type=types.Text, index=False, unique=False, nullable=True)
    descriptionOfMaterial = Column('DescriptionOfMaterial', type=types.String, index=True, unique=False, nullable=True)
    exchangeDate = Column('ExchangeDate', type=types.Date, index=True, unique=False, nullable=True)
    exchangeInNumber = Column('ExchangeInNumber', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    quantityExchanged = Column('QuantityExchanged', type=types.Integer, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    srcGeography = Column('SrcGeography', type=types.String, index=False, unique=False, nullable=True)
    srcTaxonomy = Column('SrcTaxonomy', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    ...
    addressOfRecord = Column('AddressOfRecordID', type=types.Integer, ForeignKey='AddressOfRecord.AddressOfRecordID', nullable=True, unique=False)
    agentCatalogedBy = Column('CatalogedByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    agentReceivedFrom = Column('ReceivedFromOrganizationID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    division = Column('DivisionID', type=types.Integer, ForeignKey='Division.UserGroupScopeId', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class ExchangeInAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    exchangeIn = Column('ExchangeInID', type=types.Integer, ForeignKey='ExchangeIn.ExchangeInID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class ExchangeInPrep(Base):
    ...
    comments = Column('Comments', type=types.Text, index=False, unique=False, nullable=True)
    descriptionOfMaterial = Column('DescriptionOfMaterial', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Integer, index=False, unique=False, nullable=True)
    quantity = Column('Quantity', type=types.Integer, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    exchangeIn = Column('ExchangeInID', type=types.Integer, ForeignKey='ExchangeIn.ExchangeInID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    preparation = Column('PreparationID', type=types.Integer, ForeignKey='Preparation.PreparationID', nullable=True, unique=False)
...
class ExchangeOut(Base):
    ...
    descriptionOfMaterial = Column('DescriptionOfMaterial', type=types.String, index=True, unique=False, nullable=True)
    exchangeDate = Column('ExchangeDate', type=types.Date, index=True, unique=False, nullable=True)
    exchangeOutNumber = Column('ExchangeOutNumber', type=types.String, index=True, unique=False, nullable=False)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    quantityExchanged = Column('QuantityExchanged', type=types.Integer, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    ...
    addressOfRecord = Column('AddressOfRecordID', type=types.Integer, ForeignKey='AddressOfRecord.AddressOfRecordID', nullable=True, unique=False)
    agentCatalogedBy = Column('CatalogedByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    agentSentTo = Column('SentToOrganizationID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    deaccession = Column('DeaccessionID', type=types.Integer, ForeignKey='Deaccession.DeaccessionID', nullable=True, unique=False)
    division = Column('DivisionID', type=types.Integer, ForeignKey='Division.UserGroupScopeId', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class ExchangeOutAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    exchangeOut = Column('ExchangeOutID', type=types.Integer, ForeignKey='ExchangeOut.ExchangeOutID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class ExchangeOutPrep(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    exchangeOut = Column('ExchangeOutID', type=types.Integer, ForeignKey='ExchangeOut.ExchangeOutID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    preparation = Column('PreparationID', type=types.Integer, ForeignKey='Preparation.PreparationID', nullable=True, unique=False)
...
class Exsiccata(Base):
    ...
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    schedae = Column('Schedae', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    title = Column('Title', type=types.String, index=False, unique=False, nullable=False)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class ExsiccataItem(Base):
    ...
    fascicle = Column('Fascicle', type=types.String, index=False, unique=False, nullable=True)
    number = Column('Number', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    collectionObject = Column('CollectionObjectID', type=types.Integer, ForeignKey='CollectionObject.CollectionObjectID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    exsiccata = Column('ExsiccataID', type=types.Integer, ForeignKey='Exsiccata.ExsiccataID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class FieldNotebook(Base):
    ...
    description = Column('Description', type=types.Text, index=False, unique=False, nullable=True)
    endDate = Column('EndDate', type=types.Date, index=True, unique=False, nullable=True)
    location = Column('Storage', type=types.String, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=True)
    startDate = Column('StartDate', type=types.Date, index=True, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    ...
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    ownerAgent = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
...
class FieldNotebookAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    fieldNotebook = Column('FieldNotebookID', type=types.Integer, ForeignKey='FieldNotebook.FieldNotebookID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class FieldNotebookPage(Base):
    ...
    description = Column('Description', type=types.String, index=False, unique=False, nullable=True)
    pageNumber = Column('PageNumber', type=types.String, index=True, unique=False, nullable=False)
    scanDate = Column('ScanDate', type=types.Date, index=True, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    pageSet = Column('FieldNotebookPageSetID', type=types.Integer, ForeignKey='FieldNotebookPageSet.FieldNotebookPageSetID', nullable=True, unique=False)
...
class FieldNotebookPageAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    fieldNotebookPage = Column('FieldNotebookPageID', type=types.Integer, ForeignKey='FieldNotebookPage.FieldNotebookPageID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class FieldNotebookPageSet(Base):
    ...
    endDate = Column('EndDate', type=types.Date, index=True, unique=False, nullable=True)
    method = Column('Method', type=types.String, index=False, unique=False, nullable=True)
    orderNumber = Column('OrderNumber', type=types.Integer, index=False, unique=False, nullable=True)
    startDate = Column('StartDate', type=types.Date, index=True, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    fieldNotebook = Column('FieldNotebookID', type=types.Integer, ForeignKey='FieldNotebook.FieldNotebookID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    sourceAgent = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class FieldNotebookPageSetAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    fieldNotebookPageSet = Column('FieldNotebookPageSetID', type=types.Integer, ForeignKey='FieldNotebookPageSet.FieldNotebookPageSetID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class GeoCoordDetail(Base):
    ...
    errorPolygon = Column('ErrorPolygon', type=types.Text, index=False, unique=False, nullable=True)
    geoRefAccuracy = Column('GeoRefAccuracy', type=types.Numeric, index=False, unique=False, nullable=True)
    geoRefAccuracyUnits = Column('GeoRefAccuracyUnits', type=types.String, index=False, unique=False, nullable=True)
    geoRefCompiledDate = Column('GeoRefCompiledDate', type=types.Date, index=False, unique=False, nullable=True)
    geoRefDetDate = Column('GeoRefDetDate', type=types.Date, index=False, unique=False, nullable=True)
    geoRefDetRef = Column('GeoRefDetRef', type=types.String, index=False, unique=False, nullable=True)
    geoRefRemarks = Column('GeoRefRemarks', type=types.Text, index=False, unique=False, nullable=True)
    geoRefVerificationStatus = Column('GeoRefVerificationStatus', type=types.String, index=False, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    integer3 = Column('Integer3', type=types.Integer, index=False, unique=False, nullable=True)
    integer4 = Column('Integer4', type=types.Integer, index=False, unique=False, nullable=True)
    integer5 = Column('Integer5', type=types.Integer, index=False, unique=False, nullable=True)
    maxUncertaintyEst = Column('MaxUncertaintyEst', type=types.Numeric, index=False, unique=False, nullable=True)
    maxUncertaintyEstUnit = Column('MaxUncertaintyEstUnit', type=types.String, index=False, unique=False, nullable=True)
    namedPlaceExtent = Column('NamedPlaceExtent', type=types.Numeric, index=False, unique=False, nullable=True)
    noGeoRefBecause = Column('NoGeoRefBecause', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    number4 = Column('Number4', type=types.Numeric, index=False, unique=False, nullable=True)
    number5 = Column('Number5', type=types.Numeric, index=False, unique=False, nullable=True)
    originalCoordSystem = Column('OriginalCoordSystem', type=types.String, index=False, unique=False, nullable=True)
    protocol = Column('Protocol', type=types.String, index=False, unique=False, nullable=True)
    source = Column('Source', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.Text, index=False, unique=False, nullable=True)
    ...
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    uncertaintyPolygon = Column('UncertaintyPolygon', type=types.Text, index=False, unique=False, nullable=True)
    validation = Column('Validation', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo3 = Column('YesNo3', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    geoRefCompiledBy = Column('CompiledByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    geoRefDetBy = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    locality = Column('LocalityID', type=types.Integer, ForeignKey='Locality.LocalityID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class Geography(Base):
    ...
    abbrev = Column('Abbrev', type=types.String, index=False, unique=False, nullable=True)
    centroidLat = Column('CentroidLat', type=types.Numeric, index=False, unique=False, nullable=True)
    centroidLon = Column('CentroidLon', type=types.Numeric, index=False, unique=False, nullable=True)
    commonName = Column('CommonName', type=types.String, index=False, unique=False, nullable=True)
    fullName = Column('FullName', type=types.String, index=True, unique=False, nullable=True)
    geographyCode = Column('GeographyCode', type=types.String, index=False, unique=False, nullable=True)
    gml = Column('GML', type=types.Text, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=False, unique=False, nullable=True)
    highestChildNodeNumber = Column('HighestChildNodeNumber', type=types.Integer, index=False, unique=False, nullable=True)
    isAccepted = Column('IsAccepted', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isCurrent = Column('IsCurrent', type=mysql_bit_type, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=False)
    nodeNumber = Column('NodeNumber', type=types.Integer, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Integer, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Integer, index=False, unique=False, nullable=True)
    rankId = Column('RankID', type=types.Integer, index=False, unique=False, nullable=False)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    timestampVersion = Column('TimestampVersion', type=types.Date, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    acceptedGeography = Column('AcceptedID', type=types.Integer, ForeignKey='Geography.GeographyID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    definition = Column('GeographyTreeDefID', type=types.Integer, ForeignKey='GeographyTreeDef.GeographyTreeDefID', nullable=False, unique=False)
    definitionItem = Column('GeographyTreeDefItemID', type=types.Integer, ForeignKey='GeographyTreeDefItem.GeographyTreeDefItemID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentID', type=types.Integer, ForeignKey='Geography.GeographyID', nullable=True, unique=False)
...
class GeographyTreeDef(Base):
    ...
    fullNameDirection = Column('FullNameDirection', type=types.Integer, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=False)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
...
class GeographyTreeDefItem(Base):
    ...
    fullNameSeparator = Column('FullNameSeparator', type=types.String, index=False, unique=False, nullable=True)
    isEnforced = Column('IsEnforced', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isInFullName = Column('IsInFullName', type=mysql_bit_type, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=False)
    rankId = Column('RankID', type=types.Integer, index=False, unique=False, nullable=False)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    textAfter = Column('TextAfter', type=types.String, index=False, unique=False, nullable=True)
    textBefore = Column('TextBefore', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    title = Column('Title', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentItemID', type=types.Integer, ForeignKey='GeographyTreeDefItem.GeographyTreeDefItemID', nullable=True, unique=False)
    treeDef = Column('GeographyTreeDefID', type=types.Integer, ForeignKey='GeographyTreeDef.GeographyTreeDefID', nullable=False, unique=False)
...
class GeologicTimePeriod(Base):
    ...
    endPeriod = Column('EndPeriod', type=types.Numeric, index=False, unique=False, nullable=True)
    endUncertainty = Column('EndUncertainty', type=types.Numeric, index=False, unique=False, nullable=True)
    fullName = Column('FullName', type=types.String, index=True, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    highestChildNodeNumber = Column('HighestChildNodeNumber', type=types.Integer, index=False, unique=False, nullable=True)
    isAccepted = Column('IsAccepted', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isBioStrat = Column('IsBioStrat', type=mysql_bit_type, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=False)
    nodeNumber = Column('NodeNumber', type=types.Integer, index=False, unique=False, nullable=True)
    rankId = Column('RankID', type=types.Integer, index=False, unique=False, nullable=False)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    standard = Column('Standard', type=types.String, index=False, unique=False, nullable=True)
    startPeriod = Column('StartPeriod', type=types.Numeric, index=False, unique=False, nullable=True)
    startUncertainty = Column('StartUncertainty', type=types.Numeric, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    ...
    acceptedGeologicTimePeriod = Column('AcceptedID', type=types.Integer, ForeignKey='GeologicTimePeriod.GeologicTimePeriodID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    definition = Column('GeologicTimePeriodTreeDefID', type=types.Integer, ForeignKey='GeologicTimePeriodTreeDef.GeologicTimePeriodTreeDefID', nullable=False, unique=False)
    definitionItem = Column('GeologicTimePeriodTreeDefItemID', type=types.Integer, ForeignKey='GeologicTimePeriodTreeDefItem.GeologicTimePeriodTreeDefItemID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentID', type=types.Integer, ForeignKey='GeologicTimePeriod.GeologicTimePeriodID', nullable=True, unique=False)
...
class GeologicTimePeriodTreeDefItem(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentItemID', type=types.Integer, ForeignKey='GeologicTimePeriodTreeDefItem.GeologicTimePeriodTreeDefItemID', nullable=True, unique=False)
    treeDef = Column('GeologicTimePeriodTreeDefID', type=types.Integer, ForeignKey='GeologicTimePeriodTreeDef.GeologicTimePeriodTreeDefID', nullable=False, unique=False)
...
class Gift(Base):
    ...
    date1Precision = Column('Date1Precision', type=types.Integer, index=False, unique=False, nullable=True)
    dateReceived = Column('DateReceived', type=types.Date, index=False, unique=False, nullable=True)
    giftDate = Column('GiftDate', type=types.Date, index=True, unique=False, nullable=True)
    giftNumber = Column('GiftNumber', type=types.String, index=True, unique=False, nullable=False)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    integer3 = Column('Integer3', type=types.Integer, index=False, unique=False, nullable=True)
    isFinancialResponsibility = Column('IsFinancialResponsibility', type=mysql_bit_type, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    purposeOfGift = Column('PurposeOfGift', type=types.String, index=False, unique=False, nullable=True)
    receivedComments = Column('ReceivedComments', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    specialConditions = Column('SpecialConditions', type=types.Text, index=False, unique=False, nullable=True)
    srcGeography = Column('SrcGeography', type=types.String, index=False, unique=False, nullable=True)
    srcTaxonomy = Column('SrcTaxonomy', type=types.String, index=False, unique=False, nullable=True)
    status = Column('Status', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
...
class GiftAgent(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    gift = Column('GiftID', type=types.Integer, ForeignKey='Gift.GiftID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class GiftPreparation(Base):
    ...
    outComments = Column('OutComments', type=types.Text, index=False, unique=False, nullable=True)
    quantity = Column('Quantity', type=types.Integer, index=False, unique=False, nullable=True)
    receivedComments = Column('ReceivedComments', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.Text, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    gift = Column('GiftID', type=types.Integer, ForeignKey='Gift.GiftID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    preparation = Column('PreparationID', type=types.Integer, ForeignKey='Preparation.PreparationID', nullable=True, unique=False)
...
class GroupPerson(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    division = Column('DivisionID', type=types.Integer, ForeignKey='Division.UserGroupScopeId', nullable=False, unique=False)
    group = Column('GroupID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    member = Column('MemberID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class InfoRequest(Base):
    ...
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    email = Column('Email', type=types.String, index=False, unique=False, nullable=True)
    firstName = Column('Firstname', type=types.String, index=False, unique=False, nullable=True)
    infoReqNumber = Column('InfoReqNumber', type=types.String, index=False, unique=False, nullable=True)
    institution = Column('Institution', type=types.String, index=False, unique=False, nullable=True)
    lastName = Column('Lastname', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    replyDate = Column('ReplyDate', type=types.Date, index=False, unique=False, nullable=True)
    requestDate = Column('RequestDate', type=types.Date, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class Institution(Base):
    ...
    altName = Column('AltName', type=types.String, index=False, unique=False, nullable=True)
    code = Column('Code', type=types.String, index=False, unique=False, nullable=True)
    copyright = Column('Copyright', type=types.Text, index=False, unique=False, nullable=True)
    currentManagedRelVersion = Column('CurrentManagedRelVersion', type=types.String, index=False, unique=False, nullable=True)
    currentManagedSchemaVersion = Column('CurrentManagedSchemaVersion', type=types.String, index=False, unique=False, nullable=True)
    description = Column('Description', type=types.Text, index=False, unique=False, nullable=True)
    disclaimer = Column('Disclaimer', type=types.Text, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    hasBeenAsked = Column('HasBeenAsked', type=mysql_bit_type, index=False, unique=False, nullable=True)
    iconURI = Column('IconURI', type=types.String, index=False, unique=False, nullable=True)
    ipr = Column('Ipr', type=types.Text, index=False, unique=False, nullable=True)
    isAccessionsGlobal = Column('IsAccessionsGlobal', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isAnonymous = Column('IsAnonymous', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isReleaseManagedGlobally = Column('IsReleaseManagedGlobally', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isSecurityOn = Column('IsSecurityOn', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isServerBased = Column('IsServerBased', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isSharingLocalities = Column('IsSharingLocalities', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isSingleGeographyTree = Column('IsSingleGeographyTree', type=mysql_bit_type, index=False, unique=False, nullable=False)
    license = Column('License', type=types.Text, index=False, unique=False, nullable=True)
    lsidAuthority = Column('LsidAuthority', type=types.String, index=False, unique=False, nullable=True)
    minimumPwdLength = Column('MinimumPwdLength', type=types.Integer, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=True)
    regNumber = Column('RegNumber', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    termsOfUse = Column('TermsOfUse', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    uri = Column('Uri', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    storageTreeDef = Column('StorageTreeDefID', type=types.Integer, ForeignKey='StorageTreeDef.StorageTreeDefID', nullable=True, unique=False)
...
class Journal(Base):
    ...
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    issn = Column('ISSN', type=types.String, index=False, unique=False, nullable=True)
    journalAbbreviation = Column('JournalAbbreviation', type=types.String, index=False, unique=False, nullable=True)
    journalName = Column('JournalName', type=types.String, index=True, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
...
class LatLonPolygon(Base):
    ...
    description = Column('Description', type=types.Text, index=False, unique=False, nullable=True)
    isPolyline = Column('IsPolyline', type=mysql_bit_type, index=False, unique=False, nullable=False)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    locality = Column('LocalityID', type=types.Integer, ForeignKey='Locality.LocalityID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    visualQuery = Column('SpVisualQueryID', type=types.Integer, ForeignKey='SpVisualQuery.SpVisualQueryID', nullable=True, unique=False)
...
class LatLonPolygonPnt(Base):
    ...
    elevation = Column('Elevation', type=types.Integer, index=False, unique=False, nullable=True)
    latitude = Column('Latitude', type=types.Numeric, index=False, unique=False, nullable=False)
    longitude = Column('Longitude', type=types.Numeric, index=False, unique=False, nullable=False)
    ordinal = Column('Ordinal', type=types.Integer, index=False, unique=False, nullable=False)

    latLonPolygon = Column('LatLonPolygonID', type=types.Integer, ForeignKey='LatLonPolygon.LatLonPolygonID', nullable=False, unique=False)
...
class LithoStrat(Base):
    ...
    acceptedLithoStrat = Column('AcceptedID', type=types.Integer, ForeignKey='LithoStrat.LithoStratID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    definition = Column('LithoStratTreeDefID', type=types.Integer, ForeignKey='LithoStratTreeDef.LithoStratTreeDefID', nullable=False, unique=False)
    definitionItem = Column('LithoStratTreeDefItemID', type=types.Integer, ForeignKey='LithoStratTreeDefItem.LithoStratTreeDefItemID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentID', type=types.Integer, ForeignKey='LithoStrat.LithoStratID', nullable=True, unique=False)
...
class LithoStratTreeDefItem(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentItemID', type=types.Integer, ForeignKey='LithoStratTreeDefItem.LithoStratTreeDefItemID', nullable=True, unique=False)
    treeDef = Column('LithoStratTreeDefID', type=types.Integer, ForeignKey='LithoStratTreeDef.LithoStratTreeDefID', nullable=False, unique=False)
...
class Loan(Base):
    ...
    contents = Column('Contents', type=types.Text, index=False, unique=False, nullable=True)
    currentDueDate = Column('CurrentDueDate', type=types.Date, index=True, unique=False, nullable=True)
    dateClosed = Column('DateClosed', type=types.Date, index=False, unique=False, nullable=True)
    dateReceived = Column('DateReceived', type=types.Date, index=False, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    isClosed = Column('IsClosed', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isFinancialResponsibility = Column('IsFinancialResponsibility', type=mysql_bit_type, index=False, unique=False, nullable=True)
    loanDate = Column('LoanDate', type=types.Date, index=True, unique=False, nullable=True)
    loanNumber = Column('LoanNumber', type=types.String, index=True, unique=False, nullable=False)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    originalDueDate = Column('OriginalDueDate', type=types.Date, index=False, unique=False, nullable=True)
    overdueNotiSentDate = Column('OverdueNotiSetDate', type=types.Date, index=False, unique=False, nullable=True)
    purposeOfLoan = Column('PurposeOfLoan', type=types.String, index=False, unique=False, nullable=True)
    receivedComments = Column('ReceivedComments', type=types.String, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    specialConditions = Column('SpecialConditions', type=types.Text, index=False, unique=False, nullable=True)
    srcGeography = Column('SrcGeography', type=types.String, index=False, unique=False, nullable=True)
...
class LoanAgent(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    loan = Column('LoanID', type=types.Integer, ForeignKey='Loan.LoanID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class LoanPreparation(Base):
    ...
    descriptionOfMaterial = Column('DescriptionOfMaterial', type=types.String, index=False, unique=False, nullable=True)
    inComments = Column('InComments', type=types.Text, index=False, unique=False, nullable=True)
    isResolved = Column('IsResolved', type=mysql_bit_type, index=False, unique=False, nullable=False)
    outComments = Column('OutComments', type=types.Text, index=False, unique=False, nullable=True)
    quantity = Column('Quantity', type=types.Integer, index=False, unique=False, nullable=True)
    quantityResolved = Column('QuantityResolved', type=types.Integer, index=False, unique=False, nullable=True)
    quantityReturned = Column('QuantityReturned', type=types.Integer, index=False, unique=False, nullable=True)
...
class LoanReturnPreparation(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    loanPreparation = Column('LoanPreparationID', type=types.Integer, ForeignKey='LoanPreparation.LoanPreparationID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    receivedBy = Column('ReceivedByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class Locality(Base):
    ...
    datum = Column('Datum', type=types.String, index=False, unique=False, nullable=True)
    elevationAccuracy = Column('ElevationAccuracy', type=types.Numeric, index=False, unique=False, nullable=True)
    elevationMethod = Column('ElevationMethod', type=types.String, index=False, unique=False, nullable=True)
    gml = Column('GML', type=types.Text, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=False, unique=False, nullable=True)
    lat1text = Column('Lat1Text', type=types.String, index=False, unique=False, nullable=True)
    lat2text = Column('Lat2Text', type=types.String, index=False, unique=False, nullable=True)
    latLongAccuracy = Column('LatLongAccuracy', type=types.Numeric, index=False, unique=False, nullable=True)
    latLongMethod = Column('LatLongMethod', type=types.String, index=False, unique=False, nullable=True)
    latLongType = Column('LatLongType', type=types.String, index=False, unique=False, nullable=True)
    latitude1 = Column('Latitude1', type=types.Numeric, index=False, unique=False, nullable=True)
    latitude2 = Column('Latitude2', type=types.Numeric, index=False, unique=False, nullable=True)
    localityName = Column('LocalityName', type=types.String, index=True, unique=False, nullable=False)
    long1text = Column('Long1Text', type=types.String, index=False, unique=False, nullable=True)
    long2text = Column('Long2Text', type=types.String, index=False, unique=False, nullable=True)
    longitude1 = Column('Longitude1', type=types.Numeric, index=False, unique=False, nullable=True)
    longitude2 = Column('Longitude2', type=types.Numeric, index=False, unique=False, nullable=True)
    maxElevation = Column('MaxElevation', type=types.Numeric, index=False, unique=False, nullable=True)
    minElevation = Column('MinElevation', type=types.Numeric, index=False, unique=False, nullable=True)
    namedPlace = Column('NamedPlace', type=types.String, index=True, unique=False, nullable=True)
    originalElevationUnit = Column('OriginalElevationUnit', type=types.String, index=False, unique=False, nullable=True)
    originalLatLongUnit = Column('OriginalLatLongUnit', type=types.Integer, index=False, unique=False, nullable=True)
    relationToNamedPlace = Column('RelationToNamedPlace', type=types.String, index=True, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    sgrStatus = Column('SGRStatus', type=types.Integer, index=False, unique=False, nullable=True)
    shortName = Column('ShortName', type=types.String, index=False, unique=False, nullable=True)
    srcLatLongUnit = Column('SrcLatLongUnit', type=types.Integer, index=False, unique=False, nullable=False)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.Text, index=False, unique=False, nullable=True)
    ...
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    uniqueIdentifier = Column('UniqueIdentifier', type=types.String, index=True, unique=False, nullable=True)
    verbatimElevation = Column('VerbatimElevation', type=types.String, index=False, unique=False, nullable=True)
    verbatimLatitude = Column('VerbatimLatitude', type=types.String, index=False, unique=False, nullable=True)
    verbatimLongitude = Column('VerbatimLongitude', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    visibility = Column('Visibility', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    geography = Column('GeographyID', type=types.Integer, ForeignKey='Geography.GeographyID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    paleoContext = Column('PaleoContextID', type=types.Integer, ForeignKey='PaleoContext.PaleoContextID', nullable=True, unique=False)
    visibilitySetBy = Column('VisibilitySetByID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=True, unique=False)
...
class LocalityAttachment(Base):
    ...
    attachment = Column('AttachmentID', type=types.Integer, ForeignKey='Attachment.AttachmentID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    locality = Column('LocalityID', type=types.Integer, ForeignKey='Locality.LocalityID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class LocalityDetail(Base):
    ...
    baseMeridian = Column('BaseMeridian', type=types.String, index=False, unique=False, nullable=True)
    drainage = Column('Drainage', type=types.String, index=False, unique=False, nullable=True)
    endDepth = Column('EndDepth', type=types.Numeric, index=False, unique=False, nullable=True)
    endDepthUnit = Column('EndDepthUnit', type=types.String, index=False, unique=False, nullable=True)
    endDepthVerbatim = Column('EndDepthVerbatim', type=types.String, index=False, unique=False, nullable=True)
    gml = Column('GML', type=types.Text, index=False, unique=False, nullable=True)
    hucCode = Column('HucCode', type=types.String, index=False, unique=False, nullable=True)
    island = Column('Island', type=types.String, index=False, unique=False, nullable=True)
    islandGroup = Column('IslandGroup', type=types.String, index=False, unique=False, nullable=True)
    mgrsZone = Column('MgrsZone', type=types.String, index=False, unique=False, nullable=True)
    nationalParkName = Column('NationalParkName', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    number4 = Column('Number4', type=types.Numeric, index=False, unique=False, nullable=True)
    number5 = Column('Number5', type=types.Numeric, index=False, unique=False, nullable=True)
    paleoLat = Column('PaleoLat', type=types.String, index=False, unique=False, nullable=True)
    paleoLng = Column('PaleoLng', type=types.String, index=False, unique=False, nullable=True)
    rangeDesc = Column('RangeDesc', type=types.String, index=False, unique=False, nullable=True)
    rangeDirection = Column('RangeDirection', type=types.String, index=False, unique=False, nullable=True)
    section = Column('Section', type=types.String, index=False, unique=False, nullable=True)
    sectionPart = Column('SectionPart', type=types.String, index=False, unique=False, nullable=True)
    startDepth = Column('StartDepth', type=types.Numeric, index=False, unique=False, nullable=True)
    startDepthUnit = Column('StartDepthUnit', type=types.String, index=False, unique=False, nullable=True)
    startDepthVerbatim = Column('StartDepthVerbatim', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.Text, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.Text, index=False, unique=False, nullable=True)
    ...
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    township = Column('Township', type=types.String, index=False, unique=False, nullable=True)
    townshipDirection = Column('TownshipDirection', type=types.String, index=False, unique=False, nullable=True)
    utmDatum = Column('UtmDatum', type=types.String, index=False, unique=False, nullable=True)
    utmEasting = Column('UtmEasting', type=types.Numeric, index=False, unique=False, nullable=True)
    utmFalseEasting = Column('UtmFalseEasting', type=types.Integer, index=False, unique=False, nullable=True)
    utmFalseNorthing = Column('UtmFalseNorthing', type=types.Integer, index=False, unique=False, nullable=True)
    utmNorthing = Column('UtmNorthing', type=types.Numeric, index=False, unique=False, nullable=True)
    utmOrigLatitude = Column('UtmOrigLatitude', type=types.Numeric, index=False, unique=False, nullable=True)
    utmOrigLongitude = Column('UtmOrigLongitude', type=types.Numeric, index=False, unique=False, nullable=True)
    utmScale = Column('UtmScale', type=types.Numeric, index=False, unique=False, nullable=True)
    utmZone = Column('UtmZone', type=types.Integer, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    waterBody = Column('WaterBody', type=types.String, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo3 = Column('YesNo3', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo4 = Column('YesNo4', type=mysql_bit_type, index=False, unique=False, nullable=True)
...
class LocalityNameAlias(Base):
    ...
    name = Column('Name', type=types.String, index=True, unique=False, nullable=False)
    source = Column('Source', type=types.String, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class MaterialSample(Base):
    ...
    GGBN_absorbanceRatio260_230 = Column('GGBNAbsorbanceRatio260_230', type=types.Numeric, index=False, unique=False, nullable=True)
    GGBN_absorbanceRatio260_280 = Column('GGBNAbsorbanceRatio260_280', type=types.Numeric, index=False, unique=False, nullable=True)
    GGBN_absorbanceRatioMethod = Column('GGBNRAbsorbanceRatioMethod', type=types.String, index=False, unique=False, nullable=True)
    GGBN_concentration = Column('GGBNConcentration', type=types.Numeric, index=False, unique=False, nullable=True)
    GGBN_concentrationUnit = Column('GGBNConcentrationUnit', type=types.String, index=False, unique=False, nullable=True)
    GGBN_materialSampleType = Column('GGBNMaterialSampleType', type=types.String, index=False, unique=False, nullable=True)
    GGBN_medium = Column('GGBNMedium', type=types.String, index=False, unique=False, nullable=True)
    GGBN_purificationMethod = Column('GGBNPurificationMethod', type=types.String, index=False, unique=False, nullable=True)
    GGBN_quality = Column('GGBNQuality', type=types.String, index=False, unique=False, nullable=True)
    GGBN_qualityCheckDate = Column('GGBNQualityCheckDate', type=types.Date, index=False, unique=False, nullable=True)
    GGBN_qualityRemarks = Column('GGBNQualityRemarks', type=types.Text, index=False, unique=False, nullable=True)
    GGBN_sampleDesignation = Column('GGBNSampleDesignation', type=types.String, index=True, unique=False, nullable=True)
    GGBN_sampleSize = Column('GGBNSampleSize', type=types.Numeric, index=False, unique=False, nullable=True)
    GGBN_volume = Column('GGBNVolume', type=types.Numeric, index=False, unique=False, nullable=True)
    GGBN_volumeUnit = Column('GGBNVolumeUnit', type=types.String, index=False, unique=False, nullable=True)
    GGBN_weight = Column('GGBNWeight', type=types.Numeric, index=False, unique=False, nullable=True)
    GGBN_weightMethod = Column('GGBNWeightMethod', type=types.String, index=False, unique=False, nullable=True)
    GGBN_weightUnit = Column('GGBNWeightUnit', type=types.String, index=False, unique=False, nullable=True)
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=False, unique=False, nullable=False)
    extractionDate = Column('ExtractionDate', type=types.Date, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=False, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    reservedText3 = Column('ReservedText3', type=types.Text, index=False, unique=False, nullable=True)
    reservedText4 = Column('ReservedText4', type=types.Text, index=False, unique=False, nullable=True)
    sraBioProjectID = Column('SRABioProjectID', type=types.String, index=False, unique=False, nullable=True)
    sraBioSampleID = Column('SRABioSampleID', type=types.String, index=False, unique=False, nullable=True)
    sraProjectID = Column('SRAProjectID', type=types.String, index=False, unique=False, nullable=True)
    sraSampleID = Column('SRASampleID', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    ...
    extractor = Column('ExtractorID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    preparation = Column('PreparationID', type=types.Integer, ForeignKey='Preparation.PreparationID', nullable=False, unique=False)
...
class MorphBankView(Base):
    ...
    developmentState = Column('DevelopmentState', type=types.String, index=False, unique=False, nullable=True)
    form = Column('Form', type=types.String, index=False, unique=False, nullable=True)
    imagingPreparationTechnique = Column('ImagingPreparationTechnique', type=types.String, index=False, unique=False, nullable=True)
    imagingTechnique = Column('ImagingTechnique', type=types.String, index=False, unique=False, nullable=True)
    morphBankExternalViewId = Column('MorphBankExternalViewID', type=types.Integer, index=False, unique=False, nullable=True)
    sex = Column('Sex', type=types.String, index=False, unique=False, nullable=True)
    specimenPart = Column('SpecimenPart', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    viewAngle = Column('ViewAngle', type=types.String, index=False, unique=False, nullable=True)
    viewName = Column('ViewName', type=types.String, index=False, unique=False, nullable=True)
...
class PaleoContext(Base):
    ...
    number4 = Column('Number4', type=types.Numeric, index=False, unique=False, nullable=True)
    number5 = Column('Number5', type=types.Numeric, index=False, unique=False, nullable=True)
    paleoContextName = Column('PaleoContextName', type=types.String, index=True, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.String, index=False, unique=False, nullable=True)
    text3 = Column('Text3', type=types.String, index=False, unique=False, nullable=True)
    ...
    bioStrat = Column('BioStratID', type=types.Integer, ForeignKey='GeologicTimePeriod.GeologicTimePeriodID', nullable=True, unique=False)
    chronosStrat = Column('ChronosStratID', type=types.Integer, ForeignKey='GeologicTimePeriod.GeologicTimePeriodID', nullable=True, unique=False)
    chronosStratEnd = Column('ChronosStratEndID', type=types.Integer, ForeignKey='GeologicTimePeriod.GeologicTimePeriodID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    lithoStrat = Column('LithoStratID', type=types.Integer, ForeignKey='LithoStrat.LithoStratID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class Permit(Base):
    ...
    copyright = Column('Copyright', type=types.String, index=False, unique=False, nullable=True)
    endDate = Column('EndDate', type=types.Date, index=False, unique=False, nullable=True)
    isAvailable = Column('IsAvailable', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isRequired = Column('IsRequired', type=mysql_bit_type, index=False, unique=False, nullable=True)
    issuedDate = Column('IssuedDate', type=types.Date, index=True, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    permitNumber = Column('PermitNumber', type=types.String, index=True, unique=False, nullable=False)
    permitText = Column('PermitText', type=types.Text, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    renewalDate = Column('RenewalDate', type=types.Date, index=False, unique=False, nullable=True)
    reservedInteger1 = Column('ReservedInteger1', type=types.Integer, index=False, unique=False, nullable=True)
    reservedInteger2 = Column('ReservedInteger2', type=types.Integer, index=False, unique=False, nullable=True)
    reservedText3 = Column('ReservedText3', type=types.String, index=False, unique=False, nullable=True)
    reservedText4 = Column('ReservedText4', type=types.String, index=False, unique=False, nullable=True)
    startDate = Column('StartDate', type=types.Date, index=False, unique=False, nullable=True)
    status = Column('Status', type=types.String, index=False, unique=False, nullable=True)
    statusQualifier = Column('StatusQualifier', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    institution = Column('InstitutionID', type=types.Integer, ForeignKey='Institution.UserGroupScopeId', nullable=False, unique=False)
    issuedBy = Column('IssuedByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    issuedTo = Column('IssuedToID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class PickList(Base):
    ...
    fieldName = Column('FieldName', type=types.String, index=False, unique=False, nullable=True)
    filterFieldName = Column('FilterFieldName', type=types.String, index=False, unique=False, nullable=True)
    filterValue = Column('FilterValue', type=types.String, index=False, unique=False, nullable=True)
    formatter = Column('Formatter', type=types.String, index=False, unique=False, nullable=True)
    isSystem = Column('IsSystem', type=mysql_bit_type, index=False, unique=False, nullable=False)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=False)
    readOnly = Column('ReadOnly', type=mysql_bit_type, index=False, unique=False, nullable=False)
    sizeLimit = Column('SizeLimit', type=types.Integer, index=False, unique=False, nullable=True)
    sortType = Column('SortType', type=types.Integer, index=False, unique=False, nullable=True)
    tableName = Column('TableName', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    type = Column('Type', type=types.Integer, index=False, unique=False, nullable=False)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class PickListItem(Base):
    ...
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    title = Column('Title', type=types.String, index=False, unique=False, nullable=False)
    value = Column('Value', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    pickList = Column('PickListID', type=types.Integer, ForeignKey='PickList.PickListID', nullable=False, unique=False)
...
class PrepType(Base):
    ...
    isLoanable = Column('IsLoanable', type=mysql_bit_type, index=False, unique=False, nullable=False)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class Preparation(Base):
    ...
    barCode = Column('BarCode', type=types.String, index=True, unique=False, nullable=True)
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    countAmt = Column('CountAmt', type=types.Integer, index=False, unique=False, nullable=True)
    date1 = Column('Date1', type=types.Date, index=False, unique=False, nullable=True)
    date1Precision = Column('Date1Precision', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    preparedDate = Column('PreparedDate', type=types.Date, index=False, unique=False, nullable=True)
    preparedDatePrecision = Column('PreparedDatePrecision', type=types.Integer, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    reservedInteger3 = Column('ReservedInteger3', type=types.Integer, index=False, unique=False, nullable=True)
    reservedInteger4 = Column('ReservedInteger4', type=types.Integer, index=False, unique=False, nullable=True)
    sampleNumber = Column('SampleNumber', type=types.String, index=True, unique=False, nullable=True)
    status = Column('Status', type=types.String, index=False, unique=False, nullable=True)
    storageLocation = Column('StorageLocation', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text10 = Column('Text10', type=types.Text, index=False, unique=False, nullable=True)
    text11 = Column('Text11', type=types.Text, index=False, unique=False, nullable=True)
    text12 = Column('Text12', type=types.String, index=False, unique=False, nullable=True)
    ...
    alternateStorage = Column('AlternateStorageID', type=types.Integer, ForeignKey='Storage.StorageID', nullable=True, unique=False)
    collectionObject = Column('CollectionObjectID', type=types.Integer, ForeignKey='CollectionObject.CollectionObjectID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    prepType = Column('PrepTypeID', type=types.Integer, ForeignKey='PrepType.PrepTypeID', nullable=False, unique=False)
    preparationAttribute = Column('PreparationAttributeID', type=types.Integer, ForeignKey='PreparationAttribute.PreparationAttributeID', nullable=True, unique=False)
    preparedByAgent = Column('PreparedByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    storage = Column('StorageID', type=types.Integer, ForeignKey='Storage.StorageID', nullable=True, unique=False)
...
class PreparationAttribute(Base):
    ...
    attrDate = Column('AttrDate', type=types.Date, index=False, unique=False, nullable=True)
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    number4 = Column('Number4', type=types.Integer, index=False, unique=False, nullable=True)
    number5 = Column('Number5', type=types.Integer, index=False, unique=False, nullable=True)
    number6 = Column('Number6', type=types.Integer, index=False, unique=False, nullable=True)
    number7 = Column('Number7', type=types.Integer, index=False, unique=False, nullable=True)
    number8 = Column('Number8', type=types.Integer, index=False, unique=False, nullable=True)
    number9 = Column('Number9', type=types.Integer, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text10 = Column('Text10', type=types.Text, index=False, unique=False, nullable=True)
    text11 = Column('Text11', type=types.String, index=False, unique=False, nullable=True)
...
class Project(Base):
    ...
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=False, unique=False, nullable=False)
    endDate = Column('EndDate', type=types.Date, index=False, unique=False, nullable=True)
    grantAgency = Column('GrantAgency', type=types.String, index=False, unique=False, nullable=True)
    grantNumber = Column('GrantNumber', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    projectDescription = Column('ProjectDescription', type=types.String, index=False, unique=False, nullable=True)
    projectName = Column('ProjectName', type=types.String, index=True, unique=False, nullable=False)
    projectNumber = Column('ProjectNumber', type=types.String, index=True, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    startDate = Column('StartDate', type=types.Date, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    ...
    agent = Column('ProjectAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class RecordSet(Base):
    ...
    allPermissionLevel = Column('AllPermissionLevel', type=types.Integer, index=False, unique=False, nullable=True)
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=False, unique=False, nullable=False)
    dbTableId = Column('TableID', type=types.Integer, index=False, unique=False, nullable=False)
    groupPermissionLevel = Column('GroupPermissionLevel', type=types.Integer, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=False)
    ownerPermissionLevel = Column('OwnerPermissionLevel', type=types.Integer, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    type = Column('Type', type=types.Integer, index=False, unique=False, nullable=False)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    group = Column('SpPrincipalID', type=types.Integer, ForeignKey='SpPrincipal.SpPrincipalID', nullable=True, unique=False)
    infoRequest = Column('InfoRequestID', type=types.Integer, ForeignKey='InfoRequest.InfoRequestID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    specifyUser = Column('SpecifyUserID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=False, unique=False)
...
class RecordSetItem(Base):
    ...
    order = Column('OrderNumber', type=types.Integer, index=False, unique=False, nullable=True)
    recordId = Column('RecordId', type=types.Integer, index=False, unique=False, nullable=False)

    recordSet = Column('RecordSetID', type=types.Integer, ForeignKey='RecordSet.RecordSetID', nullable=False, unique=False)
...
class ReferenceWork(Base):
    ...
    doi = Column('Doi', type=types.Text, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    isPublished = Column('IsPublished', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isbn = Column('ISBN', type=types.String, index=True, unique=False, nullable=True)
    libraryNumber = Column('LibraryNumber', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    pages = Column('Pages', type=types.String, index=False, unique=False, nullable=True)
    placeOfPublication = Column('PlaceOfPublication', type=types.String, index=False, unique=False, nullable=True)
    publisher = Column('Publisher', type=types.String, index=True, unique=False, nullable=True)
    referenceWorkType = Column('ReferenceWorkType', type=types.Integer, index=False, unique=False, nullable=False)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    title = Column('Title', type=types.String, index=True, unique=False, nullable=False)
    uri = Column('Uri', type=types.Text, index=False, unique=False, nullable=True)
    url = Column('URL', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    volume = Column('Volume', type=types.String, index=False, unique=False, nullable=True)
    workDate = Column('WorkDate', type=types.String, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)

    containedRFParent = Column('ContainedRFParentID', type=types.Integer, ForeignKey='ReferenceWork.ReferenceWorkID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    institution = Column('InstitutionID', type=types.Integer, ForeignKey='Institution.UserGroupScopeId', nullable=False, unique=False)
    journal = Column('JournalID', type=types.Integer, ForeignKey='Journal.JournalID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class RepositoryAgreement(Base):
    ...
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    repositoryAgreementNumber = Column('RepositoryAgreementNumber', type=types.String, index=True, unique=False, nullable=False)
    startDate = Column('StartDate', type=types.Date, index=True, unique=False, nullable=True)
    status = Column('Status', type=types.String, index=False, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.String, index=False, unique=False, nullable=True)
    ...
    division = Column('DivisionID', type=types.Integer, ForeignKey='Division.UserGroupScopeId', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    originator = Column('AgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=False, unique=False)
...
class RepositoryAgreementAttachment(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    repositoryAgreement = Column('RepositoryAgreementID', type=types.Integer, ForeignKey='RepositoryAgreement.RepositoryAgreementID', nullable=False, unique=False)
...
class Shipment(Base):
    ...
    insuredForAmount = Column('InsuredForAmount', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Numeric, index=False, unique=False, nullable=True)
    numberOfPackages = Column('NumberOfPackages', type=types.Integer, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    shipmentDate = Column('ShipmentDate', type=types.Date, index=True, unique=False, nullable=True)
    shipmentMethod = Column('ShipmentMethod', type=types.String, index=True, unique=False, nullable=True)
    shipmentNumber = Column('ShipmentNumber', type=types.String, index=True, unique=False, nullable=False)
    text1 = Column('Text1', type=types.Text, index=False, unique=False, nullable=True)
    text2 = Column('Text2', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    weight = Column('Weight', type=types.String, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)

    borrow = Column('BorrowID', type=types.Integer, ForeignKey='Borrow.BorrowID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=False, unique=False)
    exchangeOut = Column('ExchangeOutID', type=types.Integer, ForeignKey='ExchangeOut.ExchangeOutID', nullable=True, unique=False)
    gift = Column('GiftID', type=types.Integer, ForeignKey='Gift.GiftID', nullable=True, unique=False)
    loan = Column('LoanID', type=types.Integer, ForeignKey='Loan.LoanID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    shippedBy = Column('ShippedByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    shippedTo = Column('ShippedToID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    shipper = Column('ShipperID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class SpAppResource(Base):
    ...
    description = Column('Description', type=types.String, index=False, unique=False, nullable=True)
    groupPermissionLevel = Column('GroupPermissionLevel', type=types.Integer, index=False, unique=False, nullable=True)
    level = Column('Level', type=types.Integer, index=False, unique=False, nullable=False)
    metaData = Column('MetaData', type=types.String, index=False, unique=False, nullable=True)
    mimeType = Column('MimeType', type=types.String, index=True, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=False)
    ownerPermissionLevel = Column('OwnerPermissionLevel', type=types.Integer, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    group = Column('SpPrincipalID', type=types.Integer, ForeignKey='SpPrincipal.SpPrincipalID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    spAppResourceDir = Column('SpAppResourceDirID', type=types.Integer, ForeignKey='SpAppResourceDir.SpAppResourceDirID', nullable=False, unique=False)
    specifyUser = Column('SpecifyUserID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=False, unique=False)
...
class SpAppResourceData(Base):
    ...
    data = Column('data', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    spAppResource = Column('SpAppResourceID', type=types.Integer, ForeignKey='SpAppResource.SpAppResourceID', nullable=True, unique=False)
    spViewSetObj = Column('SpViewSetObjID', type=types.Integer, ForeignKey='SpViewSetObj.SpViewSetObjID', nullable=True, unique=False)
...
class SpAppResourceDir(Base):
    ...
    disciplineType = Column('DisciplineType', type=types.String, index=True, unique=False, nullable=True)
    isPersonal = Column('IsPersonal', type=mysql_bit_type, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    userType = Column('UserType', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    collection = Column('CollectionID', type=types.Integer, ForeignKey='Collection.UserGroupScopeId', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    specifyUser = Column('SpecifyUserID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=True, unique=False)
...
class SpAuditLog(Base):
    ...
    action = Column('Action', type=types.Integer, index=False, unique=False, nullable=False)
    parentRecordId = Column('ParentRecordId', type=types.Integer, index=False, unique=False, nullable=True)
    parentTableNum = Column('ParentTableNum', type=types.Integer, index=False, unique=False, nullable=True)
    recordId = Column('RecordId', type=types.Integer, index=False, unique=False, nullable=True)
    recordVersion = Column('RecordVersion', type=types.Integer, index=False, unique=False, nullable=False)
    tableNum = Column('TableNum', type=types.Integer, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class SpAuditLogField(Base):
    ...
    fieldName = Column('FieldName', type=types.String, index=False, unique=False, nullable=False)
    newValue = Column('NewValue', type=types.Text, index=False, unique=False, nullable=True)
    oldValue = Column('OldValue', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    spAuditLog = Column('SpAuditLogID', type=types.Integer, ForeignKey='SpAuditLog.SpAuditLogID', nullable=True, unique=False)
...
class SpExportSchema(Base):
    ...
    description = Column('Description', type=types.String, index=False, unique=False, nullable=True)
    schemaName = Column('SchemaName', type=types.String, index=False, unique=False, nullable=True)
    schemaVersion = Column('SchemaVersion', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class SpExportSchemaItem(Base):
    ...
    dataType = Column('DataType', type=types.String, index=False, unique=False, nullable=True)
    description = Column('Description', type=types.String, index=False, unique=False, nullable=True)
    fieldName = Column('FieldName', type=types.String, index=False, unique=False, nullable=True)
    formatter = Column('Formatter', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    spExportSchema = Column('SpExportSchemaID', type=types.Integer, ForeignKey='SpExportSchema.SpExportSchemaID', nullable=False, unique=False)
    spLocaleContainerItem = Column('SpLocaleContainerItemID', type=types.Integer, ForeignKey='SpLocaleContainerItem.SpLocaleContainerItemID', nullable=True, unique=False)
...
class SpExportSchemaItemMapping(Base):
    ...
    exportedFieldName = Column('ExportedFieldName', type=types.String, index=False, unique=False, nullable=True)
    extensionItem = Column('ExtensionItem', type=mysql_bit_type, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.String, index=False, unique=False, nullable=True)
    rowType = Column('RowType', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    exportSchemaItem = Column('ExportSchemaItemID', type=types.Integer, ForeignKey='SpExportSchemaItem.SpExportSchemaItemID', nullable=True, unique=False)
    exportSchemaMapping = Column('SpExportSchemaMappingID', type=types.Integer, ForeignKey='SpExportSchemaMapping.SpExportSchemaMappingID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    queryField = Column('SpQueryFieldID', type=types.Integer, ForeignKey='SpQueryField.SpQueryFieldID', nullable=True, unique=False)
...
class SpExportSchemaMapping(Base):
    ...
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    description = Column('Description', type=types.String, index=False, unique=False, nullable=True)
    mappingName = Column('MappingName', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampExported = Column('TimeStampExported', type=types.DateTime, index=False, unique=False, nullable=True)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class SpFieldValueDefault(Base):
    ...
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    fieldName = Column('FieldName', type=types.String, index=False, unique=False, nullable=True)
    idValue = Column('IdValue', type=types.Integer, index=False, unique=False, nullable=True)
    strValue = Column('StrValue', type=types.String, index=False, unique=False, nullable=True)
    tableName = Column('TableName', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
...
class SpLocaleContainer(Base):
    ...
    aggregator = Column('Aggregator', type=types.String, index=False, unique=False, nullable=True)
    defaultUI = Column('DefaultUI', type=types.String, index=False, unique=False, nullable=True)
    format = Column('Format', type=types.String, index=False, unique=False, nullable=True)
    isHidden = Column('IsHidden', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isSystem = Column('IsSystem', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isUIFormatter = Column('IsUIFormatter', type=mysql_bit_type, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=False)
    pickListName = Column('PickListName', type=types.String, index=False, unique=False, nullable=True)
    schemaType = Column('SchemaType', type=types.Integer, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    type = Column('Type', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class SpLocaleContainerItem(Base):
    ...
    type = Column('Type', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    webLinkName = Column('WebLinkName', type=types.String, index=False, unique=False, nullable=True)

    container = Column('SpLocaleContainerID', type=types.Integer, ForeignKey='SpLocaleContainer.SpLocaleContainerID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class SpLocaleItemStr(Base):
    ...
    country = Column('Country', type=types.String, index=True, unique=False, nullable=True)
    language = Column('Language', type=types.String, index=True, unique=False, nullable=False)
    text = Column('Text', type=types.String, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    variant = Column('Variant', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    containerDesc = Column('SpLocaleContainerDescID', type=types.Integer, ForeignKey='SpLocaleContainer.SpLocaleContainerID', nullable=True, unique=False)
    containerName = Column('SpLocaleContainerNameID', type=types.Integer, ForeignKey='SpLocaleContainer.SpLocaleContainerID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    itemDesc = Column('SpLocaleContainerItemDescID', type=types.Integer, ForeignKey='SpLocaleContainerItem.SpLocaleContainerItemID', nullable=True, unique=False)
    itemName = Column('SpLocaleContainerItemNameID', type=types.Integer, ForeignKey='SpLocaleContainerItem.SpLocaleContainerItemID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class SpPermission(Base):
    ...
    actions = Column('Actions', type=types.String, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=True)
    permissionClass = Column('PermissionClass', type=types.String, index=False, unique=False, nullable=False)
    targetId = Column('TargetId', type=types.Integer, index=False, unique=False, nullable=True)
...
class SpPrincipal(Base):
    ...
    groupSubClass = Column('GroupSubClass', type=types.String, index=False, unique=False, nullable=False)
    groupType = Column('groupType', type=types.String, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=False)
    priority = Column('Priority', type=types.Integer, index=False, unique=False, nullable=False)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class SpQuery(Base):
    ...
    contextName = Column('ContextName', type=types.String, index=False, unique=False, nullable=False)
    contextTableId = Column('ContextTableId', type=types.Integer, index=False, unique=False, nullable=False)
    countOnly = Column('CountOnly', type=mysql_bit_type, index=False, unique=False, nullable=True)
    formatAuditRecIds = Column('FormatAuditRecIds', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isFavorite = Column('IsFavorite', type=mysql_bit_type, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=False)
    ordinal = Column('Ordinal', type=types.Integer, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    searchSynonymy = Column('SearchSynonymy', type=mysql_bit_type, index=False, unique=False, nullable=True)
    selectDistinct = Column('SelectDistinct', type=mysql_bit_type, index=False, unique=False, nullable=True)
    smushed = Column('Smushed', type=mysql_bit_type, index=False, unique=False, nullable=True)
    sqlStr = Column('SqlStr', type=types.Text, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class SpQueryField(Base):
    ...
    allowNulls = Column('AllowNulls', type=mysql_bit_type, index=False, unique=False, nullable=True)
    alwaysFilter = Column('AlwaysFilter', type=mysql_bit_type, index=False, unique=False, nullable=True)
    columnAlias = Column('ColumnAlias', type=types.String, index=False, unique=False, nullable=True)
    contextTableIdent = Column('ContextTableIdent', type=types.Integer, index=False, unique=False, nullable=True)
    endValue = Column('EndValue', type=types.Text, index=False, unique=False, nullable=True)
    fieldName = Column('FieldName', type=types.String, index=False, unique=False, nullable=False)
    formatName = Column('FormatName', type=types.String, index=False, unique=False, nullable=True)
    isDisplay = Column('IsDisplay', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isNot = Column('IsNot', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isPrompt = Column('IsPrompt', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isRelFld = Column('IsRelFld', type=mysql_bit_type, index=False, unique=False, nullable=True)
    operEnd = Column('OperEnd', type=types.Integer, index=False, unique=False, nullable=True)
    operStart = Column('OperStart', type=types.Integer, index=False, unique=False, nullable=False)
    position = Column('Position', type=types.Integer, index=False, unique=False, nullable=False)
    sortType = Column('SortType', type=types.Integer, index=False, unique=False, nullable=False)
    startValue = Column('StartValue', type=types.Text, index=False, unique=False, nullable=False)
    stringId = Column('StringId', type=types.String, index=False, unique=False, nullable=False)
    tableList = Column('TableList', type=types.String, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    query = Column('SpQueryID', type=types.Integer, ForeignKey='SpQuery.SpQueryID', nullable=True, unique=False)
...
class SpReport(Base):
    ...
    name = Column('Name', type=types.String, index=True, unique=False, nullable=False)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    repeatCount = Column('RepeatCount', type=types.Integer, index=False, unique=False, nullable=True)
    repeatField = Column('RepeatField', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)

    appResource = Column('AppResourceID', type=types.Integer, ForeignKey='SpAppResource.SpAppResourceID', nullable=False, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    query = Column('SpQueryID', type=types.Integer, ForeignKey='SpQuery.SpQueryID', nullable=True, unique=False)
    specifyUser = Column('SpecifyUserID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=False, unique=False)
    workbenchTemplate = Column('WorkbenchTemplateID', type=types.Integer, ForeignKey='WorkbenchTemplate.WorkbenchTemplateID', nullable=True, unique=False)
...
class SpSymbiotaInstance(Base):
    ...
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    description = Column('Description', type=types.String, index=False, unique=False, nullable=True)
    instanceName = Column('InstanceName', type=types.String, index=False, unique=False, nullable=True)
    lastCacheBuild = Column('LastCacheBuild', type=types.Date, index=False, unique=False, nullable=True)
    lastPull = Column('LastPull', type=types.Date, index=False, unique=False, nullable=True)
    lastPush = Column('LastPush', type=types.Date, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    symbiotaKey = Column('SymbiotaKey', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    schemaMapping = Column('SchemaMappingID', type=types.Integer, ForeignKey='SpExportSchemaMapping.SpExportSchemaMappingID', nullable=True, unique=False)
...
class SpTaskSemaphore(Base):
    ...
    context = Column('Context', type=types.String, index=False, unique=False, nullable=True)
    isLocked = Column('IsLocked', type=mysql_bit_type, index=False, unique=False, nullable=True)
    lockedTime = Column('LockedTime', type=types.DateTime, index=False, unique=False, nullable=True)
    machineName = Column('MachineName', type=types.String, index=False, unique=False, nullable=True)
    scope = Column('Scope', type=types.Integer, index=False, unique=False, nullable=True)
    taskName = Column('TaskName', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    usageCount = Column('UsageCount', type=types.Integer, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    discipline = Column('DisciplineID', type=types.Integer, ForeignKey='Discipline.UserGroupScopeId', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    owner = Column('OwnerID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=True, unique=False)
...
class SpVersion(Base):
    ...
    appName = Column('AppName', type=types.String, index=False, unique=False, nullable=True)
    appVersion = Column('AppVersion', type=types.String, index=False, unique=False, nullable=True)
    dbClosedBy = Column('DbClosedBy', type=types.String, index=False, unique=False, nullable=True)
    isDBClosed = Column('IsDBClosed', type=mysql_bit_type, index=False, unique=False, nullable=True)
    schemaVersion = Column('SchemaVersion', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    workbenchSchemaVersion = Column('WorkbenchSchemaVersion', type=types.String, index=False, unique=False, nullable=True)
...
class SpViewSetObj(Base):
    ...
    description = Column('Description', type=types.String, index=False, unique=False, nullable=True)
    fileName = Column('FileName', type=types.String, index=False, unique=False, nullable=True)
    level = Column('Level', type=types.Integer, index=False, unique=False, nullable=False)
    metaData = Column('MetaData', type=types.String, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
...
class SpecifyUser(Base):
    ...
    accumMinLoggedIn = Column('AccumMinLoggedIn', type=types.Integer, index=False, unique=False, nullable=True)
    email = Column('EMail', type=types.String, index=False, unique=False, nullable=True)
    isLoggedIn = Column('IsLoggedIn', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isLoggedInReport = Column('IsLoggedInReport', type=mysql_bit_type, index=False, unique=False, nullable=False)
    loginCollectionName = Column('LoginCollectionName', type=types.String, index=False, unique=False, nullable=True)
    loginDisciplineName = Column('LoginDisciplineName', type=types.String, index=False, unique=False, nullable=True)
    loginOutTime = Column('LoginOutTime', type=types.DateTime, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=False, unique=True, nullable=False)
    password = Column('Password', type=types.String, index=False, unique=False, nullable=False)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    userType = Column('UserType', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class Storage(Base):
    ...
    acceptedStorage = Column('AcceptedID', type=types.Integer, ForeignKey='Storage.StorageID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    definition = Column('StorageTreeDefID', type=types.Integer, ForeignKey='StorageTreeDef.StorageTreeDefID', nullable=False, unique=False)
    definitionItem = Column('StorageTreeDefItemID', type=types.Integer, ForeignKey='StorageTreeDefItem.StorageTreeDefItemID', nullable=False, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentID', type=types.Integer, ForeignKey='Storage.StorageID', nullable=True, unique=False)
...
class StorageAttachment(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    storage = Column('StorageID', type=types.Integer, ForeignKey='Storage.StorageID', nullable=False, unique=False)
...
class StorageTreeDefItem(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentItemID', type=types.Integer, ForeignKey='StorageTreeDefItem.StorageTreeDefItemID', nullable=True, unique=False)
    treeDef = Column('StorageTreeDefID', type=types.Integer, ForeignKey='StorageTreeDef.StorageTreeDefID', nullable=False, unique=False)
...
class Taxon(Base):
    ...
    author = Column('Author', type=types.String, index=False, unique=False, nullable=True)
    citesStatus = Column('CitesStatus', type=types.String, index=False, unique=False, nullable=True)
    colStatus = Column('COLStatus', type=types.String, index=False, unique=False, nullable=True)
    commonName = Column('CommonName', type=types.String, index=True, unique=False, nullable=True)
    cultivarName = Column('CultivarName', type=types.String, index=False, unique=False, nullable=True)
    environmentalProtectionStatus = Column('EnvironmentalProtectionStatus', type=types.String, index=True, unique=False, nullable=True)
    esaStatus = Column('EsaStatus', type=types.String, index=False, unique=False, nullable=True)
    fullName = Column('FullName', type=types.String, index=True, unique=False, nullable=True)
    groupNumber = Column('GroupNumber', type=types.String, index=False, unique=False, nullable=True)
    guid = Column('GUID', type=types.String, index=True, unique=False, nullable=True)
    highestChildNodeNumber = Column('HighestChildNodeNumber', type=types.Integer, index=False, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    integer5 = Column('Integer5', type=types.Integer, index=False, unique=False, nullable=True)
    isAccepted = Column('IsAccepted', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isHybrid = Column('IsHybrid', type=mysql_bit_type, index=False, unique=False, nullable=False)
    isisNumber = Column('IsisNumber', type=types.String, index=False, unique=False, nullable=True)
    labelFormat = Column('LabelFormat', type=types.String, index=False, unique=False, nullable=True)
    lsid = Column('LSID', type=types.Text, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=True, unique=False, nullable=False)
    ncbiTaxonNumber = Column('NcbiTaxonNumber', type=types.String, index=False, unique=False, nullable=True)
    nodeNumber = Column('NodeNumber', type=types.Integer, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Integer, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Integer, index=False, unique=False, nullable=True)
    number3 = Column('Number3', type=types.Numeric, index=False, unique=False, nullable=True)
    ...
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    source = Column('Source', type=types.String, index=False, unique=False, nullable=True)
    taxonomicSerialNumber = Column('TaxonomicSerialNumber', type=types.String, index=True, unique=False, nullable=True)
    text1 = Column('Text1', type=types.String, index=False, unique=False, nullable=True)
    text10 = Column('Text10', type=types.String, index=False, unique=False, nullable=True)
    text11 = Column('Text11', type=types.String, index=False, unique=False, nullable=True)
    text12 = Column('Text12', type=types.String, index=False, unique=False, nullable=True)
    ...
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    unitInd1 = Column('UnitInd1', type=types.String, index=False, unique=False, nullable=True)
    unitInd2 = Column('UnitInd2', type=types.String, index=False, unique=False, nullable=True)
    unitInd3 = Column('UnitInd3', type=types.String, index=False, unique=False, nullable=True)
    unitInd4 = Column('UnitInd4', type=types.String, index=False, unique=False, nullable=True)
    unitName1 = Column('UnitName1', type=types.String, index=False, unique=False, nullable=True)
    unitName2 = Column('UnitName2', type=types.String, index=False, unique=False, nullable=True)
    unitName3 = Column('UnitName3', type=types.String, index=False, unique=False, nullable=True)
    unitName4 = Column('UnitName4', type=types.String, index=False, unique=False, nullable=True)
    usfwsCode = Column('UsfwsCode', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    visibility = Column('Visibility', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo10 = Column('YesNo10', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ...
    acceptedTaxon = Column('AcceptedID', type=types.Integer, ForeignKey='Taxon.TaxonID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    definition = Column('TaxonTreeDefID', type=types.Integer, ForeignKey='TaxonTreeDef.TaxonTreeDefID', nullable=False, unique=False)
    definitionItem = Column('TaxonTreeDefItemID', type=types.Integer, ForeignKey='TaxonTreeDefItem.TaxonTreeDefItemID', nullable=False, unique=False)
    hybridParent1 = Column('HybridParent1ID', type=types.Integer, ForeignKey='Taxon.TaxonID', nullable=True, unique=False)
    hybridParent2 = Column('HybridParent2ID', type=types.Integer, ForeignKey='Taxon.TaxonID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentID', type=types.Integer, ForeignKey='Taxon.TaxonID', nullable=True, unique=False)
    taxonAttribute = Column('TaxonAttributeID', type=types.Integer, ForeignKey='TaxonAttribute.TaxonAttributeID', nullable=True, unique=False)
    visibilitySetBy = Column('VisibilitySetByID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=True, unique=False)
...
class TaxonAttribute(Base):
    ...
    text3 = Column('Text3', type=types.String, index=False, unique=False, nullable=True)
    text30 = Column('Text30', type=types.String, index=False, unique=False, nullable=True)
    text31 = Column('Text31', type=types.String, index=False, unique=False, nullable=True)
    text32 = Column('Text32', type=types.String, index=False, unique=False, nullable=True)
    text33 = Column('Text33', type=types.String, index=False, unique=False, nullable=True)
    text34 = Column('Text34', type=types.String, index=False, unique=False, nullable=True)
    text35 = Column('Text35', type=types.String, index=False, unique=False, nullable=True)
    text36 = Column('Text36', type=types.String, index=False, unique=False, nullable=True)
    text37 = Column('Text37', type=types.String, index=False, unique=False, nullable=True)
    text38 = Column('Text38', type=types.String, index=False, unique=False, nullable=True)
    text39 = Column('Text39', type=types.String, index=False, unique=False, nullable=True)
    text4 = Column('Text4', type=types.String, index=False, unique=False, nullable=True)
    text40 = Column('Text40', type=types.String, index=False, unique=False, nullable=True)
    text41 = Column('Text41', type=types.String, index=False, unique=False, nullable=True)
    text42 = Column('Text42', type=types.String, index=False, unique=False, nullable=True)
    text43 = Column('Text43', type=types.String, index=False, unique=False, nullable=True)
    text44 = Column('Text44', type=types.String, index=False, unique=False, nullable=True)
    text45 = Column('Text45', type=types.String, index=False, unique=False, nullable=True)
    text46 = Column('Text46', type=types.String, index=False, unique=False, nullable=True)
    text47 = Column('Text47', type=types.String, index=False, unique=False, nullable=True)
    text48 = Column('Text48', type=types.String, index=False, unique=False, nullable=True)
    text49 = Column('Text49', type=types.Text, index=False, unique=False, nullable=True)
    text5 = Column('Text5', type=types.String, index=False, unique=False, nullable=True)
    text50 = Column('Text50', type=types.Text, index=False, unique=False, nullable=True)
    text51 = Column('Text51', type=types.Text, index=False, unique=False, nullable=True)
    text52 = Column('Text52', type=types.Text, index=False, unique=False, nullable=True)
    text53 = Column('Text53', type=types.Text, index=False, unique=False, nullable=True)
    text54 = Column('Text54', type=types.Text, index=False, unique=False, nullable=True)
    text55 = Column('Text55', type=types.Text, index=False, unique=False, nullable=True)
    text56 = Column('Text56', type=types.Text, index=False, unique=False, nullable=True)
    text57 = Column('Text57', type=types.Text, index=False, unique=False, nullable=True)
    text58 = Column('Text58', type=types.Text, index=False, unique=False, nullable=True)
    text6 = Column('Text6', type=types.String, index=False, unique=False, nullable=True)
    text7 = Column('Text7', type=types.String, index=False, unique=False, nullable=True)
    text8 = Column('Text8', type=types.String, index=False, unique=False, nullable=True)
    text9 = Column('Text9', type=types.String, index=False, unique=False, nullable=True)
    ...
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo20 = Column('YesNo20', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo21 = Column('YesNo21', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo22 = Column('YesNo22', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo23 = Column('YesNo23', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo24 = Column('YesNo24', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo25 = Column('YesNo25', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo26 = Column('YesNo26', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo27 = Column('YesNo27', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo28 = Column('YesNo28', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo29 = Column('YesNo29', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo3 = Column('YesNo3', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo30 = Column('YesNo30', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo31 = Column('YesNo31', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo32 = Column('YesNo32', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo33 = Column('YesNo33', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo34 = Column('YesNo34', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo35 = Column('YesNo35', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo36 = Column('YesNo36', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo37 = Column('YesNo37', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo38 = Column('YesNo38', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo39 = Column('YesNo39', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo4 = Column('YesNo4', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo40 = Column('YesNo40', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo41 = Column('YesNo41', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo42 = Column('YesNo42', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo43 = Column('YesNo43', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo44 = Column('YesNo44', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo45 = Column('YesNo45', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo46 = Column('YesNo46', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo47 = Column('YesNo47', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo48 = Column('YesNo48', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo49 = Column('YesNo49', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo5 = Column('YesNo5', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo50 = Column('YesNo50', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo51 = Column('YesNo51', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo52 = Column('YesNo52', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo53 = Column('YesNo53', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo54 = Column('YesNo54', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo55 = Column('YesNo55', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo56 = Column('YesNo56', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo57 = Column('YesNo57', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo58 = Column('YesNo58', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo59 = Column('YesNo59', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo6 = Column('YesNo6', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo60 = Column('YesNo60', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo61 = Column('YesNo61', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo62 = Column('YesNo62', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo63 = Column('YesNo63', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo64 = Column('YesNo64', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo65 = Column('YesNo65', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo66 = Column('YesNo66', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo67 = Column('YesNo67', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo68 = Column('YesNo68', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo69 = Column('YesNo69', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo7 = Column('YesNo7', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo70 = Column('YesNo70', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo71 = Column('YesNo71', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo72 = Column('YesNo72', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo73 = Column('YesNo73', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo74 = Column('YesNo74', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo75 = Column('YesNo75', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo76 = Column('YesNo76', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo77 = Column('YesNo77', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo78 = Column('YesNo78', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo79 = Column('YesNo79', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo8 = Column('YesNo8', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo80 = Column('YesNo80', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo81 = Column('YesNo81', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo82 = Column('YesNo82', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo9 = Column('YesNo9', type=mysql_bit_type, index=False, unique=False, nullable=True)
...
class TaxonTreeDefItem(Base):
    ...
    formatToken = Column('FormatToken', type=types.String, index=False, unique=False, nullable=True)
    fullNameSeparator = Column('FullNameSeparator', type=types.String, index=False, unique=False, nullable=True)
    isEnforced = Column('IsEnforced', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isInFullName = Column('IsInFullName', type=mysql_bit_type, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=False)
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    parent = Column('ParentItemID', type=types.Integer, ForeignKey='TaxonTreeDefItem.TaxonTreeDefItemID', nullable=True, unique=False)
    treeDef = Column('TaxonTreeDefID', type=types.Integer, ForeignKey='TaxonTreeDef.TaxonTreeDefID', nullable=False, unique=False)
...
class TreatmentEvent(Base):
    ...
    dateBoxed = Column('DateBoxed', type=types.Date, index=False, unique=False, nullable=True)
    dateCleaned = Column('DateCleaned', type=types.Date, index=False, unique=False, nullable=True)
    dateCompleted = Column('DateCompleted', type=types.Date, index=False, unique=False, nullable=True)
    dateReceived = Column('DateReceived', type=types.Date, index=True, unique=False, nullable=True)
    dateToIsolation = Column('DateToIsolation', type=types.Date, index=False, unique=False, nullable=True)
    dateTreatmentEnded = Column('DateTreatmentEnded', type=types.Date, index=False, unique=False, nullable=True)
    dateTreatmentStarted = Column('DateTreatmentStarted', type=types.Date, index=True, unique=False, nullable=True)
    fieldNumber = Column('FieldNumber', type=types.String, index=True, unique=False, nullable=True)
    location = Column('Storage', type=types.String, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Integer, index=False, unique=False, nullable=True)
    number2 = Column('Number2', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    treatmentNumber = Column('TreatmentNumber', type=types.String, index=True, unique=False, nullable=True)
    type = Column('Type', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    ...
    accession = Column('AccessionID', type=types.Integer, ForeignKey='Accession.AccessionID', nullable=True, unique=False)
    authorizedBy = Column('AuthorizedByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    collectionObject = Column('CollectionObjectID', type=types.Integer, ForeignKey='CollectionObject.CollectionObjectID', nullable=True, unique=False)
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    division = Column('DivisionID', type=types.Integer, ForeignKey='Division.UserGroupScopeId', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    performedBy = Column('PerformedByID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
...
class TreatmentEventAttachment(Base):
    ...
    createdByAgent = Column('CreatedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    treatmentEvent = Column('TreatmentEventID', type=types.Integer, ForeignKey='TreatmentEvent.TreatmentEventID', nullable=False, unique=False)
...
class VoucherRelationship(Base):
    ...
    collectionCode = Column('CollectionCode', type=types.String, index=False, unique=False, nullable=True)
    collectionMemberId = Column('CollectionMemberID', type=types.Integer, index=True, unique=False, nullable=False)
    institutionCode = Column('InstitutionCode', type=types.String, index=False, unique=False, nullable=True)
    integer1 = Column('Integer1', type=types.Integer, index=False, unique=False, nullable=True)
    integer2 = Column('Integer2', type=types.Integer, index=False, unique=False, nullable=True)
    integer3 = Column('Integer3', type=types.Integer, index=False, unique=False, nullable=True)
    number1 = Column('Number1', type=types.Numeric, index=False, unique=False, nullable=True)
    ...
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    urlLink = Column('UrlLink', type=types.String, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    voucherNumber = Column('VoucherNumber', type=types.String, index=False, unique=False, nullable=True)
    yesNo1 = Column('YesNo1', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo2 = Column('YesNo2', type=mysql_bit_type, index=False, unique=False, nullable=True)
    yesNo3 = Column('YesNo3', type=mysql_bit_type, index=False, unique=False, nullable=True)
...
class Workbench(Base):
    ...
    allPermissionLevel = Column('AllPermissionLevel', type=types.Integer, index=False, unique=False, nullable=True)
    dbTableId = Column('TableID', type=types.Integer, index=False, unique=False, nullable=True)
    exportInstitutionName = Column('ExportInstitutionName', type=types.String, index=False, unique=False, nullable=True)
    exportedFromTableName = Column('ExportedFromTableName', type=types.String, index=False, unique=False, nullable=True)
    formId = Column('FormId', type=types.Integer, index=False, unique=False, nullable=True)
    groupPermissionLevel = Column('GroupPermissionLevel', type=types.Integer, index=False, unique=False, nullable=True)
    lockedByUserName = Column('LockedByUserName', type=types.String, index=False, unique=False, nullable=True)
    name = Column('Name', type=types.String, index=False, unique=False, nullable=True)
    ownerPermissionLevel = Column('OwnerPermissionLevel', type=types.Integer, index=False, unique=False, nullable=True)
    remarks = Column('Remarks', type=types.Text, index=False, unique=False, nullable=True)
    srcFilePath = Column('SrcFilePath', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    ...
    modifiedByAgent = Column('ModifiedByAgentID', type=types.Integer, ForeignKey='Agent.AgentID', nullable=True, unique=False)
    specifyUser = Column('SpecifyUserID', type=types.Integer, ForeignKey='SpecifyUser.SpecifyUserID', nullable=False, unique=False)
    workbenchTemplate = Column('WorkbenchTemplateID', type=types.Integer, ForeignKey='WorkbenchTemplate.WorkbenchTemplateID', nullable=False, unique=False)
...
class WorkbenchDataItem(Base):
    ...
    cellData = Column('CellData', type=types.Text, index=False, unique=False, nullable=True)
    rowNumber = Column('RowNumber', type=types.Integer, index=False, unique=False, nullable=True)
    validationStatus = Column('ValidationStatus', type=types.Integer, index=False, unique=False, nullable=True)

    workbenchRow = Column('WorkbenchRowID', type=types.Integer, ForeignKey='WorkbenchRow.WorkbenchRowID', nullable=False, unique=False)
    workbenchTemplateMappingItem = Column('WorkbenchTemplateMappingItemID', type=types.Integer, ForeignKey='WorkbenchTemplateMappingItem.WorkbenchTemplateMappingItemID', nullable=False, unique=False)
...
class WorkbenchRow(Base):
    ...
    bioGeomancerResults = Column('BioGeomancerResults', type=types.Text, index=False, unique=False, nullable=True)
    cardImageData = Column('CardImageData', type=types.Text, index=False, unique=False, nullable=True)
    cardImageFullPath = Column('CardImageFullPath', type=types.String, index=False, unique=False, nullable=True)
    errorEstimate = Column('ErrorEstimate', type=types.Numeric, index=False, unique=False, nullable=True)
    errorPolygon = Column('ErrorPolygon', type=types.Text, index=False, unique=False, nullable=True)
    lat1Text = Column('Lat1Text', type=types.String, index=False, unique=False, nullable=True)
    lat2Text = Column('Lat2Text', type=types.String, index=False, unique=False, nullable=True)
    long1Text = Column('Long1Text', type=types.String, index=False, unique=False, nullable=True)
    long2Text = Column('Long2Text', type=types.String, index=False, unique=False, nullable=True)
    recordId = Column('RecordID', type=types.Integer, index=False, unique=False, nullable=True)
    rowNumber = Column('RowNumber', type=types.Integer, index=True, unique=False, nullable=True)
    sgrStatus = Column('SGRStatus', type=types.Integer, index=False, unique=False, nullable=True)
    uploadStatus = Column('UploadStatus', type=types.Integer, index=False, unique=False, nullable=True)

    workbench = Column('WorkbenchID', type=types.Integer, ForeignKey='Workbench.WorkbenchID', nullable=False, unique=False)
...
class WorkbenchRowExportedRelationship(Base):
    ...
    recordId = Column('RecordID', type=types.Integer, index=False, unique=False, nullable=True)
    relationshipName = Column('RelationshipName', type=types.String, index=False, unique=False, nullable=True)
    sequence = Column('Sequence', type=types.Integer, index=False, unique=False, nullable=True)
    tableName = Column('TableName', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
...
class WorkbenchRowImage(Base):
    ...
    attachToTableName = Column('AttachToTableName', type=types.String, index=False, unique=False, nullable=True)
    cardImageData = Column('CardImageData', type=types.Text, index=False, unique=False, nullable=True)
    cardImageFullPath = Column('CardImageFullPath', type=types.String, index=False, unique=False, nullable=True)
    imageOrder = Column('ImageOrder', type=types.Integer, index=False, unique=False, nullable=True)
...
class WorkbenchTemplateMappingItem(Base):
    ...
    caption = Column('Caption', type=types.String, index=False, unique=False, nullable=True)
    carryForward = Column('CarryForward', type=mysql_bit_type, index=False, unique=False, nullable=True)
    dataFieldLength = Column('DataFieldLength', type=types.Integer, index=False, unique=False, nullable=True)
    fieldName = Column('FieldName', type=types.String, index=False, unique=False, nullable=True)
    fieldType = Column('FieldType', type=types.Integer, index=False, unique=False, nullable=True)
    importedColName = Column('ImportedColName', type=types.String, index=False, unique=False, nullable=True)
    isEditable = Column('IsEditable', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isExportableToContent = Column('IsExportableToContent', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isIncludedInTitle = Column('IsIncludedInTitle', type=mysql_bit_type, index=False, unique=False, nullable=True)
    isRequired = Column('IsRequired', type=mysql_bit_type, index=False, unique=False, nullable=True)
    metaData = Column('MetaData', type=types.String, index=False, unique=False, nullable=True)
    origImportColumnIndex = Column('DataColumnIndex', type=types.Integer, index=False, unique=False, nullable=True)
    srcTableId = Column('TableId', type=types.Integer, index=False, unique=False, nullable=True)
    tableName = Column('TableName', type=types.String, index=False, unique=False, nullable=True)
    timestampCreated = Column('TimestampCreated', type=types.DateTime, index=False, unique=False, nullable=False)
    timestampModified = Column('TimestampModified', type=types.DateTime, index=False, unique=False, nullable=True)
    version = Column('Version', type=types.Integer, index=False, unique=False, nullable=True)
    viewOrder = Column('ViewOrder', type=types.Integer, index=False, unique=False, nullable=True)
    xCoord = Column('XCoord', type=types.Integer, index=False, unique=False, nullable=True)
    yCoord = Column('YCoord', type=types.Integer, index=False, unique=False, nullable=True)
