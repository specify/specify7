...
describe('useFieldParser', () => {
  ...
  test('updates values from input correctly', () => {
    ...
    const { result: fieldParserResult } = renderHook(() =>
      useFieldParser({
    ...
    mount(<Input.Generic forwardRef={refResult.current} value="" />);
  ...
  test('handles numeric fields', () => {
    ...
    const field = tables.CollectionObject.strictGetField('integer1');
  ...
  test('handles boolean fields', () => {
    ...
    const field = tables.CollectionObject.strictGetField('yesNo1');
  ...
  test('handle undefined parser type, and resource, and field', () => {
    ...
    const { result: fieldParserResult, rerender } = renderHook(() =>
      useFieldParser({
        resource,
        parser,
        field: undefined,
