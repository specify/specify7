...
export const queryText = createDictionary({
  ...
  primaryCatalogNumberInheritance: {
    ...
    'de-ch': 'Vererbung der primären Katalognummer',
    'es-es': 'Herencia del número de catálogo primario',
    'fr-fr': 'Héritage du numéro de catalogue principal',
    'pt-br': 'Herança do Número de Catálogo Primário',
    'ru-ru': 'Наследование основного каталожного номера',
    'uk-ua': 'Успадкування основного каталожного номера',
  },
  parentCatalogNumberInheritance: {
    'en-us': 'Parent Catalog Number Inheritance',
    'de-ch': 'Vererbung der übergeordneten Katalognummer',
    'es-es': 'Herencia del número de catálogo principal',
    'fr-fr': 'Héritage du numéro de catalogue parent',
    'pt-br': 'Herança do número de catálogo pai',
    'ru-ru': 'Наследование родительского каталожного номера',
    'uk-ua': 'Успадкування батьківського каталожного номера',
  },
  uniqueCatalogNumberAcrossComponentAndCoTitle: {
    'en-us': 'Unique Catalog # (Component & CO)',
    'de-ch': 'Eindeutige Katalognummer (Komponente & CO)',
    'es-es': 'Número de catálogo único (componente y CO)',
    'fr-fr': 'Numéro de catalogue unique (Composant et CO)',
    'pt-br': 'Número de catálogo exclusivo (componente e CO)',
    'ru-ru': 'Уникальный каталожный номер (компонент и CO)',
    'uk-ua': 'Унікальний каталожний номер (компонент та CO)',
  },
  formatInputAs: {
    comment: `
