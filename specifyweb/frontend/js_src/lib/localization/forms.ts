...
export const formsText = createDictionary({
  ...
  selectSourceOfTables: {
    ...
    "es-es": "Seleccionar fuente de tablas",
    "fr-fr": "Sélectionner la source des tables",
    "uk-ua": "Виберіть джерело таблиць",
    "de-ch": "Wählen Sie die Quelle der Tabellen aus",
    "pt-br": "Selecione a fonte das tabelas",
  },
  inheritLegacySettings: {
    ...
    "uk-ua": "Копіювати Вказати 6 налаштувань",
    "de-ch": "Kopieren Geben Sie 6 Einstellungen an",
    "pt-br": "Copiar Especificar 6 configurações",
  },
  useCustomSettings: {
    ...
    "uk-ua": "Використовуйте власні налаштування",
    "de-ch": "Benutzerdefinierte Einstellungen verwenden",
    "pt-br": "Usar configurações personalizadas",
  },
  disableReadOnly: {
