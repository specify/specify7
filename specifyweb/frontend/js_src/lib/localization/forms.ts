...
export const formsText = createDictionary({
  ...
  goToFirstRecord: {
    'en-us': 'Go to first record',
    'ru-ru': 'Перейти к первой записи',
    'es-es': 'Ir al primer registro',
    'fr-fr': 'Aller au premier enregistrement',
    'uk-ua': 'Перейти до першого запису',
    'de-ch': 'Zum ersten Eintrag gehen',
  },
  lastRecord: {
    'en-us': 'Last Record',
  ...
  goToLastRecord: {
    'en-us': 'Go to last record',
    'ru-ru': 'Перейти к последней записи',
    'es-es': 'Ir al último registro',
    'fr-fr': 'Aller au dernier enregistrement',
    'uk-ua': 'Перейти до останнього запису',
    'de-ch': 'Zum letzten Eintrag gehen',
  },
  goToPreviousRecord: {
    'en-us': 'Go to previous record',
    'ru-ru': 'Перейти к предыдущей записи',
    'es-es': 'Ir al registro anterior',
    'fr-fr': "Aller à l'enregistrement précédent",
    'uk-ua': 'Перейти до попереднього запису',
    'de-ch': 'Zum vorherigen Datensatz gehen',
  },
  goToNextRecord: {
    'en-us': 'Go to next record',
    'ru-ru': 'Перейти к следующей записи',
    'es-es': 'Ir al siguiente registro',
    'fr-fr': "Aller à l'enregistrement suivant",
    'uk-ua': 'Перейти до наступного запису',
    'de-ch': 'Zum nächsten Datensatz gehen',
  },
  currentRecord: {
