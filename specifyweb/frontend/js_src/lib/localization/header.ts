...
export const headerText = createDictionary({
  ...
  coreMappings: {
    'en-us': 'Core Mappings',
    'de-ch': 'Kern-Zuordnungen',
    'es-es': 'Mapeos principales',
    'fr-fr': 'Mappages principaux',
    'pt-br': 'Mapeamentos principais',
    'ru-ru': 'Основные сопоставления',
    'uk-ua': 'Основні зіставлення',
    'hr-hr': 'Osnovna mapiranja',
  },
  extensionMappings: {
    'en-us': 'Extension Mappings',
    'de-ch': 'Erweiterungs-Zuordnungen',
    'es-es': 'Mapeos de extensión',
    'fr-fr': "Mappages d'extension",
    'pt-br': 'Mapeamentos de extensão',
    'ru-ru': 'Сопоставления расширений',
    'uk-ua': 'Зіставлення розширень',
    'hr-hr': 'Mapiranja proširenja',
  },
  noCoreMappings: {
    'en-us': 'No core mappings configured',
    'de-ch': 'Keine Kern-Zuordnungen konfiguriert',
    'es-es': 'No hay mapeos principales configurados',
    'fr-fr': 'Aucun mappage principal configuré',
    'pt-br': 'Nenhum mapeamento principal configurado',
    'ru-ru': 'Основные сопоставления не настроены',
    'uk-ua': 'Основні зіставлення не налаштовані',
    'hr-hr': 'Nema konfiguriranih osnovnih mapiranja',
  },
  noExtensionMappings: {
    'en-us': 'No extension mappings configured',
    'de-ch': 'Keine Erweiterungs-Zuordnungen konfiguriert',
    'es-es': 'No hay mapeos de extensión configurados',
    'fr-fr': "Aucun mappage d'extension configuré",
    'pt-br': 'Nenhum mapeamento de extensão configurado',
    'ru-ru': 'Сопоставления расширений не настроены',
    'uk-ua': 'Зіставлення розширень не налаштовані',
    'hr-hr': 'Nema konfiguriranih mapiranja proširenja',
  },
  newMapping: {
    'en-us': 'New Mapping',
