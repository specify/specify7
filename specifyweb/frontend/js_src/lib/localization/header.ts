...
export const headerText = createDictionary({
  ...
  taskManager: {
    'en-us': 'Task Manager',
    'de-ch': 'Task-Manager',
    'es-es': 'Administrador de Tareas',
    'fr-fr': 'Gestionnaire de Tâches',
    'pt-br': 'Gerenciador de Tarefas',
    'ru-ru': 'Диспетчер задач',
    'uk-ua': 'Менеджер Завдань',
    'hr-hr': 'Upravitelj Zadataka',
  },
  activeTasks: {
    'en-us': 'Active Tasks',
    'de-ch': 'Aktive Aufgaben',
    'es-es': 'Tareas Activas',
    'fr-fr': 'Tâches Actives',
    'pt-br': 'Tarefas Ativas',
    'ru-ru': 'Активные Задачи',
    'uk-ua': 'Активні Завдання',
    'hr-hr': 'Aktivni Zadaci',
  },
  noActiveTasks: {
    'en-us': 'There are no active tasks.',
    'de-ch': 'Es gibt keine aktiven Aufgaben.',
    'es-es': 'No hay tareas activas.',
    'fr-fr': 'Aucune tâche active.',
    'pt-br': 'Não há tarefas ativas.',
    'ru-ru': 'Нет активных задач.',
    'uk-ua': 'Немає активних завдань.',
    'hr-hr': 'Nema aktivnih zadataka.',
  },
  stopTask: {
    'en-us': 'Stop',
    'de-ch': 'Stopp',
  ...
  taskDataSet: {
    'en-us': 'Task / Data Set Name',
    'de-ch': 'Aufgabe / Datensatzname',
    'es-es': 'Nombre de tarea / conjunto de datos',
    'fr-fr': 'Nom de la tâche / ensemble de données',
    'pt-br': 'Nome da tarefa / conjunto de dados',
    'ru-ru': 'Задача / Название набора данных',
    'uk-ua': 'Завдання / Назва набору даних',
    'hr-hr': 'Zadatak / Naziv skupa podataka',
  },
  taskOwner: {
    'en-us': 'Owner',
    'de-ch': 'Besitzer',
  ...
  taskStopped: {
    'en-us': 'Task stopped successfully.',
    'de-ch': 'Aufgabe erfolgreich gestoppt.',
    'es-es': 'Tarea detenida con éxito.',
    'fr-fr': 'Tâche arrêtée avec succès.',
    'pt-br': 'Tarefa parada com sucesso.',
    'ru-ru': 'Задача успешно остановлена.',
    'uk-ua': 'Завдання успішно зупинено.',
    'hr-hr': 'Zadatak uspješno zaustavljen.',
  },
  taskStopFailed: {
    'en-us': 'Failed to stop the task. Please try again.',
    'de-ch': 'Die Aufgabe konnte nicht gestoppt werden. Bitte versuchen Sie es erneut.',
    'es-es': 'No se pudo detener la tarea. Inténtelo de nuevo.',
    'fr-fr': "Échec de l'arrêt de la tâche. Veuillez réessayer.",
    'pt-br': 'Falha ao parar a tarefa. Tente novamente.',
    'ru-ru': 'Не удалось остановить задачу. Пожалуйста, попробуйте еще раз.',
    'uk-ua': 'Не вдалося зупинити завдання. Будь ласка, спробуйте ще раз.',
    'hr-hr': 'Neuspješno zaustavljanje zadatka. Pokušajte ponovno.',
  },
  restartWorkers: {
    'en-us': 'Restart Workers',
    'de-ch': 'Worker neustarten',
    'es-es': 'Reiniciar Workers',
    'fr-fr': 'Redémarrer les Workers',
    'pt-br': 'Reiniciar Workers',
    'ru-ru': 'Перезапустить Workers',
    'uk-ua': 'Перезапустити Workers',
    'hr-hr': 'Ponovno pokreni Workere',
  },
} as const);