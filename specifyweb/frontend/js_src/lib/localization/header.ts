...
export const headerText = createDictionary({
  ...
  schemaMapper: {
    'en-us': 'DwC Mapping',
    'de-ch': 'Schema-Zuordnung',
    'es-es': 'Mapeador de esquema',
    'fr-fr': 'Mappeur de schéma',
    'pt-br': 'Mapeador de esquema',
    'ru-ru': 'Сопоставление схемы',
    'uk-ua': 'Зіставлення схеми',
    'hr-hr': 'Mapiranje sheme',
  },
  exportPackages: {
    'en-us': 'DwC Archive Export',
    'de-ch': 'Export-Pakete',
    'es-es': 'Paquetes de exportación',
    'fr-fr': "Paquets d'exportation",
    'pt-br': 'Pacotes de exportação',
    'ru-ru': 'Пакеты экспорта',
    'uk-ua': 'Пакети експорту',
    'hr-hr': 'Paketi za izvoz',
  },
  coreMappings: {
    'en-us': 'Darwin Core Mappings',
    'de-ch': 'Darwin-Core-Zuordnungen',
    'es-es': 'Mapeos Darwin Core',
    'fr-fr': 'Mappages Darwin Core',
    'pt-br': 'Mapeamentos Darwin Core',
    'ru-ru': 'Сопоставления Darwin Core',
    'uk-ua': 'Зіставлення Darwin Core',
    'hr-hr': 'Darwin Core mapiranja',
  },
  extensionMappings: {
    'en-us': 'Darwin Core Extension Mappings',
    'de-ch': 'Darwin-Core-Erweiterungs-Zuordnungen',
    'es-es': 'Mapeos de extensión Darwin Core',
    'fr-fr': "Mappages d'extension Darwin Core",
    'pt-br': 'Mapeamentos de extensão Darwin Core',
    'ru-ru': 'Сопоставления расширений Darwin Core',
    'uk-ua': 'Зіставлення розширень Darwin Core',
    'hr-hr': 'Darwin Core mapiranja proširenja',
  },
  noCoreMappings: {
    'en-us': 'No Darwin Core mappings configured',
    'de-ch': 'Keine Darwin-Core-Zuordnungen konfiguriert',
    'es-es': 'No hay mapeos Darwin Core configurados',
    'fr-fr': 'Aucun mappage Darwin Core configuré',
    'pt-br': 'Nenhum mapeamento Darwin Core configurado',
    'ru-ru': 'Сопоставления Darwin Core не настроены',
    'uk-ua': 'Зіставлення Darwin Core не налаштовані',
    'hr-hr': 'Nema konfiguriranih Darwin Core mapiranja',
  },
  noExtensionMappings: {
    'en-us': 'No Darwin Core extension mappings configured',
    'de-ch': 'Keine Darwin-Core-Erweiterungs-Zuordnungen konfiguriert',
    'es-es': 'No hay mapeos de extensión Darwin Core configurados',
    'fr-fr': "Aucun mappage d'extension Darwin Core configuré",
    'pt-br': 'Nenhum mapeamento de extensão Darwin Core configurado',
    'ru-ru': 'Сопоставления расширений Darwin Core не настроены',
    'uk-ua': 'Зіставлення розширень Darwin Core не налаштовані',
    'hr-hr': 'Nema konfiguriranih Darwin Core mapiranja proširenja',
  },
  newMapping: {
    'en-us': 'New Mapping',
    'de-ch': 'Neue Zuordnung',
    'es-es': 'Nuevo mapeo',
    'fr-fr': 'Nouveau mappage',
    'pt-br': 'Novo mapeamento',
    'ru-ru': 'Новое сопоставление',
    'uk-ua': 'Нове зіставлення',
    'hr-hr': 'Novo mapiranje',
  },
  selectVocabulary: {
    'en-us': 'Select Vocabulary',
    'de-ch': 'Vokabular auswählen',
    'es-es': 'Seleccionar vocabulario',
    'fr-fr': 'Sélectionner le vocabulaire',
    'pt-br': 'Selecionar vocabulário',
    'ru-ru': 'Выбрать словарь',
    'uk-ua': 'Вибрати словник',
    'hr-hr': 'Odaberite rječnik',
  },
  darwinCore: {
    'en-us': 'Darwin Core',
    'de-ch': 'Darwin Core',
  ...
  selectMappingType: {
    'en-us': 'Select Mapping Type',
    'de-ch': 'Zuordnungstyp auswählen',
    'es-es': 'Seleccionar tipo de mapeo',
    'fr-fr': 'Sélectionner le type de mappage',
    'pt-br': 'Selecionar tipo de mapeamento',
    'ru-ru': 'Выбрать тип сопоставления',
    'uk-ua': 'Вибрати тип зіставлення',
    'hr-hr': 'Odaberite vrstu mapiranja',
  },
  coreOccurrence: {
    'en-us': 'Core (Occurrence)',
    'de-ch': 'Kern (Vorkommen)',
    'es-es': 'Principal (Ocurrencia)',
    'fr-fr': 'Principal (Occurrence)',
    'pt-br': 'Principal (Ocorrência)',
    'ru-ru': 'Основной (Находка)',
    'uk-ua': 'Основний (Знахідка)',
    'hr-hr': 'Osnovno (Pojava)',
  },
  extension: {
    'en-us': 'Extension',
    'de-ch': 'Erweiterung',
  ...
  createFromScratch: {
    'en-us': 'Create From Scratch',
    'de-ch': 'Neu erstellen',
    'es-es': 'Crear desde cero',
    'fr-fr': 'Créer à partir de zéro',
    'pt-br': 'Criar do zero',
    'ru-ru': 'Создать с нуля',
    'uk-ua': 'Створити з нуля',
    'hr-hr': 'Stvori od nule',
  },
  cloneExistingMapping: {
    'en-us': 'Or clone an existing mapping:',
    'de-ch': 'Oder eine bestehende Zuordnung klonen:',
    'es-es': 'O clonar un mapeo existente:',
    'fr-fr': 'Ou cloner un mappage existant :',
    'pt-br': 'Ou clonar um mapeamento existente:',
    'ru-ru': 'Или клонировать существующее сопоставление:',
    'uk-ua': 'Або клонувати наявне зіставлення:',
    'hr-hr': 'Ili kloniraj postojeće mapiranje:',
  },
  clone: {
    'en-us': 'Clone',
    'de-ch': 'Klonen',
  ...
  runAndPreview: {
    'en-us': 'Run & Preview',
    'de-ch': 'Ausführen & Vorschau',
    'es-es': 'Ejecutar y vista previa',
    'fr-fr': 'Exécuter et prévisualiser',
    'pt-br': 'Executar e visualizar',
    'ru-ru': 'Запустить и просмотреть',
    'uk-ua': 'Запустити і переглянути',
    'hr-hr': 'Pokreni i pregledaj',
  },
  saveMapping: {
    'en-us': 'Save Mapping',
    'de-ch': 'Zuordnung speichern',
    'es-es': 'Guardar mapeo',
    'fr-fr': 'Enregistrer le mappage',
    'pt-br': 'Salvar mapeamento',
    'ru-ru': 'Сохранить сопоставление',
    'uk-ua': 'Зберегти зіставлення',
    'hr-hr': 'Spremi mapiranje',
  },
  duplicateTermsError: {
    'en-us': 'Duplicate terms found: {terms:string}',
    'de-ch': 'Doppelte Begriffe gefunden: {terms:string}',
    'es-es': 'Términos duplicados encontrados: {terms:string}',
    'fr-fr': 'Termes en double trouvés : {terms:string}',
    'pt-br': 'Termos duplicados encontrados: {terms:string}',
    'ru-ru': 'Найдены дублирующиеся термины: {terms:string}',
    'uk-ua': 'Знайдено дублікати термінів: {terms:string}',
    'hr-hr': 'Pronađeni su duplicirani pojmovi: {terms:string}',
  },
  termDetails: {
    'en-us': 'Term Details',
    'de-ch': 'Begriffsdetails',
    'es-es': 'Detalles del término',
    'fr-fr': 'Détails du terme',
    'pt-br': 'Detalhes do termo',
    'ru-ru': 'Подробности термина',
    'uk-ua': 'Деталі терміна',
    'hr-hr': 'Detalji pojma',
  },
  viewOnTdwg: {
    'en-us': 'View on TDWG',
    'de-ch': 'Auf TDWG ansehen',
    'es-es': 'Ver en TDWG',
    'fr-fr': 'Voir sur TDWG',
    'pt-br': 'Ver no TDWG',
    'ru-ru': 'Посмотреть на TDWG',
    'uk-ua': 'Переглянути на TDWG',
    'hr-hr': 'Pogledaj na TDWG',
  },
  enterCustomIri: {
    'en-us': 'Enter custom IRI...',
    'de-ch': 'Benutzerdefinierte IRI eingeben...',
    'es-es': 'Ingrese IRI personalizado...',
    'fr-fr': 'Entrer un IRI personnalisé...',
    'pt-br': 'Insira IRI personalizado...',
    'ru-ru': 'Введите пользовательский IRI...',
    'uk-ua': 'Введіть довільний IRI...',
    'hr-hr': 'Unesite prilagođeni IRI...',
  },
  customIriWarning: {
    'en-us': 'IRI should start with http:// or https://',
    'de-ch': 'IRI sollte mit http:// oder https:// beginnen',
    'es-es': 'El IRI debe comenzar con http:// o https://',
    'fr-fr': "L'IRI doit commencer par http:// ou https://",
    'pt-br': 'O IRI deve começar com http:// ou https://',
    'ru-ru': 'IRI должен начинаться с http:// или https://',
    'uk-ua': 'IRI має починатися з http:// або https://',
    'hr-hr': 'IRI bi trebao počinjati s http:// ili https://',
  },
  lockedOccurrenceId: {
    'en-us': 'Required occurrenceID mapping (locked)',
    'de-ch': 'Erforderliche occurrenceID-Zuordnung (gesperrt)',
    'es-es': 'Mapeo de occurrenceID requerido (bloqueado)',
  ...
  noDwcTerms: {
    'en-us': 'No Darwin Core terms mapped to this field',
    'de-ch': 'Keine Darwin-Core-Begriffe diesem Feld zugeordnet',
    'es-es': 'No hay términos de Darwin Core mapeados a este campo',
    'fr-fr': 'Aucun terme Darwin Core mappé à ce champ',
    'pt-br': 'Nenhum termo Darwin Core mapeado para este campo',
    'ru-ru': 'Нет терминов Darwin Core, сопоставленных с этим полем',
    'uk-ua': 'Немає термінів Darwin Core, зіставлених із цим полем',
    'hr-hr': 'Nema Darwin Core pojmova mapiranih na ovo polje',
  },
  ...
  autoMapFields: {
    'en-us': 'Auto-Map Fields',
  },
  mappingEditor: {
    'en-us': 'Mapping Editor',
  },
  loadingMapping: {
    'en-us': 'Loading mapping...',
  },
  loadingFields: {
    'en-us': 'Loading fields...',
  },
  noFieldsFound: {
    'en-us': 'No fields found for this mapping',
  },
  backToList: {
    'en-us': 'Back to List',
  },
