...
export const expressSearchConfigText = createDictionary({
  ...
  CollObject_desc: {
    ...
    'fr-fr': 'Objets avec leurs déterminations.',
  ...
  ColObjCollectors_desc: {
    ...
    'fr-fr':
      'Objets et agents qui les ont collectés, avec les dates des événements de collecte.',
    'hr-hr':
  ...
  AppraisalToAgent_desc: {
    ...
    nb: 'Vurderinger og agenter assosiert med dem.',
  ...
  CollEventToCollectors: {
    ...
    nb: 'Innsamlingshendelse for samler',
  ...
  CollEventToCollectors_desc: {
    ...
    nb: 'Innsamlingshendelser og agentene som samlet inn specimens.',
    'pt-br':
  ...
  AgentExchangeIn_desc: {
    ...
    nb: 'Innkommende byttemateriale og agentene det ble mottatt fra.',
  ...
  AgentExchangeOut_desc: {
    ...
    nb: 'Utgående byttemateriale og agentene materialet ble sendt til.',
  ...
  GiftCO_desc: {
    ...
    nb: 'Gaver med samlingsobjektene knyttet til preparerte gaver.',
    'pt-br':
  ...
  LoanCO_desc: {
    ...
    nb: 'Utlån med samlingsobjektene og type preparat.',
    'pt-br':
  ...
  LithoStratToCO: {
    ...
    'fr-fr': 'Objets et leur lithostratigraphie',
  ...
  LithoStratToCO_desc: {
    ...
    'fr-fr':
      'Unités lithostratigraphiques et objets associés par leur contexte paléontologique.',
    'hr-hr':
  ...
  ProjectAgent_desc: {
    ...
    'fr-fr': 'Projets et agents assignés',
