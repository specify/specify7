...
export const expressSearchConfigText = createDictionary({
  ...
  ExchangeInCO_desc: {
    ...
    nb: 'Innkommende bytte-materiale med samleobjekter i utvekslede preparater.',
  ...
  ExchangeOutCO: {
    ...
    nb: 'Samlingsobjekt Utveksling Ut',
