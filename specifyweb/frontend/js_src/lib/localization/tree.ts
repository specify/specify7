...
export const treeText = createDictionary({
  ...
  directCollectionObjectCount: {
    ...
    'es-es': 'Recuento de {collectionObjectTable:string} directa',
    'fr-fr': "Nombre d'{collectionObjectTable:string} directe",
    'uk-ua': 'Підрахунок прямих {collectionObjectTable:string}',
  },
  indirectCollectionObjectCount: {
    ...
    'es-es': 'Recuento de objetos de {collectionObjectTable:string}',
    'fr-fr': "Nombre d'objets de la {collectionObjectTable:string}",
    'uk-ua': 'Підрахунок непрямих {collectionObjectTable:string}',
  },
  editRanks: {
    'en-us': 'Edit Ranks',
