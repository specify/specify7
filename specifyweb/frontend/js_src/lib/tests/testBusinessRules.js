...
(function () {
  define(['jquery', 'underscore', 'schema', 'whenall'], function (
    $,
    _,
    schema,
    whenAll
    ...
    return function () {
      ...
      asyncTest('saverequired event', function () {
        ...
        return collectionobject
          .rget('collectionobjectattribute')
          .done(function (coa) {
            var checks;
            checks = [
              requireEvent(
      ...
      asyncTest('dup catalognumber', function () {
        ...
        return collectionobject.fetch().done(function () {
          collectionobject.on('saveblocked:catalognumber', function (blocker) {
            ...
            blockers =
              blocker.resource.saveBlockers.blockersForField('catalogNumber');
      ...
      asyncTest(
        'catalognumber unique in collection where some collection objects have been fetched',
        function () {
          var collection;
          expect(6);
      ...
      asyncTest('collector agent not unique in collectingevent', function () {
        ...
        return collectingevent.rget('collectors').done(function (collectors) {
          ...
          requireEvent(newcollector, 'saveblocked:agent', 'saveblocked').done(
            function (blocker) {
      ...
      asyncTest(
        'accessionagent with duped role in repositoryagreement',
        function () {
          ...
          return repositoryagreement
            .rget('repositoryagreementagents')
            .done(function (AAs) {
