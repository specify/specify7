  ...
  theories(
    ...
    [
      [
        ...
        /*
         * For some reason, QUnit.deepEqual returns false for this, even
         * when objects are identical. Fixed by stringifying them first
         */
        JSON.stringify(
          [
            {
    ...
    (args: Parameters<typeof getMappingLineData>[0]) =>
      JSON.stringify(getMappingLineData(args), null, '\t')
  );
}
