  ...
  return (
    <div className="flex">
      <Button.Small
        ...
        className={` aria-handled !dark:bg-[color:var(--secondary-light-button-color)] min-w-[theme(spacing.40)] max-w-xs flex-1 !justify-start overflow-x-auto normal-case ${
