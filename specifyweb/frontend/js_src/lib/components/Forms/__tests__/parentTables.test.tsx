  ...
  expect(parentTableRelationship()).toMatchInlineSnapshot(`
    {
      ...
      "Author": "[relationship referenceWork]",
      ...
      "CommonNameTx": "[relationship taxon]",
      ...
      "DNASequencingRun": "[relationship dnaSequence]",
      ...
      "Exsiccata": "[relationship referenceWork]",
      "ExsiccataItem": "[relationship exsiccata]",
      "Extractor": "[relationship dnaSequence]",
      ...
      "MaterialSample": "[relationship preparation]",
