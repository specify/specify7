...
export function useHotHooks({
  ...
  return {
    ...
    afterInit: function () {
      ...
      const cornerHeader = this.rootElement.querySelector('.ht_clone_top_inline_start_corner th');
      ...
      const emptyHeaders = this.rootElement.querySelectorAll('thead th:not([aria-label])');
