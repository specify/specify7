...
import { resolveValidationMessage, resolveAttachmentValidationMessage } from './resultsParser';
  ...
  private resolveUploadStatus(
    ...
    if (
      ...
      setMetaCallback(
        'issues',
        whitespaceSensitive(
          resolveAttachmentValidationMessage(recordResult.AttachmentFailure.message)
        ),
