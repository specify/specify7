...
export const className = {
  ...
  dangerButton: `${dialogIconTriggers.error} hover:brightness-150 bg-[color:var(--danger-button-color)] dark:bg-[color:var(--danger-button-color-dark)] text-white`,
  infoButton: `${dialogIconTriggers.info} hover:brightness-150 bg-[color:var(--info-button-color)] dark:bg-[color:var(--info-button-color-dark)] text-white`,
  warningButton: `${dialogIconTriggers.warning} hover:brightness-150 bg-[color:var(--warning-button-color)] text-white`,
  successButton: `${dialogIconTriggers.success} hover:brightness-150 bg-[color:var(--success-button-color)] dark:bg-[color:var(--success-button-color-dark)] text-white`,
  saveButton: `hover:brightness-150 text-white bg-[color:var(--save-button-color)] dark:bg-[color:var(--save-button-color-dark)]`,
