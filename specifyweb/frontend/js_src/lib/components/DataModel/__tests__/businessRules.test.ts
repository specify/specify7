...
overrideAjax(
  '/api/specify/discipline/?domainfilter=false&name=Ichthyology&division=2&offset=0',
  {
    objects: [
      {
        id: 3,
        ...
        modifiedbyagent: '/api/specify/agent/1987/',
...
overrideAjax(
  '/api/specify/division/?domainfilter=false&name=Ichthyology&institution=1&offset=0',
  {
    objects: [
      {
        id: 2,
        abbrev: 'FISH',
        altname: 'KU Biodiversity Institute Ichthyology Division',
        description: null,
        discipline: 'fish',
        iconuri: null,
        name: 'Ichthyology',
        regnumber: '1344636812.33',
        remarks: null,
        timestampcreated: '2012-08-09T12:23:29',
        timestampmodified: '2019-12-18T09:17:04',
        uri: null,
        version: 2,
        address: null,
        createdbyagent: '/api/specify/agent/1986/',
        ...
        members: '/api/specify/agent/?division=2',
        disciplines: '/api/specify/discipline/?division=2',
        resource_uri: '/api/specify/division/2/',
      },
    ],
    meta: {
      limit: 20,
