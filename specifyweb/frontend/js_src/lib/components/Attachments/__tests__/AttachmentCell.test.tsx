...
function useAsyncRef<T>(
  ...
  const setCallback = (...value: Parameters<GetOrSet<T | undefined>[1]>) => {
    ...
    ref.current =
      typeof setter === 'function' ? (setter as Function)(ref.current) : setter;
  };

  return [ref.current, setCallback];
}

function AttachmentCellMock({
  options,
  ...rest
}: {
  readonly options: {
...
describe('AttachmentCell', () => {
  const attachment = {
    ...
    collectingEventAttachments:
      '/api/specify/collectingeventattachment/?attachment=5490',
    collectingTripAttachments:
      '/api/specify/collectingtripattachment/?attachment=5490',
    collectionObjectAttachments:
      '/api/specify/collectionobjectattachment/?attachment=5490',
    conservDescriptionAttachments:
      '/api/specify/conservdescriptionattachment/?attachment=5490',
    conservEventAttachments:
      '/api/specify/conserveventattachment/?attachment=5490',
    dnaSequenceAttachments:
      '/api/specify/dnasequenceattachment/?attachment=5490',
    dnaSequencingRunAttachments:
      '/api/specify/dnasequencingrunattachment/?attachment=5490',
    deaccessionAttachments:
      '/api/specify/deaccessionattachment/?attachment=5490',
    ...
    exchangeOutAttachments:
      '/api/specify/exchangeoutattachment/?attachment=5490',
    fieldNotebookAttachments:
      '/api/specify/fieldnotebookattachment/?attachment=5490',
    fieldNotebookPageAttachments:
      '/api/specify/fieldnotebookpageattachment/?attachment=5490',
    fieldNotebookPageSetAttachments:
      '/api/specify/fieldnotebookpagesetattachment/?attachment=5490',
    ...
    preparationAttachments:
      '/api/specify/preparationattachment/?attachment=5490',
    referenceWorkAttachments:
      '/api/specify/referenceworkattachment/?attachment=5490',
    repositoryAgreementAttachments:
      '/api/specify/repositoryagreementattachment/?attachment=5490',
    ...
    treatmentEventAttachments:
      '/api/specify/treatmenteventattachment/?attachment=5490',
  ...
  overrideAjax(
    '/api/specify/collectionobjectattachment/?limit=20&attachment=5490',
    {
      objects: [collectionObjectAttachment],
      meta: {
        limit: 20,
        offset: 0,
        total_count: 1,
  ...
  test('simple render', async () => {
    ...
    expect(handleViewRecord).toHaveBeenCalledWith(
