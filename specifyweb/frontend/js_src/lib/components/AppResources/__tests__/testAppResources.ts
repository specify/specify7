...
export const testAppResources = {
  ...
  collections: [
    {
      ...
      rightSideRelTypes:
        '/api/specify/collectionreltype/?rightsidecollection=4',
  ...
  appResources: [
    ...
    },
    {
      ...
      spAppResourceDir: '/api/specify/spappresourcedir/1/',
      specifyUser: null,
      spAppResourceDatas: '/api/specify/spappresourcedata/?spappresource=7',
      spReports: '/api/specify/spreport/?appresource=7',
      resource_uri: '/api/specify/spappresource/7/',
      _tableName: 'SpAppResource',
    },
    {
      id: 3,
