...
const { INITIAL_INTERVAL, mergeAndSortNotifications, formatDateForServer } =
  exportsForTests;
...
test('formatDateForServer correctly formats ISO date strings for API requests', () => {
  expect(formatDateForServer('2023-09-19T01:22:00')).toBe(
    '2023-09-19 01:22:00'
  );
  expect(formatDateForServer('2023-09-19T01:22:00.123456')).toBe(
    '2023-09-19 01:22:00'
  );
  expect(formatDateForServer('2023-09-19T01:22:00Z')).toBe(
    '2023-09-19 01:22:00'
  );
  expect(formatDateForServer('2023-09-19T01:22:00.123456Z')).toBe(
    '2023-09-19 01:22:00'
  );
