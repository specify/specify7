...
export const coreTermPatterns: Readonly<Record<string, readonly string[]>> = {
  ...
  'http://rs.tdwg.org/dwc/terms/datasetName': ['collection.description'],
  ...
  'http://rs.tdwg.org/dwc/terms/minimumElevationInMeters': ['locality.minElevation'],
};
