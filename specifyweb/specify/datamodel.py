...
datamodel = Datamodel(tables=[
    ...
    Table(
        ...
        relationships=[
            ...
            Relationship(name='componentType', type='many-to-one', required=True, relatedModelName='CollectionObjectType', column='CollectionObjectTypeID'),
            Relationship(name='parentComponent', type='many-to-one', required=False, relatedModelName='Component', column='ComponentID'),
