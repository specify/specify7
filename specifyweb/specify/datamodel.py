...
datamodel = Datamodel(tables=[
    ...
    Table( # CollectionObjectGroup
        ...
        relationships=[
            ...
            Relationship(name='parentCojo', type='many-to-one', required=False, relatedModelName='CollectionObjectGroupJoin',column='ParentCojoID', otherSideName='parentCog', dependent=True),
