...
datamodel = Datamodel(tables=[
    ...
    Table(
        ...
        relationships=[
            ...
            Relationship(name='components', type='one-to-many',required=False, relatedModelName='Component', otherSideName='collectionObject')
        ],
        fieldAliases=[
    ...
    Table(
        ...
        relationships=[
            ...
            Relationship(name='parentComponent', type='many-to-one', required=False, relatedModelName='Component', column='ParentComponentID'),
