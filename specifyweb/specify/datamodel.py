...
This module defines every table, field, relationship, and index in the Specify
data model as a static Python ``Datamodel`` object. It is the single source of
truth used by the API, stored queries, workbench uploads, business rules, and
all other backend components.

The schema was originally migrated from the Specify 6 ``specify_datamodel.xml``
and is now maintained directly in this file. To update the schema, edit the 
``datamodel`` definition below and regenerate any downstream artifacts 
(Django models, SQLAlchemy table classes, etc.) using the code-generation 
utilities in ``specifyweb.specify.models_utils.sp7_build_models``.

The classes used here (``Table``, ``Field``, ``Relationship``, ``Datamodel``,
etc.) are defined in ``specifyweb.specify.models_utils.load_datamodel``.
"""
...
# TODO: Refactor after merge into `main` branch
def is_tree_table(table: Table):
    return table.get_field('nodenumber') is not None
...
datamodel = Datamodel(tables=[
    Table(
        ...
        fields=[
            ...
            Field(name='dateAccessionedPrecision', column='DateAccessionedPrecision', indexed=False, unique=False, required=False, type='java.lang.Integer'),
            Field(name='dateAcknowledged', column='DateAcknowledged', indexed=False, unique=False, required=False, type='java.util.Calendar'),
            Field(name='dateAcknowledgedPrecision', column='DateAcknowledgedPrecision', indexed=False, unique=False, required=False, type='java.lang.Integer'),
            Field(name='dateReceived', column='DateReceived', indexed=False, unique=False, required=False, type='java.util.Calendar'),
            Field(name='dateReceivedPrecision', column='DateReceivedPrecision', indexed=False, unique=False, required=False, type='java.lang.Integer'),
            Field(name='date1', column='Date1', indexed=False, unique=False, required=False, type='java.util.Calendar'),
            Field(name='date1Precision', column='Date1Precision', indexed=False, unique=False, required=False, type='java.lang.Integer'),
            Field(name='date2', column='Date2', indexed=False, unique=False, required=False, type='java.util.Calendar'),
            Field(name='date2Precision', column='Date2Precision', indexed=False, unique=False, required=False, type='java.lang.Integer'),
    ...
    Table( # AbsoluteAgeCitation
        ...
        relationships=[
            Relationship(name='absoluteAge', type='many-to-one', required=True, relatedModelName='AbsoluteAge', column='AbsoluteAgeID', otherSideName='absoluteAgeCitations'),
            Relationship(name='collectionMember', type='many-to-one', required=True, relatedModelName='Collection', column='CollectionMemberID'),
            Relationship(name='createdByAgent', type='many-to-one', required=False, relatedModelName='Agent', column='CreatedByAgentID'),
            Relationship(name='modifiedByAgent', type='many-to-one', required=False, relatedModelName='Agent', column='ModifiedByAgentID'),
            Relationship(name='referenceWork', type='many-to-one', required=True, relatedModelName='ReferenceWork', column='ReferenceWorkID'),
    ...
    Table( # RelativeAgeCitation
        ...
        relationships=[
            ...
            Relationship(name='modifiedByAgent', type='many-to-one', required=False, relatedModelName='Agent', column='ModifiedByAgentID'),
            Relationship(name='referenceWork', type='many-to-one', required=True, relatedModelName='ReferenceWork', column='ReferenceWorkID'),
            Relationship(name='relativeAge', type='many-to-one', required=True, relatedModelName='RelativeAge', column='RelativeAgeID', otherSideName='relativeAgeCitations'),
        ],
        fieldAliases=[
