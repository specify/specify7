...
datamodel = Datamodel(tables=[
    ...
    Table( # CollectionObjectGroup
        ...
        relationships=[
            ...
            Relationship(name='cojo', type='one-to-one', required=False, relatedModelName='CollectionObjectGroupJoin',column='CollectionObjectGroupJoinID', otherSideName='childCog', dependent=True),
