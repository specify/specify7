...
from specifyweb.backend.geology_time import utils
...
class GeoTimeTests(GeoTimeTestsContext):
    ...
    def test_geotime_range_all_paths(self):
        ...
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(250, 150))
        ...
        self.assertTrue(co_2.id in utils.search_co_ids_in_time_range(65, 55))
        ...
        self.assertTrue(co_3.id in utils.search_co_ids_in_time_range(65, 55))
        self.assertTrue(co_3.id in utils.search_co_ids_in_time_range(67, 53))
        self.assertTrue(co_3.id in utils.search_co_ids_in_time_range(60, 0))
        self.assertTrue(co_3.id in utils.search_co_ids_in_time_range(200, 60))
        self.assertTrue(co_3.id in utils.search_co_ids_in_time_range(200, 0))
        self.assertFalse(co_3.id in utils.search_co_ids_in_time_range(200, 100))
        self.assertFalse(co_3.id in utils.search_co_ids_in_time_range(20, 10))
        ...
        self.assertTrue(co_4.id in utils.search_co_ids_in_time_range(200, 100))
        self.assertTrue(co_4.id in utils.search_co_ids_in_time_range(200, 10))
        ...
        self.assertTrue(co_5.id in utils.search_co_ids_in_time_range(65, 55))
        ...
        self.assertTrue(co_6.id in utils.search_co_ids_in_time_range(65, 55))
        ...
        self.assertTrue(co_7.id in utils.search_co_ids_in_time_range(65, 55))
        ...
        self.assertTrue(co_8.id in utils.search_co_ids_in_time_range(200, 100))
        ...
        self.assertFalse(co_9.id in utils.search_co_ids_in_time_range(200, 100))
        ...
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(100, 50))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(200, 45))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(110, 10))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(200, 10))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(200, 105))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(48, 10))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(90, 55))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(80, 70))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(89, 56))
        self.assertFalse(co_10.id in utils.search_co_ids_in_time_range(200, 112))
        self.assertFalse(co_10.id in utils.search_co_ids_in_time_range(43, 10))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(110, 45, require_full_overlap=True))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(90, 55, require_full_overlap=True))
        self.assertTrue(co_10.id in utils.search_co_ids_in_time_range(200, 10, require_full_overlap=True))
        self.assertFalse(co_10.id in utils.search_co_ids_in_time_range(80, 70, require_full_overlap=True))
        self.assertFalse(co_10.id in utils.search_co_ids_in_time_range(48, 10, require_full_overlap=True))
        self.assertFalse(co_10.id in utils.search_co_ids_in_time_range(58, 10, require_full_overlap=True))
        self.assertFalse(co_10.id in utils.search_co_ids_in_time_range(200, 110, require_full_overlap=True))
        self.assertFalse(co_10.id in utils.search_co_ids_in_time_range(200, 92, require_full_overlap=True))
        self.assertFalse(co_10.id in utils.search_co_ids_in_time_range(200, 70, require_full_overlap=True))
        ...
        self.assertTrue(co_11.id in utils.search_co_ids_in_time_range(65, 55, require_full_overlap=True))
        self.assertFalse(co_11.id in utils.search_co_ids_in_time_range(75, 65, require_full_overlap=True))
        self.assertFalse(co_11.id in utils.search_co_ids_in_time_range(60, 50, require_full_overlap=True))
    ...
    def test_geotime_period(self):
        ...
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_period('paleocene'))
    ...
    def test_geotime_simple(self):
        ...
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(300, 100))
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(300, 200))
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(200, 100))
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(300, 201))
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(199, 100))
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(300, 199))
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(201, 100))
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(300, 100, require_full_overlap=True))
        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(201, 199, require_full_overlap=True))
        self.assertFalse(co_1.id in utils.search_co_ids_in_time_range(300, 250))
        self.assertFalse(co_1.id in utils.search_co_ids_in_time_range(150, 100))
        self.assertFalse(co_1.id in utils.search_co_ids_in_time_range(300, 250, require_full_overlap=True))
        self.assertFalse(co_1.id in utils.search_co_ids_in_time_range(150, 100, require_full_overlap=True))
        ...
        self.assertTrue(co_2.id in utils.search_co_ids_in_time_range(220, 140))
        self.assertTrue(co_2.id in utils.search_co_ids_in_time_range(180, 160))
        self.assertTrue(co_2.id in utils.search_co_ids_in_time_range(220, 100))
        self.assertTrue(co_2.id in utils.search_co_ids_in_time_range(300, 140))
        self.assertTrue(co_2.id in utils.search_co_ids_in_time_range(180, 100))
        self.assertTrue(co_2.id in utils.search_co_ids_in_time_range(300, 160))
        self.assertTrue(co_2.id in utils.search_co_ids_in_time_range(300, 100))
        self.assertTrue(co_2.id in utils.search_co_ids_in_time_range(300, 100, require_full_overlap=True))
        self.assertTrue(co_2.id in utils.search_co_ids_in_time_range(195, 145, require_full_overlap=True))
        self.assertFalse(co_2.id in utils.search_co_ids_in_time_range(300, 250))
        self.assertFalse(co_2.id in utils.search_co_ids_in_time_range(120, 100))
        self.assertFalse(co_2.id in utils.search_co_ids_in_time_range(300, 250, require_full_overlap=True))
        self.assertFalse(co_2.id in utils.search_co_ids_in_time_range(120, 100, require_full_overlap=True))
        self.assertFalse(co_2.id in utils.search_co_ids_in_time_range(180, 160, require_full_overlap=True))
        self.assertFalse(co_2.id in utils.search_co_ids_in_time_range(180, 100, require_full_overlap=True))
        self.assertFalse(co_2.id in utils.search_co_ids_in_time_range(300, 160, require_full_overlap=True))
        ...
        self.assertTrue(co_3.id in utils.search_co_ids_in_time_range(200, 100))
        self.assertTrue(co_3.id in utils.search_co_ids_in_time_range(200, 10))
    ...
    def test_invalid_chronostrat(self):
        ...
        self.assertFalse(co_1.id in utils.search_co_ids_in_time_range(200, 10))

        bad_chronostrat.startperiod = 100
        bad_chronostrat.name = 'GoodBoyz' # important, don't change this :)
        bad_chronostrat.save()

        self.assertTrue(co_1.id in utils.search_co_ids_in_time_range(200, 10))
