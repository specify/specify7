    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('accession', models.ForeignKey(db_column='AccessionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='appraisals', to='specify.accession')),
                ('agent', models.ForeignKey(db_column='AgentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno1', models.BooleanField(blank=True, db_column='YesNo1', null=True)),
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('addressofrecord', models.ForeignKey(db_column='AddressOfRecordID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.addressofrecord')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno1', models.BooleanField(blank=True, db_column='YesNo1', null=True)),
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('agent1', models.ForeignKey(db_column='Agent1ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent2', models.ForeignKey(db_column='Agent2ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admincontact', models.ForeignKey(db_column='AdminContactID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'collection',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('accession', models.ForeignKey(db_column='AccessionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjects', to='specify.accession')),
                ('agent1', models.ForeignKey(db_column='Agent1ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('appraisal', models.ForeignKey(db_column='AppraisalID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjects', to='specify.appraisal')),
                ('cataloger', models.ForeignKey(db_column='CatalogerID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('collectingevent', models.ForeignKey(db_column='CollectingEventID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjects', to='specify.collectingevent')),
                ('collection', models.ForeignKey(db_column='CollectionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.collection')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('curator', models.ForeignKey(db_column='CuratorID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('examinedbyagent', models.ForeignKey(db_column='ExaminedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('treatedbyagent', models.ForeignKey(db_column='TreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('determiner', models.ForeignKey(db_column='DeterminerID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('datatype', models.ForeignKey(db_column='DataTypeID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.datatype')),
            ],
            options={
                'db_table': 'discipline',
                'ordering': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('deaccession', models.ForeignKey(db_column='DeaccessionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='disposals', to='specify.deaccession')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'disposal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('address', models.ForeignKey(db_column='AddressID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='divisions', to='specify.address')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'division',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('extractor', models.ForeignKey(db_column='ExtractorID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno3', models.BooleanField(blank=True, db_column='YesNo3', null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('dnaprimer', models.ForeignKey(db_column='DNAPrimerID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='dnasequencingruns', to='specify.dnaprimer')),
                ...
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('preparedbyagent', models.ForeignKey(db_column='PreparedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('runbyagent', models.ForeignKey(db_column='RunByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno1', models.BooleanField(blank=True, db_column='YesNo1', null=True)),
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('addressofrecord', models.ForeignKey(db_column='AddressOfRecordID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='exchangeins', to='specify.addressofrecord')),
                ('agentcatalogedby', models.ForeignKey(db_column='CatalogedByID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agentreceivedfrom', models.ForeignKey(db_column='ReceivedFromOrganizationID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('division', models.ForeignKey(db_column='DivisionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.division')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'exchangein',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno1', models.BooleanField(blank=True, db_column='YesNo1', null=True)),
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('addressofrecord', models.ForeignKey(db_column='AddressOfRecordID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='exchangeouts', to='specify.addressofrecord')),
                ('agentcatalogedby', models.ForeignKey(db_column='CatalogedByID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agentsentto', models.ForeignKey(db_column='SentToOrganizationID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('deaccession', models.ForeignKey(db_column='DeaccessionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='exchangeouts', to='specify.deaccession')),
                ('division', models.ForeignKey(db_column='DivisionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.division')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(db_column='CollectionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.collection')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('discipline', models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.discipline')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('owneragent', models.ForeignKey(db_column='AgentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('sourceagent', models.ForeignKey(db_column='AgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('acceptedgeography', models.ForeignKey(db_column='AcceptedID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='acceptedchildren', to='specify.geography')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'geography',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('acceptedgeologictimeperiod', models.ForeignKey(db_column='AcceptedID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='acceptedchildren', to='specify.geologictimeperiod')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addressofrecord', models.ForeignKey(db_column='AddressOfRecordID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.addressofrecord')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('deaccession', models.ForeignKey(db_column='DeaccessionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='gifts', to='specify.deaccession')),
                ('discipline', models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.discipline')),
                ('division', models.ForeignKey(db_column='DivisionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.division')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'gift',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('agent', models.ForeignKey(db_column='AgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uri', models.CharField(blank=True, db_column='Uri', max_length=255, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('address', models.ForeignKey(db_column='AddressID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='insitutions', to='specify.address')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('institution', models.ForeignKey(db_column='InstitutionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.institution')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'journal',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno1', models.BooleanField(blank=True, db_column='YesNo1', null=True)),
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('acceptedlithostrat', models.ForeignKey(db_column='AcceptedID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='acceptedchildren', to='specify.lithostrat')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'lithostrat',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno1', models.BooleanField(blank=True, db_column='YesNo1', null=True)),
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('addressofrecord', models.ForeignKey(db_column='AddressOfRecordID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='loans', to='specify.addressofrecord')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('discipline', models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.discipline')),
                ('division', models.ForeignKey(db_column='DivisionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.division')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('discipline', models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.discipline')),
                ('geography', models.ForeignKey(db_column='GeographyID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='localities', to='specify.geography')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'locality',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('institution', models.ForeignKey(db_column='InstitutionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.institution')),
                ('issuedby', models.ForeignKey(db_column='IssuedByID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('issuedto', models.ForeignKey(db_column='IssuedToID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'permit',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('collection', models.ForeignKey(db_column='CollectionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='picklists', to='specify.collection')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno1', models.BooleanField(blank=True, db_column='YesNo1', null=True)),
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('containedrfparent', models.ForeignKey(db_column='ContainedRFParentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='containedreferenceworks', to='specify.referencework')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('institution', models.ForeignKey(db_column='InstitutionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.institution')),
                ('journal', models.ForeignKey(db_column='JournalID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='referenceworks', to='specify.journal')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno1', models.BooleanField(blank=True, db_column='YesNo1', null=True)),
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('addressofrecord', models.ForeignKey(db_column='AddressOfRecordID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='repositoryagreements', to='specify.addressofrecord')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('division', models.ForeignKey(db_column='DivisionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.division')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('originator', models.ForeignKey(db_column='AgentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('collection', models.ForeignKey(db_column='CollectionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.collection')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('discipline', models.ForeignKey(db_column='DisciplineID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.discipline')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('discipline', models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='spexportschemas', to='specify.discipline')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('spexportschema', models.ForeignKey(db_column='SpExportSchemaID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='spexportschemaitems', to='specify.spexportschema')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('discipline', models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='splocalecontainers', to='specify.discipline')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('container', models.ForeignKey(db_column='SpLocaleContainerID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='items', to='specify.splocalecontainer')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('specifyuser', models.ForeignKey(db_column='SpecifyUserID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='spquerys', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'spquery',
                'ordering': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampversion', models.DateTimeField(blank=True, db_column='TimestampVersion', null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('acceptedstorage', models.ForeignKey(db_column='AcceptedID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='acceptedchildren', to='specify.storage')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'storage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acceptedtaxon', models.ForeignKey(db_column='AcceptedID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='acceptedchildren', to='specify.taxon')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'taxon',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('yesno3', models.BooleanField(blank=True, db_column='YesNo3', null=True)),
                ('accession', models.ForeignKey(db_column='AccessionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treatmentevents', to='specify.accession')),
                ('authorizedby', models.ForeignKey(db_column='AuthorizedByID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ...
                ('division', models.ForeignKey(db_column='DivisionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.division')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('performedby', models.ForeignKey(db_column='PerformedByID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('group', models.ForeignKey(db_column='SpPrincipalID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.spprincipal')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('specifyuser', models.ForeignKey(db_column='SpecifyUserID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='workbenches', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'workbench',
                'ordering': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('specifyuser', models.ForeignKey(db_column='SpecifyUserID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='workbenchtemplates', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workbenchtemplatemappingitem', models.ForeignKey(db_column='WorkbenchTemplateMappingItemID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='workbenchdataitems', to='specify.workbenchtemplatemappingitem')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='workbenchtemplate',
            field=models.ForeignKey(db_column='WorkbenchTemplateID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='workbenches', to='specify.workbenchtemplate'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treatmenteventattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treedef', models.ForeignKey(db_column='TaxonTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treedefitems', to='specify.taxontreedef')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('referencework', models.ForeignKey(db_column='ReferenceWorkID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='taxoncitations', to='specify.referencework')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='taxonattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.AddField(
            model_name='taxon',
            name='definition',
            field=models.ForeignKey(db_column='TaxonTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treeentries', to='specify.taxontreedef'),
        ),
        migrations.AddField(
            model_name='taxon',
            name='definitionitem',
            field=models.ForeignKey(db_column='TaxonTreeDefItemID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treeentries', to='specify.taxontreedefitem'),
        ),
        migrations.AddField(
            model_name='taxon',
            name='hybridparent1',
            field=models.ForeignKey(db_column='HybridParent1ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='hybridchildren1', to='specify.taxon'),
        ),
        migrations.AddField(
            model_name='taxon',
            name='hybridparent2',
            field=models.ForeignKey(db_column='HybridParent2ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='hybridchildren2', to='specify.taxon'),
        ),
        migrations.AddField(
            model_name='taxon',
            name='modifiedbyagent',
            field=models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent'),
        ),
        migrations.AddField(
            model_name='taxon',
            name='parent',
            field=models.ForeignKey(db_column='ParentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='children', to='specify.taxon'),
        ),
        migrations.AddField(
            model_name='taxon',
            name='taxonattribute',
            field=models.ForeignKey(db_column='TaxonAttributeID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='taxons', to='specify.taxonattribute'),
        ),
        migrations.AddField(
            model_name='taxon',
            name='visibilitysetby',
            field=models.ForeignKey(db_column='VisibilitySetByID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treedef', models.ForeignKey(db_column='StorageTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treedefitems', to='specify.storagetreedef')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='storageattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.AddField(
            model_name='storage',
            name='definition',
            field=models.ForeignKey(db_column='StorageTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treeentries', to='specify.storagetreedef'),
        ),
        migrations.AddField(
            model_name='storage',
            name='definitionitem',
            field=models.ForeignKey(db_column='StorageTreeDefItemID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treeentries', to='specify.storagetreedefitem'),
        ),
        migrations.AddField(
            model_name='storage',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='storage',
            name='parent',
            field=models.ForeignKey(db_column='ParentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='children', to='specify.storage'),
        ),
        migrations.CreateModel(
            name='Spvisualquery',
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('specifyuser', models.ForeignKey(db_column='SpecifyUserID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('spappresourcedir', models.ForeignKey(db_column='SpAppResourceDirID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='sppersistedviewsets', to='specify.spappresourcedir')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discipline', models.ForeignKey(db_column='DisciplineID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.discipline')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('owner', models.ForeignKey(db_column='OwnerID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='tasksemaphores', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('schemamapping', models.ForeignKey(db_column='SchemaMappingID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='symbiotainstances', to='specify.spexportschemamapping')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('query', models.ForeignKey(db_column='SpQueryID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='reports', to='specify.spquery')),
                ('specifyuser', models.ForeignKey(db_column='SpecifyUserID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('workbenchTemplate', models.OneToOneField(db_column='WorkbenchTemplateID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.workbenchtemplate')),
            ],
            options={
                'db_table': 'spreport',
                'ordering': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant', models.CharField(blank=True, db_column='Variant', max_length=2, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('containerdesc', models.ForeignKey(db_column='SpLocaleContainerDescID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='descs', to='specify.splocalecontainer')),
                ('containername', models.ForeignKey(db_column='SpLocaleContainerNameID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='names', to='specify.splocalecontainer')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('itemdesc', models.ForeignKey(db_column='SpLocaleContainerItemDescID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='descs', to='specify.splocalecontaineritem')),
                ('itemname', models.ForeignKey(db_column='SpLocaleContainerItemNameID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='names', to='specify.splocalecontaineritem')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('exportschemaitem', models.ForeignKey(db_column='ExportSchemaItemID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.spexportschemaitem')),
                ('exportschemamapping', models.ForeignKey(db_column='SpExportSchemaMappingID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='mappings', to='specify.spexportschemamapping')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('queryfield', models.ForeignKey(db_column='SpQueryFieldID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='mappings', to='specify.spqueryfield')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='splocalecontaineritem',
            field=models.ForeignKey(db_column='SpLocaleContainerItemID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='spexportschemaitems', to='specify.splocalecontaineritem'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('spauditlog', models.ForeignKey(db_column='SpAuditLogID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='fields', to='specify.spauditlog')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(db_column='SpPrincipalID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.spprincipal'),
        ),
        migrations.AddField(
            model_name='spappresource',
            name='modifiedbyagent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('discipline', models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.discipline')),
                ('exchangeout', models.ForeignKey(db_column='ExchangeOutID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='shipments', to='specify.exchangeout')),
                ...
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('shippedby', models.ForeignKey(db_column='ShippedByID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('shippedto', models.ForeignKey(db_column='ShippedToID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('shipper', models.ForeignKey(db_column='ShipperID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'shipment',
                'ordering': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='repositoryagreementattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='referenceworkattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.AddField(
            model_name='recordset',
            name='inforequest',
            field=models.ForeignKey(db_column='InfoRequestID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='recordsets', to='specify.inforequest'),
        ),
        migrations.AddField(
            model_name='recordset',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='recordset',
            name='specifyuser',
            field=models.ForeignKey(db_column='SpecifyUserID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('yesno1', models.BooleanField(blank=True, db_column='YesNo1', null=True)),
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('agent', models.ForeignKey(db_column='ProjectAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('collection', models.ForeignKey(db_column='CollectionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='preptypes', to='specify.collection')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno9', models.BooleanField(blank=True, db_column='YesNo9', null=True)),
                ('agent1', models.ForeignKey(db_column='Agent1ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent10', models.ForeignKey(db_column='Agent10ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent11', models.ForeignKey(db_column='Agent11ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent12', models.ForeignKey(db_column='Agent12ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent13', models.ForeignKey(db_column='Agent13ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent14', models.ForeignKey(db_column='Agent14ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent15', models.ForeignKey(db_column='Agent15ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent16', models.ForeignKey(db_column='Agent16ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent17', models.ForeignKey(db_column='Agent17ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent18', models.ForeignKey(db_column='Agent18ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent19', models.ForeignKey(db_column='Agent19ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent2', models.ForeignKey(db_column='Agent2ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent20', models.ForeignKey(db_column='Agent20ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent3', models.ForeignKey(db_column='Agent3ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent4', models.ForeignKey(db_column='Agent4ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent5', models.ForeignKey(db_column='Agent5ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent6', models.ForeignKey(db_column='Agent6ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent7', models.ForeignKey(db_column='Agent7ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent8', models.ForeignKey(db_column='Agent8D', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('agent9', models.ForeignKey(db_column='Agent9ID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('definition', models.ForeignKey(db_column='AttributeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='preparationattrs', to='specify.attributedef')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='preparationattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='AlternateStorageID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.storage'),
        ),
        migrations.AddField(
            model_name='preparation',
            name='collectionobject',
        ...
        migrations.AddField(
            model_name='preparation',
            name='createdbyagent',
            field=models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent'),
        ),
        migrations.AddField(
            model_name='preparation',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='preparation',
            name='preparationattribute',
            field=models.ForeignKey(db_column='PreparationAttributeID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='preparations', to='specify.preparationattribute'),
        ),
        migrations.AddField(
            model_name='preparation',
            name='preparedbyagent',
            field=models.ForeignKey(db_column='PreparedByID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent'),
        ),
        migrations.AddField(
            model_name='preparation',
            name='preptype',
            field=models.ForeignKey(db_column='PrepTypeID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.preptype'),
        ),
        migrations.AddField(
            model_name='preparation',
            name='storage',
            field=models.ForeignKey(db_column='StorageID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='preparations', to='specify.storage'),
        ),
        migrations.CreateModel(
            name='Picklistitem',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='permitattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(db_column='AgentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('dnasequence', models.ForeignKey(db_column='DNASequenceID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='pcrpersons', to='specify.dnasequence')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'pcrperson',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno4', models.BooleanField(blank=True, db_column='YesNo4', null=True)),
                ('yesno5', models.BooleanField(blank=True, db_column='YesNo5', null=True)),
                ('biostrat', models.ForeignKey(db_column='BioStratID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='biostratspaleocontext', to='specify.geologictimeperiod')),
                ('chronosstrat', models.ForeignKey(db_column='ChronosStratID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='chronosstratspaleocontext', to='specify.geologictimeperiod')),
                ('chronosstratend', models.ForeignKey(db_column='ChronosStratEndID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.geologictimeperiod')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('discipline', models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.discipline')),
                ('lithostrat', models.ForeignKey(db_column='LithoStratID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='paleocontexts', to='specify.lithostrat')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('referencework', models.ForeignKey(db_column='ReferenceWorkID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='localitycitations', to='specify.referencework')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='localityattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.AddField(
            model_name='locality',
            name='paleocontext',
            field=models.ForeignKey(db_column='PaleoContextID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='localities', to='specify.paleocontext'),
        ),
        migrations.AddField(
            model_name='locality',
            name='visibilitysetby',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('receivedby', models.ForeignKey(db_column='ReceivedByID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='preparation',
            field=models.ForeignKey(db_column='PreparationID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='loanpreparations', to='specify.preparation'),
        ),
        migrations.CreateModel(
            name='Loanattachment',
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='loanattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treedef', models.ForeignKey(db_column='LithoStratTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treedefitems', to='specify.lithostrattreedef')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='definition',
            field=models.ForeignKey(db_column='LithoStratTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treeentries', to='specify.lithostrattreedef'),
        ),
        migrations.AddField(
            model_name='lithostrat',
            name='definitionitem',
            field=models.ForeignKey(db_column='LithoStratTreeDefItemID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treeentries', to='specify.lithostrattreedefitem'),
        ),
        migrations.AddField(
            model_name='lithostrat',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='lithostrat',
            name='parent',
            field=models.ForeignKey(db_column='ParentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='children', to='specify.lithostrat'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='latlonpolygon',
            name='visualquery',
            field=models.ForeignKey(db_column='SpVisualQueryID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='polygons', to='specify.spvisualquery'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uri', models.CharField(blank=True, db_column='Uri', max_length=255, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('address', models.ForeignKey(db_column='AddressID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.address')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='storagetreedef',
            field=models.ForeignKey(db_column='StorageTreeDefID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='institutions', to='specify.storagetreedef'),
        ),
        migrations.CreateModel(
            name='Groupperson',
            fields=[
                ...
                ('member', models.ForeignKey(db_column='MemberID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='members', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('preparation', models.ForeignKey(db_column='PreparationID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='giftpreparations', to='specify.preparation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='giftattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treedef', models.ForeignKey(db_column='GeologicTimePeriodTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treedefitems', to='specify.geologictimeperiodtreedef')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='definition',
            field=models.ForeignKey(db_column='GeologicTimePeriodTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treeentries', to='specify.geologictimeperiodtreedef'),
        ),
        migrations.AddField(
            model_name='geologictimeperiod',
            name='definitionitem',
            field=models.ForeignKey(db_column='GeologicTimePeriodTreeDefItemID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treeentries', to='specify.geologictimeperiodtreedefitem'),
        ),
        migrations.AddField(
            model_name='geologictimeperiod',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='geologictimeperiod',
            name='parent',
            field=models.ForeignKey(db_column='ParentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='children', to='specify.geologictimeperiod'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treedef', models.ForeignKey(db_column='GeographyTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treedefitems', to='specify.geographytreedef')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='definition',
            field=models.ForeignKey(db_column='GeographyTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treeentries', to='specify.geographytreedef'),
        ),
        migrations.AddField(
            model_name='geography',
            name='definitionitem',
            field=models.ForeignKey(db_column='GeographyTreeDefItemID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='treeentries', to='specify.geographytreedefitem'),
        ),
        migrations.AddField(
            model_name='geography',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='geography',
            name='parent',
            field=models.ForeignKey(db_column='ParentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='children', to='specify.geography'),
        ),
        migrations.CreateModel(
            name='Geocoorddetail',
            fields=[
                ...
                ('yesno5', models.BooleanField(blank=True, db_column='YesNo5', null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('georefcompiledby', models.ForeignKey(db_column='CompiledByID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('georefdetby', models.ForeignKey(db_column='AgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='fieldnotebookpagesetattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='fieldnotebookpageattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='fieldnotebookattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(db_column='AgentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('dnasequence', models.ForeignKey(db_column='DNASequenceID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='extractors', to='specify.dnasequence')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
                'db_table': 'extractor',
        ...
        migrations.AddField(
            ...
            name='referencework',
            field=models.ForeignKey(db_column='ReferenceWorkID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='exsiccatae', to='specify.referencework'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('preparation', models.ForeignKey(db_column='PreparationID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='exchangeoutpreps', to='specify.preparation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='exchangeoutattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('preparation', models.ForeignKey(db_column='PreparationID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='exchangeinpreps', to='specify.preparation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='exchangeinattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('referencework', models.ForeignKey(db_column='ReferenceWorkID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.referencework')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='dnasequencingrunattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='dnasequenceattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.AddField(
            model_name='dnasequence',
            name='sequencer',
            field=models.ForeignKey(db_column='AgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent'),
        ),
        migrations.AddField(
            model_name='division',
            name='institution',
            field=models.ForeignKey(db_column='InstitutionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='divisions', to='specify.institution'),
        ),
        migrations.AddField(
            model_name='division',
            name='modifiedbyagent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loanreturnpreparation', models.ForeignKey(db_column='LoanReturnPreparationID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='disposalpreparations', to='specify.loanreturnpreparation')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('preparation', models.ForeignKey(db_column='PreparationID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='disposalpreparations', to='specify.preparation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='disposalattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.AddField(
            ...
            name='division',
            field=models.ForeignKey(db_column='DivisionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='disciplines', to='specify.division'),
        ),
        migrations.AddField(
            model_name='discipline',
            name='geographytreedef',
            field=models.ForeignKey(db_column='GeographyTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='disciplines', to='specify.geographytreedef'),
        ),
        migrations.AddField(
            model_name='discipline',
            name='geologictimeperiodtreedef',
            field=models.ForeignKey(db_column='GeologicTimePeriodTreeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='disciplines', to='specify.geologictimeperiodtreedef'),
        ),
        migrations.AddField(
            model_name='discipline',
            name='lithostrattreedef',
            field=models.ForeignKey(db_column='LithoStratTreeDefID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='disciplines', to='specify.lithostrattreedef'),
        ),
        migrations.AddField(
            model_name='discipline',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='discipline',
            name='taxontreedef',
            field=models.OneToOneField(db_column='TaxonTreeDefID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='discipline', to='specify.taxontreedef'),
        ),
        migrations.CreateModel(
            name='Determiner',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('referencework', models.ForeignKey(db_column='ReferenceWorkID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='determinationcitations', to='specify.referencework')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='preferredtaxon',
            field=models.ForeignKey(db_column='PreferredTaxonID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.taxon'),
        ),
        migrations.AddField(
            model_name='determination',
            name='taxon',
            field=models.ForeignKey(db_column='TaxonID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='determinations', to='specify.taxon'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='deaccessionattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('parent', models.ForeignKey(db_column='ParentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='children', to='specify.container')),
                ('storage', models.ForeignKey(db_column='StorageID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='containers', to='specify.storage')),
            ],
            options={
                'db_table': 'container',
                'ordering': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='conserveventattachments', to='specify.attachment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='conservdescriptionattachments', to='specify.attachment')),
        ...
        migrations.AddField(
            ...
            name='division',
            field=models.ForeignKey(db_column='DivisionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.division'),
        ),
        migrations.AddField(
            model_name='conservdescription',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='conservdescription',
            name='preparation',
            field=models.ForeignKey(db_column='PreparationID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='conservdescriptions', to='specify.preparation'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno1', models.BooleanField(blank=True, db_column='YesNo1', null=True)),
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('agent', models.ForeignKey(db_column='AgentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectors', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('leftsidecollection', models.ForeignKey(db_column='LeftSideCollectionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='leftsidereltypes', to='specify.collection')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('rightsidecollection', models.ForeignKey(db_column='RightSideCollectionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='rightsidereltypes', to='specify.collection')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('collectionreltype', models.ForeignKey(db_column='CollectionRelTypeID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.collectionreltype')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('referencework', models.ForeignKey(db_column='ReferenceWorkID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjectcitations', to='specify.referencework')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('definition', models.ForeignKey(db_column='AttributeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjectattrs', to='specify.attributedef')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjectattachments', to='specify.attachment')),
        ...
        migrations.AddField(
            ...
            name='collectionobjectattribute',
            field=models.ForeignKey(db_column='CollectionObjectAttributeID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjects', to='specify.collectionobjectattribute'),
        ),
        migrations.AddField(
            model_name='collectionobject',
            name='container',
            field=models.ForeignKey(db_column='ContainerID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjects', to='specify.container'),
        ),
        migrations.AddField(
            model_name='collectionobject',
            name='containerowner',
            field=models.ForeignKey(db_column='ContainerOwnerID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjectkids', to='specify.container'),
        ),
        migrations.AddField(
            model_name='collectionobject',
            name='createdbyagent',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='EmbargoAuthorityID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent'),
        ),
        migrations.AddField(
            model_name='collectionobject',
            name='fieldnotebookpage',
            field=models.ForeignKey(db_column='FieldNotebookPageID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjects', to='specify.fieldnotebookpage'),
        ),
        migrations.AddField(
            model_name='collectionobject',
            name='inventorizedby',
            field=models.ForeignKey(db_column='InventorizedByID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent'),
        ),
        migrations.AddField(
            model_name='collectionobject',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='collectionobject',
            name='paleocontext',
            field=models.ForeignKey(db_column='PaleoContextID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectionobjects', to='specify.paleocontext'),
        ),
        migrations.AddField(
            model_name='collectionobject',
            name='visibilitysetby',
        ...
        migrations.AddField(
            ...
            name='discipline',
            field=models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collections', to='specify.discipline'),
        ),
        migrations.AddField(
            model_name='collection',
            name='institutionnetwork',
            field=models.ForeignKey(db_column='InstitutionNetworkID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.institution'),
        ),
        migrations.AddField(
            model_name='collection',
            name='modifiedbyagent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('permit', models.ForeignKey(db_column='PermitID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingtripauthorizations', to='specify.permit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingtripattachments', to='specify.attachment')),
        ...
        migrations.AddField(
            ...
            name='collectingtripattribute',
            field=models.ForeignKey(db_column='CollectingTripAttributeID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingtrips', to='specify.collectingtripattribute'),
        ),
        migrations.AddField(
            model_name='collectingtrip',
            name='createdbyagent',
        ...
        migrations.AddField(
            model_name='collectingtrip',
            name='discipline',
            field=models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.discipline'),
        ),
        migrations.AddField(
            model_name='collectingtrip',
            name='modifiedbyagent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('permit', models.ForeignKey(db_column='PermitID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingeventauthorizations', to='specify.permit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('discipline', models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.discipline')),
                ('hosttaxon', models.ForeignKey(db_column='HostTaxonID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingeventattributes', to='specify.taxon')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('definition', models.ForeignKey(db_column='AttributeDefID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingeventattrs', to='specify.attributedef')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingeventattachments', to='specify.attachment')),
        ...
        migrations.AddField(
            ...
            name='collectingeventattribute',
            field=models.ForeignKey(db_column='CollectingEventAttributeID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingevents', to='specify.collectingeventattribute'),
        ),
        migrations.AddField(
            model_name='collectingevent',
            name='collectingtrip',
            field=models.ForeignKey(db_column='CollectingTripID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingevents', to='specify.collectingtrip'),
        ),
        migrations.AddField(
            model_name='collectingevent',
            name='createdbyagent',
        ...
        migrations.AddField(
            model_name='collectingevent',
            name='locality',
            field=models.ForeignKey(db_column='LocalityID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingevents', to='specify.locality'),
        ),
        migrations.AddField(
            model_name='collectingevent',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='collectingevent',
            name='paleocontext',
            field=models.ForeignKey(db_column='PaleoContextID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='collectingevents', to='specify.paleocontext'),
        ),
        migrations.AddField(
            model_name='collectingevent',
            name='visibilitysetby',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('agent', models.ForeignKey(db_column='ReturnedByID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='borrowattachments', to='specify.attachment')),
        ...
        migrations.AddField(
            ...
            name='discipline',
            field=models.ForeignKey(db_column='DisciplineID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='attributedefs', to='specify.discipline'),
        ),
        migrations.AddField(
            model_name='attributedef',
            name='modifiedbyagent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='tags', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('attachment', models.ForeignKey(db_column='AttachmentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='metadata', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('morphbankview', models.ForeignKey(db_column='MorphBankViewID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='attachmentimageattributes', to='specify.morphbankview')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='attachment',
            name='creator',
            field=models.ForeignKey(db_column='CreatorID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent'),
        ),
        migrations.AddField(
            model_name='attachment',
            name='modifiedbyagent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('geography', models.ForeignKey(db_column='GeographyID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.geography')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='agentattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='CollectionCCID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='contentcontacts', to='specify.collection'),
        ),
        migrations.AddField(
            model_name='agent',
            name='colltechcontact',
            field=models.ForeignKey(db_column='CollectionTCID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='technicalcontacts', to='specify.collection'),
        ),
        migrations.AddField(
            model_name='agent',
            name='createdbyagent',
        ...
        migrations.AddField(
            model_name='agent',
            name='division',
            field=models.ForeignKey(db_column='DivisionID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='members', to='specify.division'),
        ),
        migrations.AddField(
            model_name='agent',
            name='instcontentcontact',
            field=models.ForeignKey(db_column='InstitutionCCID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='contentcontacts', to='specify.institution'),
        ),
        migrations.AddField(
            model_name='agent',
            name='insttechcontact',
            field=models.ForeignKey(db_column='InstitutionTCID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='technicalcontacts', to='specify.institution'),
        ),
        migrations.AddField(
            model_name='agent',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='agent',
            name='organization',
            field=models.ForeignKey(db_column='ParentOrganizationID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='orgmembers', to='specify.agent'),
        ),
        migrations.AddField(
            model_name='agent',
            name='specifyuser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0, null=True)),
                ('accession', models.ForeignKey(db_column='AccessionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='accessioncitations', to='specify.accession')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('referencework', models.ForeignKey(db_column='ReferenceWorkID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.referencework')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('permit', models.ForeignKey(db_column='PermitID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='accessionauthorizations', to='specify.permit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.ForeignKey(db_column='AttachmentID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='accessionattachments', to='specify.attachment')),
                ('createdbyagent', models.ForeignKey(db_column='CreatedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
                ('modifiedbyagent', models.ForeignKey(db_column='ModifiedByAgentID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.agent')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='addressofrecord',
            field=models.ForeignKey(db_column='AddressOfRecordID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='accessions', to='specify.addressofrecord'),
        ),
        migrations.AddField(
            model_name='accession',
            name='createdbyagent',
        ...
        migrations.AddField(
            model_name='accession',
            name='division',
            field=models.ForeignKey(db_column='DivisionID', on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='+', to='specify.division'),
        ),
        migrations.AddField(
            model_name='accession',
            name='modifiedbyagent',
        ...
        migrations.AddField(
            model_name='accession',
            name='repositoryagreement',
            field=models.ForeignKey(db_column='RepositoryAgreementID', null=True, on_delete=specifyweb.backend.datamodel.models.protect_with_blockers, related_name='accessions', to='specify.repositoryagreement'),
        ),
        migrations.AddField(
