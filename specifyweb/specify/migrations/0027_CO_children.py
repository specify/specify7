...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='parentco',
            field=models.ForeignKey(db_column='ParentCOID', null=True, on_delete=specifyweb.specify.models.protect_with_blockers, related_name='children', to='specify.collectionobject'),
        ),
