    ...
    operation = [
     migrations.CreateModel(
         ...
         fields=[
             ...
             ('verbatimname', models.TextField(blank=True, db_column='VerbatimName', max_length=64, null=True)),
            ...
            ('uniqueidentifier', models.CharField(blank=True,db_column='UniqueIdentifier', max_length=255, null=True, unique=True)),
