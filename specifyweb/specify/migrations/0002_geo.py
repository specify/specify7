    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yesno2', models.BooleanField(blank=True, db_column='YesNo2', null=True)),
                ('yesno3', models.BooleanField(blank=True, db_column='YesNo3', null=True)),
                ('parentcog', models.ForeignKey(db_column='ParentCOGID', null=False, on_delete=django.db.models.deletion.CASCADE, related_name='parentcojo', to='specify.collectionobjectgroup')),
