    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isaccepted', models.BooleanField(blank=True, db_column='IsAccepted')),
                ('name', models.CharField(blank=True, db_column='Name', max_length=255)),
                ('nodenumber', models.IntegerField(blank=True, db_column='NodeNumber', max_length=255, null=True)),
                ...
                ('rank', models.IntegerField(blank=True, db_column='RankID')),
                ('remarks', models.TextField(blank=True, db_column='Remarks', null=True)),
                ('text1', models.TextField(blank=True, db_column='Text1')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestampcreated', models.DateTimeField(db_column='TimestampCreated', default=django.utils.timezone.now)),
                ('timestampmodified', models.DateTimeField(blank=True, db_column='TimestampModified', default=django.utils.timezone.now, null=True)),
                ('version', models.IntegerField(blank=True, db_column='Version', default=0)),
                ('isfigured', models.BooleanField(blank=True, db_column='IsFigured', default=0)),
                ('remarks', models.TextField(blank=True, db_column='Remarks', default=0)),
                ...
                # relationships
                ('collection', models.ForeignKey(db_column='CollectionMemberID', on_delete=protect_with_blockers, related_name='RelativeAgeCitation', to='specify.collection')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platenumber', models.CharField(blank=True, db_column='PlateNumber', default=0, max_length=255)),
                # relationships
                ('collection', models.ForeignKey(db_column='CollectionMemberID', on_delete=protect_with_blockers, related_name='AbsoluteAgeCitation', to='specify.collection')),
