...
from specifyweb.specify.migration_utils.migration_helpers.helper_0034_accession_date_fields import revert_update_accession_date_fields, update_accession_date_fields

def apply_migration(apps, schema_editor):
    update_accession_date_fields(apps)

def revert_migration(apps, schema_editor):
    revert_update_accession_date_fields(apps)
