...
class Accession(models.Model):
    accessionid = models.AutoField(db_column='AccessionID', primary_key=True)
    timestampcreated = models.DateTimeField(db_column='TimestampCreated')
    timestampmodified = models.DateTimeField(db_column='TimestampModified', blank=True, null=True)
    version = models.IntegerField(db_column='Version', blank=True, null=True)
    accessioncondition = models.CharField(db_column='AccessionCondition', max_length=255, blank=True, null=True)
    accessionnumber = models.CharField(db_column='AccessionNumber', max_length=60)
    dateaccessioned = models.DateField(db_column='DateAccessioned', blank=True, null=True)
    dateacknowledged = models.DateField(db_column='DateAcknowledged', blank=True, null=True)
    datereceived = models.DateField(db_column='DateReceived', blank=True, null=True)
    number1 = models.DecimalField(db_column='Number1', max_digits=20, decimal_places=10, blank=True, null=True)
    number2 = models.DecimalField(db_column='Number2', max_digits=20, decimal_places=10, blank=True, null=True)
    ...
    text1 = models.TextField(db_column='Text1', blank=True, null=True)
    text2 = models.TextField(db_column='Text2', blank=True, null=True)
    text3 = models.TextField(db_column='Text3', blank=True, null=True)
    totalvalue = models.DecimalField(db_column='TotalValue', max_digits=12, decimal_places=2, blank=True, null=True)
    type = models.CharField(db_column='Type', max_length=32, blank=True, null=True)
    verbatimdate = models.CharField(db_column='VerbatimDate', max_length=50, blank=True, null=True)
    yesno1 = models.BooleanField(db_column='YesNo1', blank=True, null=True)
    yesno2 = models.BooleanField(db_column='YesNo2', blank=True, null=True)
    repositoryagreementid = models.ForeignKey('Repositoryagreement', models.DO_NOTHING, db_column='RepositoryAgreementID', blank=True, null=True)
    modifiedbyagentid = models.ForeignKey('Agent', models.DO_NOTHING, db_column='ModifiedByAgentID', blank=True, null=True)
    addressofrecordid = models.ForeignKey('Addressofrecord', models.DO_NOTHING, db_column='AddressOfRecordID', blank=True, null=True)
    createdbyagentid = models.ForeignKey('Agent', models.DO_NOTHING, db_column='CreatedByAgentID', blank=True, null=True)
    divisionid = models.ForeignKey('Division', models.DO_NOTHING, db_column='DivisionID')
    integer1 = models.IntegerField(db_column='Integer1', blank=True, null=True)
    integer2 = models.IntegerField(db_column='Integer2', blank=True, null=True)
    integer3 = models.IntegerField(db_column='Integer3', blank=True, null=True)
    text4 = models.TextField(db_column='Text4', blank=True, null=True)
    text5 = models.TextField(db_column='Text5', blank=True, null=True)
...
class Deaccessionpreparation(models.Model):
    deaccessionpreparationid = models.AutoField(db_column='DeaccessionPreparationID', primary_key=True)  # Field name made lowercase.
    timestampcreated = models.DateTimeField(db_column='TimestampCreated')  # Field name made lowercase.
    timestampmodified = models.DateTimeField(db_column='TimestampModified', blank=True, null=True)  # Field name made lowercase.
    version = models.IntegerField(db_column='Version', blank=True, null=True)  # Field name made lowercase.
    quantity = models.SmallIntegerField(db_column='Quantity', blank=True, null=True)  # Field name made lowercase.
...
class Dwcfish(models.Model):
    dwcfishid = models.IntegerField(db_column='dwcfishId', primary_key=True)  # Field name made lowercase.
    ...
    coordinateuncertaintyinmeters = models.DecimalField(db_column='coordinateUncertaintyInMeters', max_digits=20, decimal_places=10, blank=True, null=True)  # Field name made lowercase.
    country = models.CharField(max_length=500, blank=True, null=True)
    county = models.CharField(max_length=500, blank=True, null=True)
    dateidentified = models.DateField(db_column='dateIdentified', blank=True, null=True)  # Field name made lowercase.
    day = models.IntegerField(blank=True, null=True)
    decimallatitude = models.DecimalField(db_column='decimalLatitude', max_digits=12, decimal_places=10, blank=True, null=True)  # Field name made lowercase.
    decimallongitude = models.DecimalField(db_column='decimalLongitude', max_digits=13, decimal_places=10, blank=True, null=True)  # Field name made lowercase.
    dynamicproperties = models.CharField(db_column='dynamicProperties', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    georeferencesources = models.CharField(db_column='georeferenceSources', max_length=50, blank=True, null=True)  # Field name made lowercase.
    georeferencedby = models.CharField(db_column='georeferencedBy', max_length=500, blank=True, null=True)  # Field name made lowercase.
    ...
    identifiedby = models.CharField(db_column='identifiedBy', max_length=500, blank=True, null=True)  # Field name made lowercase.
    ...
    island = models.CharField(max_length=64, blank=True, null=True)
    ...
    scientificnameauthorship = models.CharField(db_column='scientificNameAuthorship', max_length=500, blank=True, null=True)  # Field name made lowercase.
    ...
    waterbody = models.CharField(max_length=64, blank=True, null=True)
...
class Dwcfishtissue(models.Model):
    dwcfishtissueid = models.IntegerField(db_column='dwcfishtissueId', primary_key=True)  # Field name made lowercase.
    associatedmedia = models.TextField(db_column='associatedMedia', blank=True, null=True)  # Field name made lowercase.
    associatedreferences = models.TextField(db_column='associatedReferences', blank=True, null=True)  # Field name made lowercase.
    associatedsequences = models.TextField(db_column='associatedSequences', blank=True, null=True)  # Field name made lowercase.
    catalognumber = models.CharField(db_column='catalogNumber', max_length=32, blank=True, null=True)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'dwcfishtissue'


class Dwckui(models.Model):
    dwckuiid = models.IntegerField(db_column='dwckuiId', primary_key=True)  # Field name made lowercase.
    institutioncode = models.CharField(db_column='institutionCode', max_length=64, blank=True, null=True)  # Field name made lowercase.
    ...
    occurrenceid = models.CharField(db_column='occurrenceID', max_length=128, blank=True, null=True)  # Field name made lowercase.
    catalognumber = models.CharField(db_column='catalogNumber', max_length=32, blank=True, null=True)  # Field name made lowercase.
    othercatalognumbers = models.CharField(db_column='otherCatalogNumbers', max_length=32, blank=True, null=True)  # Field name made lowercase.
    modified = models.DateTimeField(blank=True, null=True)
    associatedmedia = models.TextField(db_column='associatedMedia', blank=True, null=True)  # Field name made lowercase.
    ...
    eventremarks = models.TextField(db_column='eventRemarks', blank=True, null=True)  # Field name made lowercase.
    recordedby = models.TextField(db_column='recordedBy', blank=True, null=True)  # Field name made lowercase.
    minimumdepthinmeters = models.FloatField(db_column='minimumDepthInMeters', blank=True, null=True)  # Field name made lowercase.
    maximumdepthinmeters = models.FloatField(db_column='maximumDepthInMeters', blank=True, null=True)  # Field name made lowercase.
    locality = models.CharField(max_length=255, blank=True, null=True)
    geodeticdatum = models.CharField(db_column='geodeticDatum', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Dwckuit(models.Model):
    dwckuitid = models.IntegerField(db_column='dwckuitId', primary_key=True)  # Field name made lowercase.
    institutioncode = models.CharField(db_column='institutionCode', max_length=64, blank=True, null=True)  # Field name made lowercase.
    institutionid = models.CharField(db_column='institutionID', max_length=128, blank=True, null=True)  # Field name made lowercase.
    rights = models.TextField(blank=True, null=True)
    accessrights = models.TextField(db_column='accessRights', blank=True, null=True)  # Field name made lowercase.
    ...
    occurrenceid = models.CharField(db_column='occurrenceID', max_length=128, blank=True, null=True)  # Field name made lowercase.
    catalognumber = models.CharField(db_column='catalogNumber', max_length=32, blank=True, null=True)  # Field name made lowercase.
    othercatalognumbers = models.CharField(db_column='otherCatalogNumbers', max_length=50, blank=True, null=True)  # Field name made lowercase.
    modified = models.DateTimeField(blank=True, null=True)
    associatedmedia = models.TextField(db_column='associatedMedia', blank=True, null=True)  # Field name made lowercase.
    dynamicproperties = models.CharField(db_column='dynamicProperties', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sex = models.CharField(max_length=50, blank=True, null=True)
...
class TissueWebSearch(models.Model):
    tissue_web_searchid = models.IntegerField(db_column='tissue_web_searchId', primary_key=True)  # Field name made lowercase.
    catalognumber = models.CharField(db_column='catalogNumber', max_length=32, blank=True, null=True)  # Field name made lowercase.
    fieldnumber = models.CharField(db_column='fieldNumber', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    common_name = models.CharField(db_column='Common_Name', max_length=128, blank=True, null=True)  # Field name made lowercase.
    ...
    stationfieldnumber = models.CharField(db_column='stationFieldNumber', max_length=50, blank=True, null=True)  # Field name made lowercase.
    localityname = models.CharField(db_column='localityName', max_length=255, blank=True, null=True)  # Field name made lowercase.
    latitude1 = models.CharField(max_length=20, blank=True, null=True)
    longitude1 = models.CharField(max_length=20, blank=True, null=True)
    elevationmethod = models.CharField(db_column='elevationMethod', max_length=50, blank=True, null=True)  # Field name made lowercase.
    min_depth = models.FloatField(db_column='Min_depth', blank=True, null=True)  # Field name made lowercase.
    max_depth = models.FloatField(db_column='Max_depth', blank=True, null=True)  # Field name made lowercase.
    ...
    text11 = models.CharField(max_length=50, blank=True, null=True)
    text8 = models.CharField(max_length=50, blank=True, null=True)
    text12 = models.CharField(max_length=50, blank=True, null=True)
    text10 = models.CharField(max_length=50, blank=True, null=True)
    dna_sequences = models.TextField(db_column='DNA_Sequences', blank=True, null=True)  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'tissue_web_search'
...
class VoucherWebSearch(models.Model):
    voucher_web_searchid = models.IntegerField(db_column='voucher_web_searchId', primary_key=True)  # Field name made lowercase.
    cat_field = models.CharField(db_column='Cat__', max_length=32, blank=True, null=True)  # Field name made lowercase. Field renamed because it contained more than one '_' in a row. Field renamed because it ended with '_'.
    prev_exch_field = models.CharField(db_column='Prev_Exch__', max_length=32, blank=True, null=True)  # Field name made lowercase. Field renamed because it contained more than one '_' in a row. Field renamed because it ended with '_'.
    left_side_rels = models.TextField(db_column='Left_Side_Rels', blank=True, null=True)  # Field name made lowercase.
    order = models.CharField(db_column='Order', max_length=500, blank=True, null=True)  # Field name made lowercase.
    class_field = models.CharField(db_column='Class', max_length=500, blank=True, null=True)  # Field name made lowercase. Field renamed because it was a Python reserved word.
    family = models.CharField(db_column='Family', max_length=500, blank=True, null=True)  # Field name made lowercase.
    ...
    collectors = models.TextField(db_column='Collectors', blank=True, null=True)  # Field name made lowercase.
    field_number = models.CharField(db_column='Field_Number', max_length=50, blank=True, null=True)  # Field name made lowercase.
    locality_name = models.CharField(db_column='Locality_Name', max_length=255, blank=True, null=True)  # Field name made lowercase.
    latitude1 = models.CharField(db_column='Latitude1', max_length=20, blank=True, null=True)  # Field name made lowercase.
    longitude1 = models.CharField(db_column='Longitude1', max_length=20, blank=True, null=True)  # Field name made lowercase.
    water_type = models.CharField(db_column='Water_Type', max_length=50, blank=True, null=True)  # Field name made lowercase.
    min_depth = models.FloatField(db_column='Min_depth', blank=True, null=True)  # Field name made lowercase.
    max_depth = models.FloatField(db_column='Max_depth', blank=True, null=True)  # Field name made lowercase.
    continent = models.CharField(db_column='Continent', max_length=500, blank=True, null=True)  # Field name made lowercase.
    country = models.CharField(db_column='Country', max_length=500, blank=True, null=True)  # Field name made lowercase.
