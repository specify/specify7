...
dependent_fields = {
    ...
    'Geograhytreedef.geographytreedefitems',
    'Geologictimeperiodtreedef.geologictimeperiodtreedefitems',
    'Gift.addressofrecord',
    'Gift.giftagents',
    'Gift.giftpreparations',
    'Gift.shipments',
    'Latlonpolygon.points',
    'Lithostratreedef.lithostrattreedefitems',
    ...
    'Spquery.fields',
    'Storagetreedef.storagetreeitems',
    'Taxon.commonnames',
