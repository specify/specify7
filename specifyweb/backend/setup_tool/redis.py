...
ACTIVE_TASK_REDIS_KEY = "setup:active_task_id"
ACTIVE_TASK_TTL = 60*60*2 # setup should be less than 2 hours

# Keep track of last error.
LAST_ERROR_REDIS_KEY = "setup:last_error"

# Track async setup/config tasks by resource scope.
COLLECTION_TASKS_REDIS_KEY = "setup:collection:{collection_id}:tasks"
DISCIPLINE_TASKS_REDIS_KEY = "setup:discipline:{discipline_id}:tasks"
