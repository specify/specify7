...
from specifyweb.backend.datamodel.models import Collectionobject, Collectionobjectgroupjoin, datamodel
...
from specifyweb.backend.datamodel.load_datamodel import Table, Field, Relationship
