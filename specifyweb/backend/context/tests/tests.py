...
import specifyweb.backend.context.viewsets as viewsets
...
class OpenApiTests(TestCase):
    def test_operations_spec(self) -> None:
        from specifyweb.backend.context.views import generate_openapi_for_endpoints
        from specifyweb.backend.context.openapi_schema import schema
