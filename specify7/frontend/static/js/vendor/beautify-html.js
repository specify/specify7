    ...
    style_html: function(html_source, options) {
        ...
        function Parser() {
            ...
            this.Utils = { //Uilities made available to the various functions
                whitespace: "\n\r\t ".split(''),
                single_token: 'br,input,link,meta,!doctype,basefont,base,area,hr,wbr,param,img,isindex,?xml,embed,col'.split(','), //all the single tags for HTML
            ...
            this.get_tag = function () { //function to get a full tag and parse its type
                ...
                do {
                    ...
                    if (content.length && content[content.length-1] !== '=' &&
                        input_char !== '>' && space) { //no space after = or before >
